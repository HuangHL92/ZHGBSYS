        ...
        throws SAXException
    {
        ...
        try
        {
            ...
            if(format.isTrimText())
            {
                ...
                if(charsAdded && Character.isWhitespace(lastChar))
                    writer.write(32);
                else
                if(lastOutputNodeType == 1 && format.isPadText() && lastElementClosed && Character.isWhitespace(ch[0]))
                    writer.write(" ");
                String delim = "";
...
/*
	...
	Decompiled from: D:\newWorks\insiis6\WebContent\WEB-INF\lib\dom4j-1.6.1.jar
	Total time: 470 ms
