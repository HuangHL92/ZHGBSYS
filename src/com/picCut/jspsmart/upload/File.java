...
public class File {
	...
	public void saveAs(String s, int i) throws IOException,
		...
		try {
			...
			fileoutputstream.write(this.m_parent.m_binArray, this.m_startData,
					this.m_size);
	...
	public void fileToField(ResultSet resultset, String s)
		...
		try {
			...
			System.arraycopy(this.m_parent.m_binArray, this.m_startData,
					abyte0, 0, this.m_size);
	...
	public String getContentString() {
		String s = new String(this.m_parent.m_binArray, this.m_startData,
				this.m_size);
		return s;
	}
