...
/**
 * VerifyScheme entity. @author MyEclipse Persistence Tools
 */

public class VerifyScheme implements java.io.Serializable {
	...
	/** minimal constructor */
	public VerifyScheme(String vsc001) {
		this.vsc001 = vsc001;
	}

	/** full constructor */
	public VerifyScheme(String vsc001, String vsc002, String vsc003,
