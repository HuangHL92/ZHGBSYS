...
public class SublibrariesconditionDTO implements Serializable {
	...
	public SublibrariesconditionDTO() {
		super();
	}

	public SublibrariesconditionDTO(String sub_libraries_condition_id,
