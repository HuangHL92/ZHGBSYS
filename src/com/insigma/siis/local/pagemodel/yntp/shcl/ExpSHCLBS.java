package com.insigma.siis.local.pagemodel.yntp.shcl;
		...
		if(a01!=null&&!"4".equals(a01.getStatus())){
			...
			if(a57!=null){
				...
				if(data!=null){
					...
					a.setZhaoPian(new byte[1]);
				}
		    }else{
		    	a.setZhaoPian(new byte[1]);
		    }
			//formatNULL
			a.setXingMing(formatNULL(a01.getA0101()));
			a.setXingBie(xb!=null?xb.toString():"");                                    
			a.setChuShengNianYue(formatNULL(a01.getA0107()));                            
			a.setMinZu(mz!=null?mz.toString():"");                                      
			a.setJiGuan(formatNULL(a01.getComboxArea_a0111()));                                     
			a.setChuShengDi(formatNULL(a01.getComboxArea_a0114()));
			a.setRuDangShiJian(formatNULL(a01.getA0140()));
			a.setCanJiaGongZuoShiJian(formatNULL(a01.getA0134()));
			a.setJianKangZhuangKuang(formatNULL(a01.getA0128()));      
			a.setZhuanYeJiShuZhiWu(formatNULL(a01.getA0196()));
			a.setShuXiZhuanYeYouHeZhuanChang(formatNULL(a01.getA0187a()));
			a.setQuanRiZhiJiaoYu_XueLi(formatNULL(a01.getQrzxl()));
			a.setQuanRiZhiJiaoYu_XueWei(formatNULL(a01.getQrzxw()));
			a.setQuanRiZhiJiaoYu_XueLi_BiYeYuanXiaoXi(formatNULL(a01.getQrzxlxx()));
			a.setQuanRiZhiJiaoYu_XueWei_BiYeYuanXiaoXi(formatNULL(a01.getQrzxwxx()));
			a.setZaiZhiJiaoYu_XueLi(formatNULL(a01.getZzxl()));
			a.setZaiZhiJiaoYu_XueWei(formatNULL(a01.getZzxw()));
			a.setZaiZhiJiaoYu_XueLi_BiYeYuanXiaoXi(formatNULL(a01.getZzxlxx()));
			a.setZaiZhiJiaoYu_XueWei_BiYeYuanXiaoXi(formatNULL(a01.getZzxwxx()));
			a.setXianRenZhiWu(formatNULL(a01.getA0192a()));                               
			a.setJianLi(formatNULL(a01.getA1701()));                                     
			a.setJiangChengQingKuang(formatNULL(a01.getA14z101()));                        
			a.setNianDuKaoHeJieGuo(formatNULL(a01.getA15z101()));
			a.setShenFenZheng(formatNULL(a01.getA0184()));
			if(list==null||list.size()==0){
				...
				a.setTianBiaoShiJian(formatNULL(time));
				a.setTianBiaoRen("");
			}else{
				A53 a53 = list.get(0);
				a.setNiRenZhiWu(formatNULL(a53.getA5304()));                                 
				a.setNiMianZhiWu(formatNULL(a53.getA5315()));
				a.setRenMianLiYou(formatNULL(a53.getA5317()));                               
				a.setChengBaoDanWei(formatNULL(a53.getA5319()));                             
				a.setJiSuanNianLingShiJian(""); 
...
//				}
			...
			if(lista36!=null&&lista36.size()>0){
				for(int i=1;i<=lista36.size();i++){
					...
					b.setChuShengRiQi(formatNULL(a36.getA3607()));
					b.setGongZuoDanWeiJiZhiWu(formatNULL(a36.getA3611()));
					b.setXingMing(formatNULL(a36.getA3601()));
	...
	private String formatNULL(String s){
		return s==null?"":s;
	}
	/**
	 * 创建文件
