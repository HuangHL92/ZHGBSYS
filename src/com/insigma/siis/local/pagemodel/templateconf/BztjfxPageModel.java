...
public class BztjfxPageModel extends PageModel{
	...
	public int showtype(String gid){
		...
		if(list!=null&&list.size()>0){
			...
			this.getExecuteSG().addExecuteCode("comprevalue('"+parem+"');");
		}else{
			this.getExecuteSG().addExecuteCode("comprevalue('error');");
		}
	...
	public int Znzs(String gid) throws RadowException{
		...
		if(list != null && list.size() > 0){
			...
			for (String string : str) {
				...
				//String sql1="select count(1) from (select distinct a01.a0000,GET_BIRTHDAY( a01.a0107,'"+DateUtil.getcurdate()+"')a0107 from a01 inner join a02 on a01.a0000=a02.a0000 and a02.a0201b='"+gid+"' and a02.a0219='"+zwlb+"' and a02.a0221='"+zwzj+"') aa where  aa.a0107='"+nll+"'";
				String sql1="select count(1) from (select distinct a01.a0000 from a01 inner join a02 on a01.a0000=a02.a0000 and a02.a0201b='"+gid+"' and a02.a0219='"+zwlb+"' and a01.a0221='"+zwzj+"' and a0279='1') aa ";
				String fc = "select * from (select distinct a01.a0000,a01.a0101,(CASE  a01.a0104 WHEN #1# THEN #男# else #女# end)a0104, (substr (a01.a0107,1,4)||#.#||substr (a01.a0107,-4,2))a0107,a01.a0114a,a01.a0111a,a01.a0192 from a01 inner join a02 on a01.a0000=a02.a0000 and a02.a0201b=#"+gid+"# and a02.a0219=#"+zwlb+"# and a01.a0221=#"+zwzj+"# and a0279=#1#) aa";
		...
		if(list != null && list.size() > 0){
			...
			for (int i = 0; i < list.size(); i++) {
				...
				String stj="";
					...
					String nl ="";
					if(nianl!=null&&nianl.length==1){
						nl =nianl[0]+"0";//年龄
					}
					if(nianl!=null&&nianl.length==2){
						nl =nianl[0]+nianl[1];//年龄
					}
			...
			//if(parall!=null&&parall.indexOf("null")>0){
				parall = parall.replaceAll("null", "");
			//}
			//if(sls!=null&&sls.indexOf("null")>0){
				sls = sls.replaceAll("null", "");
			//}
				...
				if("nl".equals(objects[0])){//年龄
					...
					for (Object object : objects) {
						if("51-55岁".equals(object)){
							...
							String sql1="select count(1) from (select distinct a01.a0000,GET_BIRTHDAY( a01.a0107,'"+DateUtil.getcurdate()+"')a0111 from a01 inner join a02 on a01.a0000=a02.a0000 and a02.a0201b='"+gid+"') aa where aa.a0111='"+arrayList.get(0)+"' ";	
							BigDecimal cou = (java.math.BigDecimal) sess.createSQLQuery(sql1).uniqueResult();
							count = cou.toString();
							fc = "select * from (select distinct a01.a0000,GET_BIRTHDAY( a01.a0107,#"+DateUtil.getcurdate()+"#)a0111,a01.a0141 , a01.a0101,(CASE a01.a0104 WHEN #1# THEN #男# else #女# end)a0104,(substr (a01.a0107,1,4)||#.#||substr (a01.a0107,-4,2))a0107, a01.a0114a,a01.a0111a,a01.a0192 from a01 inner join a02 on a01.a0000=a02.a0000 and a02.a0201b=#"+gid+"#) aa where aa.a0111=#"+arrayList.get(0)+"#";
						}
						nl+=object+",";
					}
	 ...
	 * */
	@PageEvent("jgysmc")
	public int jgysmc(String gid) throws RadowException{
		HBSession sess =HBUtil. getHBSession ();
		...
		if(list != null && list.size() > 0){
			...
			for (int i = 0; i < list2.size(); i++) {
				...
				if("nl".equals(objects[0])){//年龄
					for (Object object : objects) {
						...
						if("51-55岁".equals(object)){
							...
							if(!"0".equals(count)){
							 ...
							 String pjnl = (String)objects[2];
							 Pattern pattern = Pattern.compile("\\d+");//>=&xx取&后面年龄
							 Matcher matcher = pattern.matcher(pjnl);
							 ...
							 ArrayList<String> arrayList = new ArrayList<String>();
							 while(matcher.find()){
								 arrayList.add(matcher.group());//取平均年龄
							}
							String sql1="select count(1) from (select distinct a01.a0000,GET_BIRTHDAY( a01.a0107,'"+DateUtil.getcurdate()+"')a0111 from a01 inner join a02 on a01.a0000=a02.a0000 and a02.a0201b='"+gid+"') aa where aa.a0111='"+arrayList.get(0)+"' ";	
							BigDecimal cou = (java.math.BigDecimal) sess.createSQLQuery(sql1).uniqueResult();
							count = cou.toString();
					...
					String count="";
					String sql2="select count(1) from (select distinct a01.a0000,modelconfig.source from a01 inner join a02 on a01.a0000=a02.a0000 left join MODELCONFIG on a01.a0000=MODELCONFIG.id and a02.a0201b='"+gid+"') aa where  aa.source=( select code_value from code_value where code_name='"+objects[1]+"') and aa.a0000='"+obj[0]+"'";
					BigDecimal cou = (java.math.BigDecimal) sess.createSQLQuery(sql2).uniqueResult();
					count = cou.toString();
					if(!"0".equals(count)){
						 count="Y";
					...
					String count="";
					String sql2="select count(1) from (select distinct a01.a0000,modelconfig.expertise from a01 inner join a02 on a01.a0000=a02.a0000 left join MODELCONFIG on a01.a0000=MODELCONFIG.id and a02.a0201b='"+gid+"') aa where  aa.expertise=( select code_value from code_value where code_name='"+objects[1]+"') and aa.a0000='"+obj[0]+"'";
					BigDecimal cou = (java.math.BigDecimal) sess.createSQLQuery(sql2).uniqueResult();
					count = cou.toString();
					if(!"0".equals(count)){
						 count="Y";
					...
					String count = "";
					String sql2="select count(1) from (select distinct a01.a0000,modelconfig.region from a01 inner join a02 on a01.a0000=a02.a0000 left join MODELCONFIG on a01.a0000=MODELCONFIG.id and a02.a0201b='"+gid+"') aa where  aa.region=( select code_value from code_value where code_name='"+objects[1]+"') and aa.a0000='"+obj[0]+"'";
					BigDecimal cou = (java.math.BigDecimal) sess.createSQLQuery(sql2).uniqueResult();
					count = cou.toString();
					if(!"0".equals(count)){
						 count="Y";
					...
					String count="";
					String sql2="select count(1) from (select distinct a01.a0000,modelconfig.ability from a01 inner join a02 on a01.a0000=a02.a0000 left join MODELCONFIG on a01.a0000=MODELCONFIG.id and a02.a0201b='"+gid+"') aa where  aa.ability=( select code_value from code_value where code_name='"+objects[1]+"') and aa.a0000='"+obj[0]+"'";
					BigDecimal cou = (java.math.BigDecimal) sess.createSQLQuery(sql2).uniqueResult();
					count = cou.toString();
					if(!"0".equals(count)){
						 count="Y";
					...
					String count="";
					String sql2="select count(1) from (select distinct a01.a0000,modelconfig.experience from a01 inner join a02 on a01.a0000=a02.a0000 left join MODELCONFIG on a01.a0000=MODELCONFIG.id and a02.a0201b='"+gid+"') aa where  aa.experience=( select code_value from code_value where code_name='"+objects[1]+"') and aa.a0000='"+obj[0]+"'";
					BigDecimal cou = (java.math.BigDecimal) sess.createSQLQuery(sql2).uniqueResult();
					count = cou.toString();
					if(!"0".equals(count)){
						 count="Y";
					...
					String count="";
					String sql2="select count(1) from (select distinct a01.a0000,modelconfig.undergo from a01 inner join a02 on a01.a0000=a02.a0000 left join MODELCONFIG on a01.a0000=MODELCONFIG.id and a02.a0201b='"+gid+"') aa where  aa.undergo=( select code_value from code_value where code_name='"+objects[1]+"') and aa.a0000='"+obj[0]+"'";
					BigDecimal cou = (java.math.BigDecimal) sess.createSQLQuery(sql2).uniqueResult();
					count = cou.toString();
					if(!"0".equals(count)){
						 count="Y";
					...
					String count="";
					String sql2="select count(1) from (select distinct a01.a0000,modelconfig.tenuresystem from a01 inner join a02 on a01.a0000=a02.a0000 left join MODELCONFIG on a01.a0000=MODELCONFIG.id and a02.a0201b='"+gid+"') aa where  aa.tenuresystem=( select code_value from code_value where code_name='"+objects[1]+"') and aa.a0000='"+obj[0]+"'";
					BigDecimal cou = (java.math.BigDecimal) sess.createSQLQuery(sql2).uniqueResult();
					count = cou.toString();
					if(!"0".equals(count)){
						 count="Y";
