...
public class SGGBTJB2 {
	public static String expData(){
		try {
			String sql  = HBUtil.getValueFromTab("comments", "sourcetable", "table_name='SGGBTJB2'");
	...
	public static String expData2(){
		try {
			String sql  = HBUtil.getValueFromTab("comments", "sourcetable", "table_name='SGGBTJB21'");
			CommQuery cqbs=new CommQuery();
			List<HashMap<String, Object>> listCode=cqbs.getListBySQL(sql.toString());
			JSONArray  updateunDataStoreObject = JSONArray.fromObject(listCode);
