 ...
 *
 */
public class ProfessSkillAddPagePageModel extends PageModel {	
	...
	public int initX() throws RadowException, AppException {
		String a0000 = this.getPageElement("subWinIdBussessId").getValue();//String a0000 = this.getRadow_parent_data();
	...
	public int deleteRow(String a0600)throws RadowException, AppException{
		...
		try {
			...
			//记录删除了哪条
			applog.createLog("3063", "A06", a01.getA0000(), a01.getA0101(), "删除记录", new Map2Temp().getLogInfo(a06, new A06()));
