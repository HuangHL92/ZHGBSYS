 ...
 */
public class WorkUnitsNiRenAddPagePageModel extends PageModel {
    ...
    public int initX() throws RadowException, AppException {
        ...
        try {
            ...
            if (a01.getA0195() != null) {
                ...
                if (a0195 != null) {
                    this.getPageElement("a0195_val").setValue(a0195);//机构名称 中文。
                }
            }
            //是否具有两年以上基层工作经历为空
            if (a01.getA0197() == null || a01.getA0197().equals("")) {
