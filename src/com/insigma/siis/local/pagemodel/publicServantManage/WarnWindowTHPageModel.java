...
public class WarnWindowTHPageModel extends PageModel{
	...
	public static void setSyDayCount(int syDayCount) {
		WarnWindowTHPageModel.syDayCount = syDayCount;
	}
	
	public static void setBirthDaycount(int birthDaycount) {
		WarnWindowTHPageModel.birthDaycount = birthDaycount;
	}
