 ...
 *
 */
public class RewardPunishAddPagePageModel extends PageModel {	
	...
	public int saveRewardPunish()throws RadowException, AppException{
		...
		String a1423 = this.getPageElement("a1423").getValue();//影响期
		...
		/*	if(a1411a == null || "".equals(a1411a)){
			...
			if(a1423!=null&&!"".equals(a1423)&&a1407!=null&&!"".equals(a1407)){
				if(a1423.length()==6){
					a1423 += "00";
				}
				if(a1407.length()==6){
				...
				if(a1423.compareTo(a1407)<0){
					this.setMainMessage("影响期不能早于批准日期");
					return EventRtnType.NORMAL_SUCCESS;
				}
			}
...
/***********************************************奖惩情况(a14)*********************************************************************/
	...
	public int rewardPunishGridOnRowClick() throws RadowException{ 
		...
		String a1400 = this.getPageElement("RewardPunishGrid").getValue("a1400",index)+"";
		...
		try {
			...
			PMPropertyCopyUtil.copyObjValueToElement(a14, this);
			/*if(a14.getA1404b().startsWith("02")){
				this.getExecuteSG().addExecuteCode("document.getElementById('chufa').style.visibility='visible';");
			}else{
				this.getExecuteSG().addExecuteCode("document.getElementById('chufa').style.visibility='hidden';");
			}*/
		} catch (Exception e) {
			this.setMainMessage("查询失败！");
			return EventRtnType.FAILD;
	...
	public int appendonClick() throws RadowException{
		...
		//奖惩名称代码
		String a1404b = this.getPageElement("RewardPunishGrid").getValue("a1404b",index)+"";
		//奖惩名称
		String a1404a = this.getPageElement("RewardPunishGrid").getValue("a1404a",index)+"";
		//批准机关
		String a1411a = this.getPageElement("RewardPunishGrid").getValue("a1411a",index)+"";
		//批准时间
		String a1407 = this.getPageElement("RewardPunishGrid").getValue("a1407",index)+"";
		
		//备注
		String a1499 = this.getPageElement("RewardPunishGrid").getValue("a1499",index)+"";
		...
		if(a1499!=null&&!"".equals(a1499)){
			...
			if(a1404b.startsWith("01") || a1404b.startsWith("1")||a1404b.startsWith("A")||a1404b.startsWith("B")){//奖
	...
	public int addAllonClick() throws RadowException{
		...
		if(list!=null&&list.size()>0){
			...
			for(HashMap<String, Object> map : list){
				...
				//根据贵州客户要求，如果填写了A1499备注字段，则直接取备注里面的文字
				String a1499 = map.get("a1499")+""; 
				if(a1499!=null&&!"".equals(a1499)){
					desc.insert(0, a1499+"；");
				}
				else{
					//奖惩名称代码
					String a1404b = map.get("a1404b")+"";
					//奖惩名称
					String a1404a = map.get("a1404a")+"";
					//批准机关
					String a1411a = map.get("a1411a")+"";
					...
					if(a1404b.startsWith("01")||a1404b.startsWith("A")||a1404b.startsWith("B")){//奖
						//desc.append("经"+a1411a+"批准，").append(a1404a+"。");
	...
	public int deleteRow(String a1400)throws RadowException, AppException{
		...
		try {
			...
			//记录删除了哪条
			applog.createLog("3143", "A14", a01.getA0000(), a01.getA0101(), "删除记录", new Map2Temp().getLogInfo(a14, new A14()));
	...
	private void change_visiable(A14 a14) throws RadowException{
		...
		String a1499 = a14.getA1499();//备注
		if(a1499!=null&&!"".equals(a1499)){
			System.out.println(a1499);
			description = description.replaceAll(a1499.toString().trim(), "");
		}
