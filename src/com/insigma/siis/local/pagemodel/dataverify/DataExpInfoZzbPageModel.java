...
public class DataExpInfoZzbPageModel extends PageModel{
	...
	public int doInit() throws RadowException {
		...
		//MYSQL数据库上报按钮，是否显示控制
		String mysqlexport_isuseful = (String) sess.createSQLQuery("select aaa005 from aa01 where aaa001 = 'MYSQLEXPORT_ISUSEFUL'").uniqueResult();
