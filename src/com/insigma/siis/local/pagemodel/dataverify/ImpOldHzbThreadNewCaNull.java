...
public class ImpOldHzbThreadNewCaNull implements Runnable {
	...
	private String fxz;
    public ImpOldHzbThreadNewCaNull(String filename, String uuid, String b0111new,String a0165, CurrentUser user,UserVO userVo,String fxz) {
        this.uuid = uuid;
	...
	public void run() {
		...
		try {
			...
			if (imprecords != null && imprecords.size() > 0) {
				...
				ImpOldHzbPart1Thread t1 = new ImpOldHzbPart1Thread(userVo, houzhui, imprecordid, uuid, from_file, B0111, deptid, impdeptid, logfilename, control,"1",fxz);
				ImpOldHzbPart1Thread t2 = new ImpOldHzbPart1Thread(userVo, houzhui, imprecordid, uuid, from_file, B0111, deptid, impdeptid, logfilename, control,"2",fxz);
