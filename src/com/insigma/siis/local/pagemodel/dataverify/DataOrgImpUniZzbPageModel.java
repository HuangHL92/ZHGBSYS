...
public class DataOrgImpUniZzbPageModel extends PageModel {
...
//				String lsry = this.getPageElement("lsry").getValue();
				...
				//String gs = this.getPageElement("gs").getValue();
				//通用格式标记
				String sign = "zip";//7z
				/*if("7z".equals(gs)){
					sign = "7z";
				}else if("zip".equals(gs)){
					sign = "zip";
				}*/
				...
				List vlist = HBUtil.getHBSession().createQuery(" from  VerifyProcess where bsType='1' and result_flag in ('0','1') and batchNum ='"+searchDeptid+"'").list();
