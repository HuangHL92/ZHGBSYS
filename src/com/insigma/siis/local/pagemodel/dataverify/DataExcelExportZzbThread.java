...
public class DataExcelExportZzbThread {
	...
	public DataExcelExportZzbThread(String mbpath,String uuid,CurrentUser user,String fxzry,String gzlbry,String gllbry,String searchDeptid,
	...
	public void copyFile(String sourcefile, String targetDir,String nameIc) throws IOException {
		try{
			File sourceFile =  new File(DataExcelExportZzbThread.PHOTO_PATH +  sourcefile);
...
//			this.exppicture=exppicture;
			...
			if("true".equals(exppicture)){
				...
				CommonQueryBS.systemOut("导出图片路径------"+DataExcelExportZzbThread.PHOTO_PATH+picpath);
	...
	public void exportData11(Sheet sheet,Workbook workbook,CellStyle cellstyle,String tableExt,Map<String, String> codeValues) throws Exception{
		try{
			...
			Cell cell=null;HashMap<String, Object> map=null;
			for(int i=0;i<list.size();i++){
				/*unitname=(String)list.get(i).get("a3001");//是否考录
				if("31".equals(unitname)){
					list.get(i).put("a3001", "离(退)休");	
				}else if("32".equals(unitname)){
					list.get(i).put("a3001", "辞去公职");	
				}else if("33".equals(unitname)){
					list.get(i).put("a3001", "辞退");	
				}else if("34".equals(unitname)){
					list.get(i).put("a3001", "开除");	
				}else if("35".equals(unitname)){
					list.get(i).put("a3001", "死亡");	
				}else if("36".equals(unitname)){
					list.get(i).put("a3001", "非正常死亡");	
				}else if("37".equals(unitname)){
					list.get(i).put("a3001", "因选举退出登记");	
				}else if("39".equals(unitname)){
					list.get(i).put("a3001", "其他");	
				}*/
