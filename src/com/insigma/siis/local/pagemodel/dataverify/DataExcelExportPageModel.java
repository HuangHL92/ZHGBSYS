...
public class DataExcelExportPageModel extends PageModel{

	public DataExcelExportPageModel() {
	}
...
//			}
			...
			DataExcelExportThread thr = new DataExcelExportThread(mbpath1,uuid, user,fxzry,gzlbry,gllbry,searchDeptid,
