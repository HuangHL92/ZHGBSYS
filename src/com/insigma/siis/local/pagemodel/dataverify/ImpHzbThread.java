...
public class ImpHzbThread implements Runnable {
	...
	private String fxz;
    public ImpHzbThread(String filename, String uuid, CurrentUser user,UserVO userVo,String a0165,String fxz) {
        this.uuid = uuid;
	...
	public void run() {
		...
		try {
			...
			if (imprecords != null && imprecords.size() > 0) {
				...
				String[] tables = {"A01","A02","A06","A08","A14","A15","A36","A57","B01","A05","A99Z1","A30","A33","A65"};
