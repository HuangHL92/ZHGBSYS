...
public class BZYPPageModel extends PageModel {
	...
	public  int  init2() throws RadowException{
		...
		try {
			...
			//总体评价
			@SuppressWarnings("unchecked")
			List<String> ztpjs= HBUtil.getHBSession().createSQLQuery("select ztpj from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			...
			//班子不足
			@SuppressWarnings("unchecked")
			List<String> bzbzs= HBUtil.getHBSession().createSQLQuery("select bzbz from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			...
			//优化建议
			@SuppressWarnings("unchecked")
			List<String> yhjys= HBUtil.getHBSession().createSQLQuery("select yhjy from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			if(yhjys.size()>0 && yhjys.get(0)!=null) {
				yhjy.append(String.valueOf(yhjys.get(0)));
			}
			//本地 干部
			/*@SuppressWarnings("unchecked")
			List<String> bdgb1= HBUtil.getHBSession().createSQLQuery("select bdgb from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			if(bdgb1.size()>0 && bdgb1.get(0)!=null) {
				bdgb.append(String.valueOf(bdgb1.get(0)));
			}*/
			//本届以来新提任
			/*@SuppressWarnings("unchecked")
			List<String> bjylxtr1= HBUtil.getHBSession().createSQLQuery("select bjylxtr from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			...
			//基本概况
			@SuppressWarnings("unchecked")
			List<String> jbgks1= HBUtil.getHBSession().createSQLQuery(" select to_char(substr(jbgk,0,2000)) from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			if(jbgks1.size()>0 && jbgks1.get(0)!=null) {
				jbgk.append(String.valueOf(jbgks1.get(0)));
			}
			@SuppressWarnings("unchecked")
			List<String> jbgks2= HBUtil.getHBSession().createSQLQuery(" select to_char(substr(jbgk,2001,2000)) from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			if(jbgks2.size()>0 && jbgks2.get(0)!=null) {
				jbgk.append(String.valueOf(jbgks2.get(0)));
			}
			@SuppressWarnings("unchecked")
			List<String> jbgks3= HBUtil.getHBSession().createSQLQuery(" select to_char(substr(jbgk,4001,2000)) from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			if(jbgks3.size()>0 && jbgks3.get(0)!=null) {
				jbgk.append(String.valueOf(jbgks3.get(0)));
			}
			@SuppressWarnings("unchecked")
			List<String> jbgks4= HBUtil.getHBSession().createSQLQuery(" select to_char(substr(jbgk,6001,2000)) from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			if(jbgks4.size()>0 && jbgks4.get(0)!=null) {
				jbgk.append(String.valueOf(jbgks4.get(0)));
			}
			@SuppressWarnings("unchecked")
			List<String> jbgks5= HBUtil.getHBSession().createSQLQuery(" select to_char(substr(jbgk,8001,2000)) from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			...
			//发展定位
			@SuppressWarnings("unchecked")
			List<String> fzdws= HBUtil.getHBSession().createSQLQuery("select to_char(substr(fzdw,0,2000)) fzdw from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			if(fzdws.size()>0 && fzdws.get(0)!=null) {
				fzdw.append(String.valueOf(fzdws.get(0)));
			}
			@SuppressWarnings("unchecked")
			List<String> fzdws1= HBUtil.getHBSession().createSQLQuery("select to_char(substr(fzdw,2001,2000)) fzdw from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			if(fzdws1.size()>0 && fzdws1.get(0)!=null) {
				fzdw.append(String.valueOf(fzdws1.get(0)));
			}
			@SuppressWarnings("unchecked")
			List<String> fzdws2= HBUtil.getHBSession().createSQLQuery("select to_char(substr(fzdw,4001,2000)) fzdw from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			if(fzdws2.size()>0 && fzdws2.get(0)!=null) {
				fzdw.append(String.valueOf(fzdws2.get(0)));
			}
			@SuppressWarnings("unchecked")
			List<String> fzdws3= HBUtil.getHBSession().createSQLQuery("select to_char(substr(fzdw,6001,2000)) fzdw from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			if(fzdws3.size()>0 && fzdws3.get(0)!=null) {
				fzdw.append(String.valueOf(fzdws3.get(0)));
			}
			@SuppressWarnings("unchecked")
			List<String> fzdws4= HBUtil.getHBSession().createSQLQuery("select to_char(substr(fzdw,8001,2000)) fzdw from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
...
//		}
	...
	public  int  init5() throws RadowException{
		...
		StringBuffer jqkjybsyrx=new StringBuffer();
		StringBuffer bxyxddwgb=new StringBuffer();
		StringBuffer bxyxdvgb=new StringBuffer();
		StringBuffer bxyxdnqgb=new StringBuffer();
		StringBuffer syxnqgb=new StringBuffer();
		StringBuffer snqgb=new StringBuffer();
		...
		try {
			...
			//近期可进一步使用人选 03
			@SuppressWarnings("unchecked")
			List<String> syrx= HBUtil.getHBSession().createSQLQuery("select distinct(a1.a0101) from code_value c，historymd a ,historyper b,a01 a1 ,a02 a2 where code_type='GZMD01' \r\n" + 
					"and c.code_value=a.bqtype		\r\n" + 
					"and a.mdid=b.mdid \r\n" + 
					"and b.a0000=a1.a0000 \r\n" + 
					"and a1.a0000 =a2.a0000\r\n" + 
					"and a1.A0163='1'\r\n" + 
					"and a1.status='1'\r\n" + 
					"and a2.a0255='1' \r\n" + 
					"and a2.a0281='true' \r\n" + 
					"and a.bqtype='03'   and a2.a0201b='"+checkedgroupid+"'").list();
			if(syrx.size()>0) {
				for(int i=0;i<syrx.size();i++) {
					jqkjybsyrx.append("<a>"+String.valueOf(syrx.get(i))+"</a>，");
					}
					if(jqkjybsyrx.length()>0){
						jqkjybsyrx.deleteCharAt(jqkjybsyrx.length()-1);
					}
			}
			//表现优秀的党外干部 06
			@SuppressWarnings("unchecked")
			List<String> bxyx= HBUtil.getHBSession().createSQLQuery("select distinct(a1.a0101) from code_value c，historymd a ,historyper b,a01 a1 ,a02 a2 where code_type='GZMD01' \r\n" + 
					"and c.code_value=a.bqtype		\r\n" + 
					"and a.mdid=b.mdid \r\n" + 
					"and b.a0000=a1.a0000 \r\n" + 
					"and a1.a0000 =a2.a0000\r\n" + 
					...
					"and a2.a0255='1' \r\n" + 
					"and a2.a0281='true' \r\n" + 
					"and a.bqtype='06'  and a2.a0201b='"+checkedgroupid+"'").list();
			if(bxyx.size()>0) {
				for(int i=0;i<bxyx.size();i++) {
					bxyxddwgb.append("<a>"+String.valueOf(bxyx.get(i))+"</a>，");
					}
					if(bxyxddwgb.length()>0){
						bxyxddwgb.deleteCharAt(bxyxddwgb.length()-1);
					}
			}
			//表现优秀的女干部 07
			@SuppressWarnings("unchecked")
			List<String> bxyxvgb= HBUtil.getHBSession().createSQLQuery("select distinct(a1.a0101) from code_value c，historymd a ,historyper b,a01 a1 ,a02 a2 where code_type='GZMD01' \r\n" + 
					"and c.code_value=a.bqtype		\r\n" + 
					"and a.mdid=b.mdid \r\n" + 
					"and b.a0000=a1.a0000 \r\n" + 
					"and a1.a0000 =a2.a0000\r\n" + 
					...
					"and a2.a0255='1' \r\n" + 
					"and a2.a0281='true' \r\n" + 
					"and a.bqtype='07'  and a2.a0201b='"+checkedgroupid+"'").list();
			if(bxyxvgb.size()>0) {
				for(int i=0;i<bxyxvgb.size();i++) {
					bxyxdvgb.append("<a>"+String.valueOf(bxyxvgb.get(i))+"</a>，");
					}
					if(bxyxdvgb.length()>0){
						bxyxdvgb.deleteCharAt(bxyxdvgb.length()-1);
					}
			}
			//表现优秀的年轻干部 08
			@SuppressWarnings("unchecked")
			List<String> bxyxnqgb= HBUtil.getHBSession().createSQLQuery("select distinct(a1.a0101) from code_value c，historymd a ,historyper b,a01 a1 ,a02 a2 where code_type='GZMD01' \r\n" + 
					"and c.code_value=a.bqtype		\r\n" + 
					"and a.mdid=b.mdid \r\n" + 
					"and b.a0000=a1.a0000 \r\n" + 
					"and a1.a0000 =a2.a0000\r\n" + 
					...
					"and a2.a0255='1' \r\n" + 
					"and a2.a0281='true' \r\n" + 
					"and a.bqtype='08'  and a2.a0201b='"+checkedgroupid+"'").list();
			if(bxyxnqgb.size()>0) {
				for(int i=0;i<bxyxnqgb.size();i++) {
					bxyxdnqgb.append("<a>"+String.valueOf(bxyxnqgb.get(i))+"</a>，");
					}
					if(bxyxdvgb.length()>0){
						bxyxdnqgb.deleteCharAt(bxyxdnqgb.length()-1);
					}
			}
			//省优秀年轻干部	 10
			@SuppressWarnings("unchecked")
			List<String> syx= HBUtil.getHBSession().createSQLQuery("select distinct(a1.a0101) from code_value c，historymd a ,historyper b,a01 a1 ,a02 a2 where code_type='GZMD01' \r\n" + 
					"and c.code_value=a.bqtype		\r\n" + 
					"and a.mdid=b.mdid \r\n" + 
					"and b.a0000=a1.a0000 \r\n" + 
					"and a1.a0000 =a2.a0000\r\n" + 
					...
					"and a2.a0255='1' \r\n" + 
					"and a2.a0281='true' \r\n" + 
					"and a.bqtype='10'  and a2.a0201b='"+checkedgroupid+"'").list();
			if(syx.size()>0) {
				for(int i=0;i<syx.size();i++) {
					syxnqgb.append("<a>"+String.valueOf(syx.get(i))+"</a>，");
					}
					if(bxyxdvgb.length()>0){
						syxnqgb.deleteCharAt(syxnqgb.length()-1);
					}
			}
			//市优秀年轻干部 11
			@SuppressWarnings("unchecked")
			List<String> sgb= HBUtil.getHBSession().createSQLQuery("select distinct(a1.a0101) from code_value c，historymd a ,historyper b,a01 a1 ,a02 a2 where code_type='GZMD01' \r\n" + 
					"and c.code_value=a.bqtype		\r\n" + 
					"and a.mdid=b.mdid \r\n" + 
					"and b.a0000=a1.a0000 \r\n" + 
					"and a1.a0000 =a2.a0000\r\n" + 
					...
					"and a2.a0255='1' \r\n" + 
					"and a2.a0281='true' \r\n" + 
					"and a.bqtype='11'  and a2.a0201b='"+checkedgroupid+"'").list();
			if(sgb.size()>0) {
				for(int i=0;i<sgb.size();i++) {
					snqgb.append("<a>"+String.valueOf(sgb.get(i))+"</a>，");
					}
					if(bxyxdvgb.length()>0){
						snqgb.deleteCharAt(snqgb.length()-1);
					}
			}
		}catch (Exception e) {
			e.printStackTrace();
...
//		this.getExecuteSG().addExecuteCode("document.getElementById(\"xgzfz\").innerHTML='"+xgzfz.toString()+"'");
		this.getExecuteSG().addExecuteCode("document.getElementById(\"jqkjybsyrx\").innerHTML='"+jqkjybsyrx.toString()+"'");
		this.getExecuteSG().addExecuteCode("document.getElementById(\"bxyxddwgb\").innerHTML='"+bxyxddwgb.toString()+"'");
		this.getExecuteSG().addExecuteCode("document.getElementById(\"bxyxdvgb\").innerHTML='"+bxyxdvgb.toString()+"'");
		this.getExecuteSG().addExecuteCode("document.getElementById(\"bxyxdnqgb\").innerHTML='"+bxyxdnqgb.toString()+"'");
		this.getExecuteSG().addExecuteCode("document.getElementById(\"syxnqgb\").innerHTML='"+syxnqgb.toString()+"'");
		this.getExecuteSG().addExecuteCode("document.getElementById(\"snqgb\").innerHTML='"+snqgb.toString()+"'");
	...
	public  int  init6() throws RadowException{
		...
		try {
			//班子研判建议
			@SuppressWarnings("unchecked")
			List<String> bzypjyb= HBUtil.getHBSession().createSQLQuery("select bzypjy from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			...
			//班子专业性默认
			@SuppressWarnings("unchecked")
			List<String> zyxbm= HBUtil.getHBSession().createSQLQuery("select zyxbm from BZFX where BZFX.B0111='"+checkedgroupid+"'").list();
			if(zyxbm.size()>0) {
...
//			 System.out.print(zyzb);
	...
	public int saveFX() throws RadowException, AppException {
		...
		bzfx.setFzdw(fzdw);
		this.copyElementsValueToObj(bzfx, this);
		HBSession sess = null;
		...
		try {
			...
			@SuppressWarnings("unchecked")
			List<String> b0111= HBUtil.getHBSession().createSQLQuery("select b0111 from BZFX where b0111='"+checkedgroupid+"'").list();
			
			if(b0111.size()>0) {
				@SuppressWarnings("unchecked")
				List<String> bz00s= HBUtil.getHBSession().createSQLQuery("select bz00 from BZFX where b0111='"+checkedgroupid+"'").list();
