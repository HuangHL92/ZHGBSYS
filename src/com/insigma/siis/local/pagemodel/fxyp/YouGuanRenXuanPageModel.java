...
public class YouGuanRenXuanPageModel extends PageModel {
	...
	public int grid1Query(int start, int limit) throws RadowException, AppException, PrivilegeException {
		...
		if(gbmcSql!=null&&!"".equals(gbmcSql)) {
			...
			String retsql = "select  a01.a0000,a01.a0101,a01.a0104,a01.a0107,a0117,a0111a,a0140,a0134,a0196,a01.a0192a,a01.zgxw,a01.zgxl,a01.a0192c,a01.a0288,a0192f ";
			...
			if(sql.contains(replaceSql2)) {
				sql = sql.replace(replaceSql2, retsql);
			}else if (sql.contains(replaceSql)) {
				sql = sql.replace(replaceSql, retsql);
			}
	...
	public static String getCondiQuerySQL(String userid, StringBuffer a01sb, String a01sb1,StringBuffer a02sb, String a02_a0201b_sb,
		...
		if (lablesql == null || "".equals(lablesql.toString())) {
			retsql = "select  a01.a0000,a01.a0101,a01.a0104,a01.a0107,a0117,a0111a,a0140,a0134,a0196,a01.a0192a,a01.zgxw,a01.zgxl,a01.a0192c,a01.a0288,a0192f  from A01 a01 "
					+ " where  1=1 " + orther_sb +
					// xzry +
					a02str + a01sb;
		} else {
			retsql = "select  a01.a0000,a01.a0101,a01.a0104,a01.a0107,a0117,a0111a,a0140,a0134,a0196,a01.a0192a,a01.zgxw,a01.zgxl,a01.a0192c,a01.a0288,a0192f  from A01 a01  inner join ("
