...
public class UserManageWindowPageModel extends PageModel {
	...
	public int doAddUser() throws RadowException{
		...
		try {
			String AREA_ID = HBUtil.getValueFromTab("aaa005","aa01","aaa001='AREA_ID'");
			if("330200".equals(AREA_ID)){//宁波校验  
				PrivilegeManager.getInstance().getIGroupControl().checkGroup(groupid, choosePersonIds("userGrid"));
			}			 
	 ...
	 * 跨辖区不能有多个组
	 */
	private String checkGroup() throws RadowException{
		String groupid = this.getRadow_parent_data();
