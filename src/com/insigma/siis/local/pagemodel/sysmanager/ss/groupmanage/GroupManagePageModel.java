...
//			String areaname = (String) sess.createSQLQuery("select name from smt_group where groupid = 'G001'").uniqueResult();
...
//		}
	...
	public int searchAllBtn() throws RadowException{
		...
		this.openWindow("groupWin", "pages.sysmanager.ss.groupmanage.GroupShowWindow");
	...
	public int saveBtnOnClick() throws RadowException{
		...
		this.openWindow("addWin", "pages.sysmanager.ss.groupmanage.GroupAddWindow"); //事件处理完后的打开窗口事件
	...
	public int doGroupEdit() throws RadowException{
		...
		if(id.equals("")){
			...
			this.openWindow("uptWin", "pages.sysmanager.ss.groupmanage.GroupUptWindow"); //事件处理完后的打开窗口事件
