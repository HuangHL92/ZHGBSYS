...
//		String tabimp = this.getPageElement("tabimp").getValue();
		...
		try {
			...
			if (gjgs!=null && gjgs.equals("1")) {
				...
				this.setMainMessage("只支持HZB格式上报。");
				return EventRtnType.NORMAL_SUCCESS;
			}
			//------------      -------------//
...
//			b.append(" and a2.a0201b in (select b.b0111 from b01 b start with b0111='" + searchDeptid +"' connect by prior b0111=b0121)");
			...
			info.setDatainfo("机构单位信息集数据3条，人员基本信息集2条。");
			...
			String packageFile = "Pack_按机构导出文件_" +b01.getB0114()+"_" +b01.getB0101()+"_" + time1 +".xml";
...
//				String path = getPath();
				...
				String zippath = path + "按机构导出文件_" +b01.getB0111()+"_" +b01.getB0101()+"_" + time1 +"/" + number+"/";
				...
				String zippathtable = path + "按机构导出文件_" +b01.getB0111()+"_" +b01.getB0101()+"_" + time1 +"/" + number +"/Table/";
				...
				String zipfile = localf + "/" + "按机构导出文件_" +b01.getB0114()+"_" +b01.getB0101()+"_" + time1+"_" + number +".7z";
				if (gjgs!=null && gjgs.equals("1")) {
					zipfile = localf + "/" + "按机构导出文件_" +b01.getB0114()+"_" +b01.getB0101()+"_" + time1+"_" + number +".hzb";
