...
public class XmlSAXHandler02ZHGB extends DefaultHandler { 
		...
		public XmlSAXHandler02ZHGB() {
		}
		
		public XmlSAXHandler02ZHGB(String docname, String lowerCase, String table,
					...
					try {
						...
						if(table.equals("A36")){
							if((rowData.get("A3601")==null || rowData.get("A3601").toString().equals(""))
								...
								String A3684 = rowData.get("A3684")!=null?rowData.get("A3684").toString():"";
								rowData.put("A3684", subStringByByte(A3684, 18));
							}
						}
						if(table.equals("A02")){	
							//A02 特殊字符处理
...
//											rowData.put("A0827", "071");
							...
							String A1701 = rowData.get("A1701")!=null?rowData.get("A1701").toString():"";
							rowData.put("A1701", A1701.replaceAll("\u001a", ""));
