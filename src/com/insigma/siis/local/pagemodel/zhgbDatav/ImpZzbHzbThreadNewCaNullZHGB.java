...
import com.insigma.siis.local.pagemodel.dataverify.ImpZzbPart1Thread;
...
public class ImpZzbHzbThreadNewCaNullZHGB implements Runnable {
	...
	private String fxz;
    public ImpZzbHzbThreadNewCaNullZHGB(String filename, String uuid, String b0111new,String a0165, CurrentUser user,UserVO userVo,String fxz) {
        this.uuid = uuid;
	...
	public void run() {
		...
		try {
			...
			if (imprecords != null && imprecords.size() > 0) {
				...
				ImpZzbPart1ThreadZHGB t1 = new ImpZzbPart1ThreadZHGB(userVo, houzhui, imprecordid, uuid, from_file, B0111, deptid, impdeptid, logfilename, control,"1",fxz);
				ImpZzbPart1ThreadZHGB t2 = new ImpZzbPart1ThreadZHGB(userVo, houzhui, imprecordid, uuid, from_file, B0111, deptid, impdeptid, logfilename, control,"2",fxz);
