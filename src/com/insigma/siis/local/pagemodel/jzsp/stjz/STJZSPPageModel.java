...
public class STJZSPPageModel extends PageModel {
	...
	public int doMemberQuery(int start,int limit) throws RadowException{
		...
		String sp0114 = this.getPageElement("sp0114").getValue();
		String where = " and t.sp0114 != '0'";//过滤登记状态
		String daiban = "";
		/*if(sp0102!=null&&!"".equals(sp0102)){
			where += " and t.sp0102 like '%"+sp0102+"%'";
		}*/
		if(sp0114!=null&&!"".equals(sp0114)&&!"all".equals(sp0114)){
			if("99".equals(sp0114)){
				//待办
				where += " and t.sp0114 = '1' and t.spp00 is null ";
				daiban = " and 1=2 ";
			}else{
				where += " and t.sp0114 like '%"+sp0114+"%'";
			}
		}
		String sql="select t.sp0100,t.a0000,t.sp0102,t.sp0103,t.sp0104,t.sp0106,"
				+ " t.sp0107,t.sp0108 ,b.spb03,b.spb04,b.spb02,t.sp0114 "
				+ " from SP01 t left join SP_BUS b on t.sp0100=b.spb00 "
				+ " where (exists "
				+ " (select 1 from SP_BUS_LOG s where s.spb00=t.sp0100 and "
				+ " s.spbl01='"+SysManagerUtils.getUserId()+"' "+daiban+") "
				+ " or ((b.spb03='"+SysManagerUtils.getUserId()+"' "
				+ " or b.spb04='"+SysManagerUtils.getUserGroupid()+"') and b.spb02!=0)) "+where+" order by t.sp0116 desc";
