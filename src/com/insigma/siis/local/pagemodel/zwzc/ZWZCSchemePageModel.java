...
public class ZWZCSchemePageModel extends PageModel{
	
	public ZWZCSchemePageModel(){
	}
...
//				HBUtil.executeUpdate("insert into EVALUATION_TARGET_scheme(zwzc00,a0192a,ets02,ets04) values(?,?,seq_sort.nextval,?)",
//						new Object[]{zwzc00,a0192a,userID});
//			}else{
//				HBUtil.executeUpdate("update EVALUATION_TARGET_scheme set a0192a=? where zwzc00=?",
//						new Object[]{a0192a,zwzc00});
//			}
			String selsql = "select '"+zwzc00+"',b01id from b01 where 1=1 "+ b0111_sb;
			HBUtil.executeUpdate("delete from A02_ZWZC_ORGREF  where zwzc00=?",
					new Object[]{zwzc00});
			String insertSQL = "insert into A02_ZWZC_ORGREF(zwzc00,b01id) ("+selsql+")";
...
//        }
	...
	public String getJson(String type,String nodeother,String sign){
		...
		String zwzc00 = this.getParameter("zwzc00");
		...
		if("system".equals(loginName)){//system用户不加权限
			...
			sql=" select ("+sql1+") count1, t.b0111,t.b0121,t.b0101,t.b0107,t.sortid,t.b0194,(select 'true' from A02_ZWZC_ORGREF t1 where t1.b01id=t.b01id and t1.zwzc00='"+zwzc00+"') checked from "+b01Table+" t where t.b0121='"+node+"'  order by t.sortid asc ";			
		}else{
			...
			sql=" select ("+sql1+") count1, t.b0111,t.b0121,t.b0101,t.b0107,t.sortid,t.b0194,(select 'true' from A02_ZWZC_ORGREF t1 where t1.b01id=t.b01id and t1.zwzc00='"+zwzc00+"') checked from "+b01Table+" t,"+deptTable+" s where t.b0111=s.b0111 and t.b0121='"+node+"' and s.userid='"+cueUserid+"' order by t.sortid asc ";
		}
