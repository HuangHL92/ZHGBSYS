...
public class ZjXmlSAXHandler02 extends DefaultHandler {
	...
	public ZjXmlSAXHandler02() {
	}

	@SuppressWarnings("rawtypes")
	public ZjXmlSAXHandler02(String docname, String lowerCase, String table, String imprecordid, int t_n, String uuid, String from_file, String B0111, String deptid, String impdeptid, Connection conn1, PreparedStatement pstmt1, List colomns, int batchNum) {
		super();
		...
		if (!isError && (qName.equals("z:row") || qName.equals("row"))) {
			...
			if (attributes.getLength() > 0) {
				...
				try {
					// --------------------------------------------------------------------------------------------------------------
					if (table.equals("A36")) {
						if ((rowData.get("A3601") == null || rowData.get("A3601").toString().equals("")) && (rowData.get("A3604A") == null || rowData.get("A3604A").toString().equals("")) && (rowData.get("A3607") == null || rowData.get("A3607").toString().equals("")) && (rowData.get("A3611") == null || rowData.get("A3611").toString().equals("")) && (rowData.get("A3627") == null || rowData.get("A3627").toString().equals(""))) {
							return;
						} else {
					...
					} else if ("Extra_Tags".equalsIgnoreCase(table) || "A0193_Tag".equalsIgnoreCase(table) || "A0194_Tag".equalsIgnoreCase(table) || "Tag_Rclx".equalsIgnoreCase(table) || "Tag_Cjlx".equalsIgnoreCase(table) || "Tag_Sbjysjl".equalsIgnoreCase(table) || "Tag_Kcclfj".equalsIgnoreCase(table)) {
						String CREATEDATE = rowData.get("CREATEDATE") != null ? rowData.get("CREATEDATE").toString() : "";
						String UPDATEDATE = rowData.get("UPDATEDATE") != null ? rowData.get("UPDATEDATE").toString() : "";
						rowData.put("CREATEDATE", DateUtil.stringToTime2(CREATEDATE));
						rowData.put("UPDATEDATE", DateUtil.stringToTime2(UPDATEDATE));
					} else if ("Tag_Kcclfj2".equalsIgnoreCase(table) || "Tag_Ndkhdjbfj".equalsIgnoreCase(table) || "Tag_Dazsbfj".equalsIgnoreCase(table)) {
						String UPDATEDATE = rowData.get("UPDATEDATE") != null ? rowData.get("UPDATEDATE").toString() : "";
						rowData.put("UPDATEDATE", DateUtil.stringToTime2(UPDATEDATE));
					...
					for (int j = 0; j < colomns.size(); j++) {
						if ((lowerCase.equalsIgnoreCase("7z") || lowerCase.equalsIgnoreCase("zip")) && ("A0200".equals(colomns.get(j).toString().toUpperCase()) || "A0500".equals(colomns.get(j).toString().toUpperCase()) || "A0600".equals(colomns.get(j).toString().toUpperCase()) || "A0800".equals(colomns.get(j).toString().toUpperCase()) || "A1400".equals(colomns.get(j).toString().toUpperCase()) || "A1500".equals(colomns.get(j).toString().toUpperCase()) || "A3600".equals(colomns.get(j).toString().toUpperCase()) || "A99Z100".equals(colomns.get(j).toString().toUpperCase()) || "TAGID".equals(colomns.get(j).toString().toUpperCase()))) {
							pstmt1.setObject(j + 1, UUID.randomUUID().toString());
						} else {
							if ("A3038".equalsIgnoreCase(colomns.get(j).toString())) {
								pstmt1.setObject(j + 1, rowData.get(colomns.get(j).toString().toUpperCase()) == null || rowData.get(colomns.get(j).toString().toUpperCase()).equals("") ? null : subStringByByte(rowData.get(colomns.get(j).toString().toUpperCase()).toString(), 100));

							} else {
								pstmt1.setObject(j + 1, rowData.get(colomns.get(j).toString().toUpperCase()) == null || rowData.get(colomns.get(j).toString().toUpperCase()).equals("") ? null : rowData.get(colomns.get(j).toString().toUpperCase()));
							}
						}
					}
					pstmt1.addBatch();
