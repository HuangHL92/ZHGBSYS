...
public class ZjImpZzbHzbThreadNew implements Runnable {
	
	private String uuid;
	private String filename;
	private CurrentUser user;
	private UserVO userVo;
    public ZjImpZzbHzbThreadNew(String filename, String uuid, CurrentUser user,UserVO userVo) {
        this.uuid = uuid;
	...
	public void run() {
		...
		try {
			...
			if (imprecords != null && imprecords.size() > 0) {
				...
				ZjImpZzbPart1Thread t1 = new ZjImpZzbPart1Thread(userVo, houzhui, imprecordid, uuid, from_file, B0111, deptid, impdeptid, logfilename, control,"1","");
				ZjImpZzbPart1Thread t2 = new ZjImpZzbPart1Thread(userVo, houzhui, imprecordid, uuid, from_file, B0111, deptid, impdeptid, logfilename, control,"2","");
