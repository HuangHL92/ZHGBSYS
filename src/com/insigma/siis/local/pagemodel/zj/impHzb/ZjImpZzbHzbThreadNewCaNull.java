...
public class ZjImpZzbHzbThreadNewCaNull implements Runnable {
	...
	private String fxz;
    public ZjImpZzbHzbThreadNewCaNull(String filename, String uuid, String b0111new,String a0165, CurrentUser user,UserVO userVo,String fxz) {
        this.uuid = uuid;
	...
	public void run() {
		...
		try {
			...
			if (imprecords != null && imprecords.size() > 0) {
				...
				ZjImpZzbPart1Thread t1 = new ZjImpZzbPart1Thread(userVo, houzhui, imprecordid, uuid, from_file, B0111, deptid, impdeptid, logfilename, control,"1",fxz);
				ZjImpZzbPart1Thread t2 = new ZjImpZzbPart1Thread(userVo, houzhui, imprecordid, uuid, from_file, B0111, deptid, impdeptid, logfilename, control,"2",fxz);
