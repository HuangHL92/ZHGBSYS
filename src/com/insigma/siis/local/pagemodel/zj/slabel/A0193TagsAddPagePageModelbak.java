 ...
 *
 */
public class A0193TagsAddPagePageModelbak extends PageModel {
	...
	public int saveA0193zInfo() throws RadowException, AppException {
		...
		try {
			...
			String tag0101n = this.getPageElement("tag0101n").getValue();
			if (tag0101 != null && ("1".equals(tag0101) || "on".equals(tag0101))) {
				...
				a0193tag.setA0193c(tag0101n);
				sess.save(a0193tag);
			}
			String tag0102 = this.getPageElement("tag0102").getValue();
			String tag0102n = this.getPageElement("tag0102n").getValue();
			if (tag0102 != null && ("1".equals(tag0102) || "on".equals(tag0102))) {
				a0193z = returnA0193z("0102", a0193z);
				A0193Tag a0193tag = new A0193Tag();
				a0193tag.setA0000(a0000);
				a0193tag.setTagid(UUID.randomUUID().toString());
				a0193tag.setCreatedate(curTime);
				a0193tag.setA0193("0102");
				a0193tag.setA0184(a01.getA0184());
				a0193tag.setA0193c(tag0102n);
				sess.save(a0193tag);
			}
			String tag0103 = this.getPageElement("tag0103").getValue();
			String tag0103n = this.getPageElement("tag0103n").getValue();
			if (tag0103 != null && ("1".equals(tag0103) || "on".equals(tag0103))) {
				a0193z = returnA0193z("0103", a0193z);
				A0193Tag a0193tag = new A0193Tag();
				a0193tag.setA0000(a0000);
				a0193tag.setTagid(UUID.randomUUID().toString());
				a0193tag.setCreatedate(curTime);
				a0193tag.setA0193("0103");
				a0193tag.setA0184(a01.getA0184());
				a0193tag.setA0193c(tag0103n);
				sess.save(a0193tag);
			}
			String tag0104 = this.getPageElement("tag0104").getValue();
			String tag0104n = this.getPageElement("tag0104n").getValue();
			if (tag0104 != null && ("1".equals(tag0104) || "on".equals(tag0104))) {
				a0193z = returnA0193z("0104", a0193z);
				A0193Tag a0193tag = new A0193Tag();
				a0193tag.setA0000(a0000);
				a0193tag.setTagid(UUID.randomUUID().toString());
				a0193tag.setCreatedate(curTime);
				a0193tag.setA0193("0104");
				a0193tag.setA0184(a01.getA0184());
				a0193tag.setA0193c(tag0104n);
				sess.save(a0193tag);
			}
			String tag0105 = this.getPageElement("tag0105").getValue();
			if (tag0105 != null && ("1".equals(tag0105) || "on".equals(tag0105))) {
				a0193z = returnA0193z("0105", a0193z);
				A0193Tag a0193tag = new A0193Tag();
				a0193tag.setA0000(a0000);
				a0193tag.setTagid(UUID.randomUUID().toString());
				a0193tag.setCreatedate(curTime);
				a0193tag.setA0193("0105");
				a0193tag.setA0184(a01.getA0184());
				sess.save(a0193tag);
			}
			// 省区市职务
...
/*			String tag0505 = this.getPageElement("tag0505").getValue();
			...
			if (tag1301 != null && ("1".equals(tag1301) || "on".equals(tag1303))) {
			...
			String tag1501n = this.getPageElement("tag1501n").getValue();
			...
			String tag1509n = this.getPageElement("tag1509n").getValue();
			...
			String tag1511n = this.getPageElement("tag1511n").getValue();
