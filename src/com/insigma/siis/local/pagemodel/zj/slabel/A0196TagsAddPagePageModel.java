...
public class A0196TagsAddPagePageModel extends PageModel {
	...
	public int initX() throws RadowException {
		...
		if (extratags != null) {
			this.getPageElement("a0196z").setValue(extratags.getA1401c());
			String a0194s = extratags.getA1401d();
