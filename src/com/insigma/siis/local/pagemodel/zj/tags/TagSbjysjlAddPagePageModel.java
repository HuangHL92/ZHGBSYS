...
import com.insigma.siis.local.business.entity.extra.TagSbjysjl;
...
public class TagSbjysjlAddPagePageModel extends PageModel {
	...
	public int initX() throws RadowException {
		...
		try {
			...
			StringBuffer sql = new StringBuffer("from TagSbjysjl where a0000='" + extraTags.getA0000()
	...
	public int saveTagSbjysjl() throws RadowException, AppException {
		...
		try {
			...
			List<TagSbjysjl> tagSbjysjlListOld = sess.createQuery("from TagSbjysjl where a0000='" + a0000 + "'")
					.list();
			...
			// 人员基本信息界面
			this.getExecuteSG().addExecuteCode("window.realParent.document.getElementById('tagsbjysjlzs').value='"
