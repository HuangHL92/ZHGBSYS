...
public class TagDazsbfjAddPagePageModel extends PageModel {
	...
	String a0000 = this.getPageElement("subWinIdBussessId").getValue();
	String sql = "select tagid, file_url fileurl, file_name filename, file_size filesize, updatedate, note from tag_dazsbfj where a0000='" + a0000 + "' order by updatedate desc";
	...
	String a0000 = this.getPageElement("subWinIdBussessId").getValue();
	String sqlTagDazsbfj = "from TagDazsbfj where a0000='" + a0000 + "' order by updatedate desc";
