...
public class TagNdkhdjbfjAddPagePageModel extends PageModel {
	...
	String a0000 = this.getPageElement("subWinIdBussessId").getValue();
	String sql = "select tagid, file_url fileurl, file_name filename, file_size filesize, updatedate, note from tag_ndkhdjbfj where a0000='" + a0000 + "' order by updatedate desc";
	...
	String a0000 = this.getPageElement("subWinIdBussessId").getValue();
	String sqlTagNdkhdjbfj = "from TagNdkhdjbfj where a0000='" + a0000 + "' order by updatedate desc";
