package com.insigma.siis.local.pagemodel.xbrm2.expword;
		...
		List<String> paths = new ArrayList<String>();
			...
			for (int i = 0; i < a0000s.size(); i++) {
				...
				try {
					...
					dataMap.put("js0108", tphj1[1]==null?"":tphj1[1].toString());
					String a0101 = (String) dataMap.get("a0101");
					doctpl = JSGLPageModel.class.getClassLoader().getResource("./com/insigma/siis/local/pagemodel/xbrm2/tpl/gbrmspb_1.doc").getPath();
