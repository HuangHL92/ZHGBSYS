...
public class formanalysis_syczPageModel extends PageModel{

	public formanalysis_syczPageModel() {
	}
...
//			this.getExecuteSG().addExecuteCode("json_func('1')");//
			...
			this.getExecuteSG().addExecuteCode("json_func('3')");//正职
			...
			this.getExecuteSG().addExecuteCode("json_func('4')");//副职
