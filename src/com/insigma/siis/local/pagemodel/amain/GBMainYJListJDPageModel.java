...
public class GBMainYJListJDPageModel extends PageModel{
	...
	public int doMemberQuery(int start,int limit) throws RadowException{
	  ...
	  if("子女移居国外".equals(query_type)){
		  sql = " select t.*, a01.a0192a" + 
		  		"  from DJDGW t, a01" + 
		  		"  where t.a0000 = a01.a0000 order by lg desc,yjsj desc " ;
	  }
