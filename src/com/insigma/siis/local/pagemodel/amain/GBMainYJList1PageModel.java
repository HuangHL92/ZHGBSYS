...
public class GBMainYJList1PageModel extends PageModel{
	...
	public int doMemberQuery(int start,int limit) throws RadowException{
	  ...
	  String sql = "";
	  String ordersql = " order by  ((select rpad(b0269, 25, '.') || lpad(a0225, 25, '0') from ( select a02.a0000,b0269,a0225,row_number()over(partition by a02.a0000 order by nvl(a02.a0279,0) desc,b0269) rn from a02,b01 where a02.a0201b=b01.b0111 and a0281 = 'true' )  t where rn=1 and t.a0000=b.zhujian))";

	  if("信访有关工作".equals(query_type)){
		  sql = "select zhujian a0000,bjbrxm a0101,y year,jbnrzl infodesc,bfyrzw a0192a,cljg from DJDXF b where   not exists (select 1 from a02 where a02.a0000=b.zhujian and substr(a0201b,0,11)='001.001.001') order by y desc,d desc" ;
	  }
