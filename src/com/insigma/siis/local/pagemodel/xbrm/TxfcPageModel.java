...
public class TxfcPageModel extends PageModel {
	...
	public int dogridquery(int start,int limit) throws Exception{
		...
		String sql = "select * from A01 a" + 
				...
				"   and TRUNC(months_between(to_date('"+warndate+"', 'yyyy-mm-dd')," + 
				"                                       to_date(substr(nvl(a.a0107,'999901'), 0, 6) || '01'," + 
				"                                               'yyyymmdd')) / 12) >= 60 " + 
				"    and a.a0221 = '"+gwcode+"' and b.a0219 = '2'" + 
