...
public class BatchMerge01PageModel extends PageModel {
...
//		}
		String sql="select * from RECORD_BATCH where nvl(RBM_STATUS,'0')='1' and rbm_dept='01' order by rb_sysno desc";
	...
	public int dogridrightQuery(int start,int limit) throws RadowException{
		String sql="select * from RECORD_BATCH_MERGE where rbm_dept='01' order by rbm_sysno desc";
		this.pageQuery(sql, "SQL", start, limit);
		return EventRtnType.SPE_SUCCESS;
	}
