package com.insigma.siis.local.pagemodel.xbrm.expword;
...
public class ExpJSGLRMB {
	...
	public static List getPdfsByA000s_aspose(List<Js01> a0000s,String tpid,String type, String zip_directory_rb_path) throws AppException {
		...
		List<String> paths = new ArrayList<String>();
			...
			for (int i = 0; i < a0000s.size(); i++) {
				Js01 js01 = a0000s.get(i);
				String a0000 = js01.getA0000();
				// 创建Document对象，读取Word模板
				try {
					dataMap = FiledownServlet.getMap(a0000,tpid);
					dataMap.put("js0108", js01.getJs0108()==null?"":js01.getJs0108());
					dataMap.put("js0111", js01.getJs0111()==null?"":js01.getJs0111());
					dataMap.put("js0117", js01.getJs0117()==null?"":js01.getJs0117());
					String a0101 = (String) dataMap.get("a0101");
					doctpl = JSGLPageModel.class.getClassLoader().getResource("./com/insigma/siis/local/pagemodel/xbrm/tpl/gbrmspb_1.doc").getPath();
					...
					File outdf = new File(zip_directory_rb_path+js01.getJs0100());
					if(!outdf.isDirectory()){
						outdf.mkdirs();
					}
					File outFile = new File(zip_directory_rb_path+js01.getJs0100() +"/干部任免审批表_"+a0101 + ".doc");
					// 写入到Word文档中
