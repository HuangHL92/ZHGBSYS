...
public class CheckRegFCPageModel extends PageModel implements JUpload {
	...
	public int doMemberQuery(int start,int limit) throws RadowException{
		...
		String sql="select * from CHECKREGFC t where CHECKREGID='"+checkregid
				+"' order by SORTID ";
	...
	public int doInitX() throws RadowException, AppException{
		...
		try {
			...
			String spasql = "select ckfileid,filesize,filename from CHECKREGFILE where "
					+ " checkregid='" +checkregid+"' and filetype='crfc'";
			...
			if (spalist != null) {
				...
				//遍历map
				this.setFilesInfo("crfc", list_temp, false);
				/*if(count>0) {
					this.getExecuteSG().addExecuteCode("Ext.getCmp('crcrj').setDisabled(true);");
				} else {
					this.getExecuteSG().addExecuteCode("Ext.getCmp('crcrj').setDisabled(false);");
				}*/
			}
	...
	public String deleteFile(String id) {
		...
		try {
			...
			sess.createSQLQuery("delete from CHECKREGFC "
