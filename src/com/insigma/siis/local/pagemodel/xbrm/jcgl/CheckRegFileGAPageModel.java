...
public class CheckRegFileGAPageModel extends PageModel {
	...
	public int doMemberQuery(int start,int limit) throws RadowException{
		...
		String sql="select * from CHECKREG t where 1=1 and gacltx='1' and REGSTATUS='1' "+where1+" "+where+" order by createtime desc";
