...
public class CheckRegGSZWPageModel extends PageModel implements JUpload {
	...
	public int doMemberQuery(int start,int limit) throws RadowException{
		...
		String sql="select * from CHECKREGGSZW t where CHECKREGID='"+checkregid
				+"' order by SORTID ";
	...
	public int doInitX() throws RadowException, AppException{
		...
		try {
			...
			String spasql = "select ckfileid,filesize,filename from CHECKREGFILE where "
					+ " checkregid='" +checkregid+"' and filetype='crgszw'";
			...
			if (spalist != null) {
				...
				//遍历map
				this.setFilesInfo("crgszw", list_temp, false);
			}
	...
	public String deleteFile(String id) {
		...
		try {
			...
			sess.createSQLQuery("delete from CHECKREGGSZW "
