package com.insigma.siis.local.pagemodel.dataExp;
...
public class DataExpPageModel extends PageModel {
	...
	public int doMemberQuery(int start,int limit) throws RadowException{
		...
		str.append("select  * from EXCEL_TABLE  where xls02='"+this.getCurUserid()+"' order by xls05 desc");
	...
	public int addEGLInfo() throws Exception{
		...
		if(StringUtils.isEmpty(egl00)){
			...
			HBUtil.executeUpdate("insert into EVALUATION_grade_list(egl00,egl01,egl02,ets00,egl04) values(?,?,?,?,?)",
					new Object[]{egl00,egl01,this.getCurUserid(),ets00,egl04});
		}else{
			HBUtil.executeUpdate("update EVALUATION_grade_list set egl01=?,egl04=? where egl00=?",
	...
	public int allDelete(String egl00) throws RadowException, AppException{
		...
		try {
			...
			HBUtil.executeUpdate("delete from EVALUATION_grade_list where egl00=?",new Object[]{egl00});
			sess.flush();
			this.setNextEventName("memberGrid.dogridquery");
		}catch (Exception e) {
			// TODO Auto-generated catch block
