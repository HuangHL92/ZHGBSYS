...
var tabs = new Ext.TabPanel(
		{
			...
			items : {
				title : '一览表',
				closable : false,
				id : '2c909e1d6d05d72d016d065b225800f1',
				iconCls : 'iconwelcome',
				html : '<Iframe id="2c909e1d6d05d72d016d065b225800f1" width="100%" height="100%" scrolling="auto" frameborder="0" src="'
					+ g_contextpath
					+ '/radowAction.do?method=doEvent&pageModel=pages.xbrm2.YNTPGL'
