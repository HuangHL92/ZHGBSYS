...
var tabs = new Ext.TabPanel(
		{
			...
			items : {
				...
				iconCls : 'iconwelcome',
				html : '<Iframe id="40287d815451830d0154519c343e0007" width="100%" height="100%" scrolling="auto" frameborder="0" src="'
					+ g_contextpath
					+ '/radowAction.do?method=doEvent&pageModel=pages.FamilyMember.addFam'
					+ '" style="clear:both;margin-left:0px;margin-right:0px;float:right;"></Iframe>'
			}, 
			initEvents : function() {
