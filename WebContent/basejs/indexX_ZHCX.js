...
var tabs = new Ext.TabPanel(
		{
			...
			items : {
				title : '干部综合查询',
				closable : false,
				id : '402882f265c693770165c6c7d65b0007',
				iconCls : 'iconwelcome',
				html : '<Iframe id="402882f265c693770165c6c7d65b0007" width="100%" height="100%" scrolling="auto" frameborder="0" src="'
					+ g_contextpath
					+ '/radowAction.do?method=doEvent&pageModel=pages.zhsearch.Isearch'
