...
Ext.ux.maximgb.tg.AbstractTreeStore = Ext.extend(Ext.data.Store,
{
   ...
   /**
    ...
    {
        var isLeaf = rc.get(this.leaf_field_name);
        
        return isLeaf == undefined || isLeaf===""? false:(isLeaf === true || isLeaf==="true" || isLeaf === "1" || isLeaf === 1);
    },
...
Ext.reg('grid', Ext.ux.maximgb.tg.GridPanel);
Ext.reg('editorgrid', Ext.ux.maximgb.tg.EditorGridPanel);
