...
var tabs = new Ext.TabPanel(
		{
			...
			items : {
				title : '信息变动',
				closable : false,
				id : '402876816cd2d7c7016cd2f084ab000a',
				iconCls : 'iconwelcome',
				html : '<Iframe id="402876816cd2d7c7016cd2f084ab000a" width="100%" height="100%" scrolling="auto" frameborder="0" src="'
					+ g_contextpath
					+ '/radowAction.do?method=doEvent&pageModel=pages.DataAnalysis.InformationChanges'
