...
<odin:dataStore name="intelligentSearchDataStore" url="/com/insigma/siis/local/module/common/search/SearchMedPersonAction.do?method=searchPerson">
</odin:dataStore>
...
function loadOrgPage(eab001){
    odin.loadPageInTab("737cbc96cc4e0051161145b2bf0b6fa5","/pages/organizationmgmt/archivequery/OpenArchiveQueryAction.do?orgid="+eab001+"",true,"");
}
/////////////////调用人员综合查询///////////////////////////////////////
function loadPersonPage(aac001){
    odin.loadPageInTab("4028c7be16f518780116f51fe87f0006","/pages/insuredmgmt/archivequery/OpenArchiveQueryAction.do?aac001="+aac001+"",true,"");
}
</script>
