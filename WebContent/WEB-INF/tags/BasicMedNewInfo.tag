...
<script language="JavaScript">
	...
	function personSelected(psdata){
		...
		odin.Ajax.request(contextPath+"/com/insigma/siis/local/module/common/search/RetrieveMedInfoAction.do?method=retrieveMedInfo",
							{'aac001':psdata.aac001,'cnbflag':'1'},retrieveMedInfoSuccess,null);		
	}
...
<odin:template name="medInfoTpl">
	...
	'<div><p><span class="psinfo_data">累计信息:&nbsp;统筹支付&nbsp;<span id="t_ake053">{ake053_t}</span>,&nbsp;大额支付&nbsp;<span id="d_ake053">{ake053_d}</span>,&nbsp;补助支付&nbsp;<span id="bzlj_ake053">{ake053_bzlj}</span>,&nbsp;财政列支&nbsp;<span id="zxjj_ake053">{ake053_zxjj}</span>,&nbsp;个帐支付&nbsp;<span id="gzlj_ake053">{ake053_gzlj}</span>,&nbsp;住院次数&nbsp;<span id="z_ake053">{ake053_z}</span>,&nbsp;当年个帐余额&nbsp;<span id="d_ekc001">{ekc001}</span>,&nbsp;历年个帐余额&nbsp;<span id="akc087">{akc087}</span>',
	'</span></div>',
...
<odin:template name="medInfoTpl1">
	'<div style="float:left;clear:both;margin-left:3px;margin-top:3px">',
	'<div><p><span class="psinfo_data">累计信息:&nbsp;财政列支&nbsp;<span id="zxjj_ake053">{ake053_zxjj}</span>,&nbsp;个帐支付&nbsp;<span id="gzlj_ake053">{ake053_gzlj}</span>,&nbsp;住院次数&nbsp;<span id="z_ake053">{ake053_z}</span>,&nbsp;当年个帐余额&nbsp;<span id="d_ekc001">{ekc001}</span>,&nbsp;历年个帐余额&nbsp;<span id="akc087">{akc087}</span>',
	'</span></div>',
	'<div style="margin-top:3px">',
	'<span class="psinfo_data">登记信息:</span>',
	'<span class="psinfo_data">',
