...
<odin:tabLayOut />
   <tr>
	 ...
	 <odin:select property="AAC004" editor="false" data="['1', '男'],['2', '女'],['9', '未说明']" label="性别" required="false" width="127" disabled="true" ></odin:select> 
   </tr>
   <tr>
	 <odin:textEdit property="EAC109" label="身份证号码"   required="false" disabled="true"/>     
	 <odin:textEdit property="EA0127" label="年龄"  required="false" disabled="true"/> 
     <odin:dateEdit property="AAC030" label="参加工作日期" required="false" disabled="true" width="127"/>
   </tr>
   <tr> 
     <odin:textEdit property="AAB001" label="单位编号"   required="false" disabled="true"/>
	 <odin:textEdit property="AAB004" label="单位名称" colspan="4" width="379" required="false" disabled="true"/>    
   </tr>
</table>
</odin:groupBox> 
</td>
