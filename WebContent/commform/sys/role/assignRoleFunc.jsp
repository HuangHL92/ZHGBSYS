...
<script type="text/javascript" src="<%=request.getContextPath()%>/commform/sys/role/assignRoleFunc.js"></script>
</head>

<body onload="getRoleFuncIds();onLoad();" style="overflow-y:hidden;overflow-x:hidden">
<odin:base>
...
<table width="96%" align="center">
	...
	<tr>
		<td width="150"></td>
		<td align="right"><img src="<%=request.getContextPath()%>/commform/images/baocun.gif" onclick="submit()"></td>
		<td width="6"></td>
		<td><img src="<%=request.getContextPath()%>/commform/images/quxiao.gif" onclick="parent.odin.ext.getCmp('funcWindow').hide()"></td>
	</tr>
	<tr>
		<td colspan="4" height="4"></td>
	</tr>
...
<form action="<%=request.getContextPath()%>/sys/roleAction.do" method="post" name="roleForm">
	...
	<input type="hidden" name="cueRoleFuncs" value="">
