...
<odin:toolBar property="btnToolBar">
	...
	<odin:fill/>
	<odin:buttonForToolBar isLast="true" text="查询" handler="loadRoleGridData" icon="../commform/images/icon/i_2.gif" cls="x-btn-text-icon"/>
</odin:toolBar>
...
<odin:gridColumnModel>
  ...
  <odin:gridColumn header="角色名称" width="100" dataIndex="rolename" selectOnFocus="true" editor="text" edited="true"/>
  <odin:gridColumn header="角色描述" width="240" dataIndex="roledesc" editor="text" selectOnFocus="true" edited="true"/>
  <odin:gridColumn header="所属系统" width="60" dataIndex="sysid" editor="select" selectOnFocus="true" codeType="SYSID" />
  <odin:gridColumn header="权限类型" hidden="true" width="60" dataIndex="qxlx" editor="select" selectOnFocus="true" codeType="QXLX" />
  <odin:gridColumn header="状态"  align="center" width="80" renderer="renderStatus" dataIndex="status" />
  <odin:gridColumn header="创建者"  width="60" dataIndex="creator" />
