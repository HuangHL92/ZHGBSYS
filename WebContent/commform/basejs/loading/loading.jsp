...
#progressbar{
		...
		background:white url(<%=request.getContextPath()%>/commform/basejs/loading/images/block-bg.gif) repeat-x;
		padding:10px;
...
{   
   window.attachEvent("onload", loading.remove);   
} 
else if (window.addEventListener) 
{   
   window.addEventListener("load", loading.remove, false);    
}
