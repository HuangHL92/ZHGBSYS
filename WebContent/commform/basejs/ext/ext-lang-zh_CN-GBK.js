...
}if(Ext.DatePicker)
{
	...
	{
		todayText:"今天",minText:"日期在最小日期之前",maxText:"日期在最大日期之后",disabledDaysText:"",disabledDatesText:"",monthNames:Date.monthNames,dayNames:Date.dayNames,nextText:"下月 (Control+Right)",prevText:"上月 (Control+Left)",monthYearText:"选择一个月 (Control+Up/Down 修改年份)",todayTip:"{0} (空格键选择)",format:"y年m月d日",cancelText:"取消",okText:"确定"
	})
