...
import="com.lbs.leaf.web.util.LeafTagUtils"%>
body
{
...
.ExportExcel
{
  background-image: url(<%=LeafTagUtils.calcWebURI((HttpServletRequest) pageContext.getRequest(),"/images/arrow-g5.gif")%>);
  width:17px;
  height:17px;
  cursor:hand;
}
.ExportAllExcel
{
  background-image: url(<%=LeafTagUtils.calcWebURI((HttpServletRequest) pageContext.getRequest(),"/images/arrow-g6.gif")%>);
  width:17px;
  height:17px;
  cursor:hand;
}
