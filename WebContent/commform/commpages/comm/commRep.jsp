...
<%
	...
	String method = request.getParameter("method").substring(0,n); 
	String repid=moduleSysfunction.getParam1()==null?method:moduleSysfunction.getParam1();
	String queryName=(moduleSysfunction.getParam2()==null?"Q001":moduleSysfunction.getParam2());
	String param="";
	String repmode=moduleSysfunction.getRpflag().equals("0")?"1":moduleSysfunction.getRpflag();
%>
<body leftmargin="0" topmargin="0"  rightmargin="0" bottommargin="0">
<OBJECT width ="102%"  height="99.8%" align ="center" hspace=0 vspace=0
      ...
      <PARAM NAME="D_COLOR_BORDER"  VALUE="16760767"                     > <!-- 插件边框颜色 -->
      <PARAM NAME="D_COLOR_BACK"    VALUE="16773874"                    > <!-- 插件背景颜色 -->
