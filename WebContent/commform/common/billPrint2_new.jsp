...
<title></title>     
<link rel="stylesheet" type="text/css" href="<%=FR_ADDR%>/ReportServer?op=resource&resource=/com/fr/web/load.css"></link>
<script type="text/javascript" src="<%=FR_ADDR%>/ReportServer?op=resource&resource=/com/fr/web/load.js"></script>
</head>
