...
<title></title>
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/ReportServer?op=emb&resource=finereport.css"/> 
<script type="text/javascript" src="<%=request.getContextPath()%>/ReportServer?op=emb&resource=finereport.js"></script>
</head>
<body style='overflow:hidden'>
<table id="div_1" align="center" width="96%" style="display:none;">
	<tr>
		<td align="center" height="60" colspan="2"><div style="font-size:16px;">打印发送成功！</div></td>
	</tr>
	<tr>
...
<script type='text/javascript'>
    ...
    function doCloseWin(){
		...
		if(navigator.userAgent.indexOf("Workpf")>=0){
			window.close();
		}else{
