...
<table border="0"  align="center" width="750" cellpadding="0" cellspacing="0">
		<odin:tabLayOut />
		<tr>
			<odin:select property="A1KA130" label="报销类型"  required="true" editor="true" data="['1', '门诊报销'],['2', '住院报销'],['3', '基本特殊病报销'],['4', '补充特殊病报销']"/>
			<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
		</tr>
		<tr>
			<odin:dateEdit property="A1KC192" label="就诊时间" required="true" mask="yyyy-mm-dd"/>
			<odin:dateEdit property="A1KC194" label="结束时间" required="true" mask="yyyy-mm-dd"/>
			<odin:textIconEdit property="A1KB020" label="就诊医院" required="true"/>
		</tr>
		<tr>
			<odin:textEdit property="A1KC190"  required="true" label="就诊号"/>
			<odin:textIconEdit property="A1KA121" label="就诊疾病" required="true"/>
			<odin:textEdit property="E1KC113"  required="true" label="床位号"/>
		</tr>
		<tr>
			<odin:textEdit property="EK1C122" label="出院科室" required="false"/>
			<odin:select disabled="true" property="A1KC195" editor="true"  data="['1', '病愈出院'],['2', '死亡'],['3', '其他']" label="出院原因" required="false"/>
			<odin:numberEdit property="F1PZS" label="发票张数" required="false"/>
		</tr>
		<tr>
			<odin:textEdit property="E1KC124" label="病情描述" colspan="6" required="false"/>
		</tr>
	</table>
</div>
...
<odin:groupBoxNew contentEl="test1"   property="mygroupBox" 
     title="分组信息" checkboxToggle="true" collapsed="true"></odin:groupBoxNew>	
</td></tr></table>
