		...
		<div class="inner_div left_div">
			<div class="top_div">
				<div style="width:100%;height:100%;">
					...
					<div id="personInfo" style="width:250px;height: 42px;font-size: 12px; font: normal;overflow: hidden; text-align: center;padding-top:5px;  " align="center" title=""></div>
				</div>
			</div>
						...
						<tr>
							<td class="label_color width-60 height-330">
								<div style="width: 100%;height: 100%;position: relative;">
									<div onclick="showwin();" title="简历生成" style="width:100%;height:40%;background:url(images/jl.png) no-repeat center 10px;cursor:pointer;"></div>
									<span style="" class="fontConfig"><font color="red">*</font><br>简<br>历</span>
									
									<div onclick="a1701Format();" title="简历格式化" style="width:100%;height:20%;background:url(images/cv.png) no-repeat center 10px;cursor:pointer;"></div>
								</div>
							</td>
...
readonly="readonly" ondblclick="$h.openPageModeWin('assessmentInfo','pages.publicServantManage.AssessmentInfoAddPage','年度考核情况',800,330,document.getElementById('a0000').value,ctxPath,null,{maximizable:false,resizable:false})" ><%=SV(a01.getA15z101()) %></textarea>
						...
						if(content1.contains((a36.getA3604a()==null?"":a36.getA3604a()))){
							int ichar = numFor+97;
	...
	textareaStyle="display:none;text-align:center;" textareaCls="cellbgclor x-form-field" defaultValue="<%=SV(a36.getA3611()) %>" divStyle="width:156px;"	/>
						...
						String allContent=content1+content2+content3+content4;
	...
	textareaStyle="display:none;text-align:center;" textareaCls="cellbgclor x-form-field" defaultValue="<%=SV(a36.getA3611()) %>" divStyle="width:156px;"	/>
		...
		<div class="inner_div right_div">
			<div class="top_div pic1" style="background-color:#92B3D4">
				<span style="" id="a0163Text" width="250px">
...
title="" textareaStyle="" textareaCls="cright_input_btn"/>
			...
			<div style="width:100%;height:70px;">
				...
				<div class="top_btn_style" style="background-color:#3680C9;margin-left:10px;" onclick="addnew()">继续增加</div>
...
function CtrlV (curRow){
	...
	tabSwitch('tabs','page',2);
	var mycars=new Array("a3604a_","a3601_","a3607_","a3627_","a3611_");
