...
<iframe width="825" height="85px" src="<%=request.getContextPath() %>/pages/dataverify/DataVerifyMakeHZB.jsp" frameborder=”no” border=”0″ marginwidth=”0″ marginheight=”0″ scrolling=”no” allowtransparency=”yes”></iframe>
...
<odin:toolBar property="btnToolBar" >
	<odin:textForToolBar text="<h3>&nbsp;支持套改版本数据包导入</h3>" />
	<odin:fill />
...
function formSubmit2(){
	...
	if(type11 == "MYSQL" && count2>100000){
		...
		Ext.Ajax.request({
				url:'<%=request.getContextPath()%>/UploadFileServlet?method=hzbMakeFileImp&uuid='+uuid+'&filename='+filename+'&b0111new='+b0111new+'&a0165='+a0165+'&fxz='+fxz,
