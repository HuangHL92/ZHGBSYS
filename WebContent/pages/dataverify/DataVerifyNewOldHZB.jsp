...
<iframe width="825" height="85px" src="<%=request.getContextPath() %>/pages/dataverify/DataVerifyOldHZB.jsp" frameborder=”no” border=”0″ marginwidth=”0″ marginheight=”0″ scrolling=”no” allowtransparency=”yes”></iframe>
			...
			<div id="aa2"  style="width: 540px">
				...
				<tr>
				 ...
				 <tr >
					...
					<td>&nbsp;&nbsp;&nbsp;
					<input type="checkbox" id="fxz" /><span style="font-size: 12">非现职人员</span></td>
				</tr>
				<tr height="15">
					<td></td><td></td>
					<td></td><td></td>
...
<odin:toolBar property="btnToolBar" >
	<odin:textForToolBar text="<h3>&nbsp;支持HZB1.0格式导入</h3>" />
	<odin:fill />
...
function formSubmit2(){
	...
	if(type11 == "MYSQL" && count2>100000){
		...
		Ext.Ajax.request({
				url:'<%=request.getContextPath()%>/UploadFileServlet?method=hzbOldFileImp&uuid='+uuid+'&filename='+filename+'&b0111new='+b0111new+'&a0165='+a0165+'&fxz='+fxz,
...
function changeData(){
	alert("检测到数据包版本不一致，请使用2016版HZB 1.0数据包！");
