...
<div id="bzyp">
	<table width="960" align="center" style="border: 1px solid #DDD;">
		...
		<tr>
			<td width="120" height="100" style="text-align:center;font-family:SimHei;background-color:#ADD8E6">班子研判建议</td>
		...
		<tr>
			...
			<odin:textarea property="pbjy" colspan="7" ></odin:textarea>
			<!-- <td colspan=7 id="bzypjyb">
				<textarea id="bzypjy" name="bzypjy" ></textarea>
			</td> -->
		</tr>
		<tr>
			<td width="120" height="100" style="text-align:center;font-family:SimHei;background-color:#ADD8E6">班子特点</td>
			<odin:textarea property="bztd" colspan="7" ></odin:textarea>
			<!-- <td colspan=7 id="bzypjyb">
				<textarea id="bzypjy" name="bzypjy" ></textarea>
			</td> -->
		</tr>
		<tr>
			<td width="120" height="100" style="text-align:center;font-family:SimHei;background-color:#ADD8E6">主要问题</td>
			<odin:textarea property="zywt" colspan="7" ></odin:textarea>
			<!-- <td colspan=7 id="bzypjyb">
				<textarea id="bzypjy" name="bzypjy" ></textarea>
			</td> -->
		</tr>
	...
	<table width="960" align="center" id="table2"  >
		<tr>
			<td rowspan=3 width=120 style="text-align:center;font-family:SimHei;background-color:#ADD8E6">主要经营指标</td>
			<td height="40" style="text-align:center;font-family:SimHei;">年份</td>
			<odin:select2 property="year1"  onchange="yearQuery1()" style="width:100%;border-right:none"></odin:select2>
			<td colspan=2 style="border-left:none"></td>
		</tr>
		<tr>
			<td   height=50 style="text-align:center;font-family:SimHei;background-color:#FFFFFF">总资产</td>
			<td   style="text-align:center;font-family:SimHei;">净资产</td>
			<td   style="text-align:center;font-family:SimHei;">营业收入</td>
			<td   style="text-align:center;font-family:SimHei;">净利润</td>
		</tr>
		<tr>
			<td  height=60 ><input id="zzc" /></td>
			<td ><input id="jzc" /></td>
			<td ><input id="yysr" /></td>
			<td ><input id="jlr" /></td>
		</tr>
	...
	<div id="ButtonDiv" style="border:none;text-align:right;padding-right:5px">
		<button onclick="saveJYZB()" type="button" style="border-radius:5px;background-color: #F08000;border: none;width:120px;height:30px;
    	cursor:pointer;color: white;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;">保存经营指标</button>
	</div>
