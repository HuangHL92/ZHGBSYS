...
<table width="100%">
		...
		<tr>
			<odin:textEdit property="meetingname" label="引用所属会议名称"  disabled="true"></odin:textEdit>
	    </tr>
	    <tr>
	    	<odin:textEdit property="agendaname" label="引用的议题名称" disabled="true"></odin:textEdit>
		</tr>
		<tr>
			<td height="20"  colspan="2"></td>
		</tr>
		<tr>
			<odin:select2 property="xmeetingname"  label="引用到的会议名称" required="true"></odin:select2>
	    </tr>
</table>	
</div>
