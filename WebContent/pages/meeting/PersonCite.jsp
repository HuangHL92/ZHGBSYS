...
<div id="addCiteContent">
	<table style="height: 95%;width: 100%;" >
		<tr>
			<odin:select2 property="meetingname" label="被引用所属会议名称"  onchange="updatepublish"></odin:select2>
			<td rowspan="3"></td>
			<odin:textEdit property="xmeetingname"  label="引用到的会议名称"  disabled="true"></odin:textEdit>
		</tr>
		<tr>
			<odin:select2 property="agendaname" label="被引用所属议题名称" onchange="updatetitle" disabled="true"></odin:select2>
			<odin:textEdit property="xagendaname" label="引用到的议题名称" disabled="true"></odin:textEdit>
		</tr>
		<tr>
			<odin:select2 property="titlename" label="被引用所属标题名称" onchange="updateperson" disabled="true"></odin:select2>
			<odin:textEdit property="xtitlename" label="引用到的标题名称" disabled="true"></odin:textEdit>
		</tr>
				...
				<div id="selectByPersonIdDiv" >
					<odin:editgrid property="gridcq" title="待选列表"  width="300" height="450" pageSize="9999"
						...
						<odin:gridColumnModel>
							...
							<odin:gridColumn header="引用标识" editor="text" hidden="true" dataIndex="yy_flag" />
...
<odin:panel contentEl="addCiteContent" property="addCitePanel" topBarId="btnToolBar"></odin:panel>
