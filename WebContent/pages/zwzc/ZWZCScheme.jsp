...
<div style="height: 100%; width: 100%" id="conditionArea">
	...
	<table cellspacing="0" align="center">
		<tr height="30">
		    <odin:textEdit property="a0192a" label="职务全称" width="300" readonly='true'/>
		</tr>
...
Ext.onReady(function() {
      ...
      var zwzc00 =parentParams.zwzc00||'';
//alert(LWflag.value);
      ...
      var tree = new Tree.TreePanel( {
          ...
          loader : new Tree.TreeLoader( {
        	  ...
        	  dataUrl : 'radowAction.do?method=doEvent&pageModel=pages.zwzc.ZWZCScheme&eventNames=orgTreeJsonData&tag=1&sign='+sign+"&zwzc00="+zwzc00
...
Ext.onReady(function() {
	$('#a0192a').val(parentParams.a0192a||'');
	$('#zwzc00').val(parentParams.zwzc00||'');
...
function reflashParent(){
	realParent.radow.doEvent('initX',$('#zwzc00').val());
