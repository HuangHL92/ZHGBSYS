...
<table style="width:350;align:left" >
	...
	<tr>
	<odin:select2 property="wj02" data="['政治素质考核材料','政治素质考核材料'],['干部提任考察材料','干部提任考察材料'],['平时考核表现材料','平时考核表现材料']
	,['年度考核','年度述职述廉材料(年度考核)'],['民主生活会材料','民主生活会材料'],['整改清单','整改清单'],['向组织说说心里话','向组织说说心里话']
	,['其他','其他']" width="130"  label="材料类型"  />
	</tr>
	<tr>
		<td height="30"></td>
	</tr>
...
function saveCallBack(t){
	$h.alert('系统提示', t, function(){
		...
		realParent.Ext.getCmp('clGrid').getStore().reload();
		realParent.Ext.getCmp('ryGrid').getStore().reload();
		parent.Ext.getCmp('CJWJGLAdd').close()
	});
}
