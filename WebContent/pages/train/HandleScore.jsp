...
<table style="width:100%;margin-top: 40px;">
	...
	<tr>
		<td style="width: 20px"></td>
		<odin:select2 property="g11039" label="考试类别" width="160" codeType="GB2230"></odin:select2>
		<odin:NewDateEditTag property="g11040" isCheck="true" label="考试时间" maxlength="8"></odin:NewDateEditTag>
	</tr>
	<tr>
		<td style="width: 20px"></td>
		<odin:numberEdit property="g11041" label="考试成绩" width="160" ></odin:numberEdit>
...
function saveCallBack(){
	parent.Ext.getCmp('scoreGrid').getStore().reload();
