...
<iframe width="525" height="85px" src="<%=request.getContextPath() %>/pages/train/TrainDataImp2.jsp" id=iframe1></iframe>
<div id="addResourceContent">
</div>
</div>
<odin:toolBar property="btnToolBar" >
	<odin:fill />
	<odin:buttonForToolBar id="btnNew1" handler="formSubmit2" text="导入" icon="images/i_2.gif" isLast="true"
		cls="x-btn-text-icon" />
...
function closeWin(){
	window.close();
	parent.odin.ext.getCmp('TrainDataImpWin').close();
}
function doRenewal(){
	location.reload();
}
