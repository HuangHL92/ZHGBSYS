...
<ss:hlistDiv id="div_1" title="查询信息">
	<ss:textEdit property="ywmk" label="业务模块名称" p="E"></ss:textEdit>	
	...
	<ss:select property="suser" label="审核人" codeType="USER" allAsItem="true"  isPageSelect="true" p="E"></ss:select>
	<ss:textEdit property="ywrz" label="业务日志ID" p="H"></ss:textEdit>
</ss:hlistDiv>
<ss:editgrid property="div_2" pageSize="150" title="审核信息"  bbarId="pageToolBar"     isFirstLoadData="false" url="/" height="430" autoFill="false">
		<ss:gridColModel>
			...
			<ss:gridCol header="业务日志ID" name="opseno" width="120" editor="number" renderer="renderClick1"/>
			<ss:gridCol header="点击还原" name="opseno1" width="120" editor="number"  renderer="renderClick"/>
			...
			<ss:gridCol header="审核结束时间" name="enddate" width="130" editor="date"></ss:gridCol>
		</ss:gridColModel>
</ss:editgrid>
