...
<ss:hlistDiv id="div_1" >
	...
	<ss:select property="suser" label="经办人" codeType="USER" allAsItem="true"  isPageSelect="true" p="E"></ss:select>
	<ss:textEdit property="digest" label="摘要信息" p="E"></ss:textEdit>
	<ss:textEdit property="ywmk" label="业务模块" p="H"></ss:textEdit>
...
<ss:editgrid property="div_2"  title="审核信息"  bbarId="pageToolBar" pageSize="50"   isFirstLoadData="false" url="/" height="-80,1" autoFill="false" rowDbClick="true">
		<ss:gridColModel>
			...
			<ss:gridCol header="模块名称" name="title" width="200" editor="text"/>			
