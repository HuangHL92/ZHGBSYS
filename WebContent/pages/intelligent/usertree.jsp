...
Ext.onReady(function() {
      ...
      tree = new Tree.TreePanel( {
            ...
            checkModel: 'multiple',//cascade ：级联选中所有父结点和子结点 parentCascade ：级联选中所有父结点 childCascade  ：级联选中所有子结点
...
<odin:toolBar property="btnToolBar">
	...
	<odin:buttonForToolBar id="save1" handler="doSave" isLast="true"
		text="确定" icon="images/save.gif" cls="x-btn-text-icon" />
</odin:toolBar>
...
<odin:tabModel  >
	...
	<odin:tabItem title="用户配置" id="tab2" ></odin:tabItem>
	<odin:tabItem title="角色配置" id="tab3" ></odin:tabItem>
	<odin:tabItem title="用户组配置" id="tab1" isLast="true"></odin:tabItem>
</odin:tabModel > 
<odin:tabCont itemIndex="tab1"  >
 ...
 <odin:tabCont itemIndex="tab2">
 			...
 			<odin:select property="user" label="用户" codeType="USER" tpl="keyvalue" minChars="1"  canOutSelectList="true" isPageSelect="true" ></odin:select>
 			</td>
 			<td colspan="2" width="40" >

 			</td>
 			<td colspan="2"   width="300" align="right">
 			<odin:button text="查询" property="search_person"></odin:button>
 			</td>
 			</tr>

 			</table>
			<odin:editgrid property="grid1" isFirstLoadData="false" 
				url="/" title="用户列表" width="300" height="280" bbarId="pageToolBar" pageSize="100">
				...
				<odin:gridColumnModel>
					...
					<odin:gridEditColumn header="登录名称" align="center" width="80"
						dataIndex="loginname" editor="text" edited="false"/>
					<odin:gridEditColumn header="用户名称" align="center" width="150"
	...
	<table width="100%">
		...
		<tr>
	    	...
	    	<odin:textEdit property="roleQName" label="角色名称"></odin:textEdit>
 			...
 			<odin:button text="查询" property="search_role"></odin:button>
 			</td>
		</tr>
...
<odin:editgrid property="grid6" bbarId="pageToolBar" url="/" title="角色信息表" isFirstLoadData="false" width="300" height="280">
...
<odin:gridColumnModel>
 ...
 <odin:gridColumn  header="selectall"  gridName="grid6" dataIndex="checked" editor="checkbox" edited="true" />
  ...
  <odin:gridEditColumn header="角色描述" width="130" dataIndex="desc" editor="text" selectOnFocus="true" edited="false" isLast="true"/>
</odin:gridColumnModel>			
</odin:editgrid>	
