...
<odin:toolBar property="toolBar2" applyTo="tol1" >
				<odin:textForToolBar text="点击保存自动计算最高学历学位并输出"></odin:textForToolBar>
				<odin:fill></odin:fill>
				<%--<odin:buttonForToolBar text="学历简历添加" id="setA1701"></odin:buttonForToolBar> --%>
				<odin:buttonForToolBar text="设置最高学历学位"  id="sethighest" icon="image/u53.png"></odin:buttonForToolBar>
				<%-- <odin:buttonForToolBar text="输出最高学历学位" id="printoutBtn"></odin:buttonForToolBar> --%>
				<odin:buttonForToolBar text="增加"  id="degreesAddBtn" icon="images/add.gif"></odin:buttonForToolBar>
				<%--
				<odin:buttonForToolBar text="删除"   id="delete" handler="deleteRow" icon="images/back.gif"></odin:buttonForToolBar>
				--%>
				<odin:buttonForToolBar text="保存" id="save" handler="saveDegree1" icon="images/save.gif" isLast="true" cls="x-btn-text-icon" ></odin:buttonForToolBar>
</odin:toolBar>
...
Ext.onReady(function(){
	var side_resize=function(){
		 ...
		 Ext.getCmp('degreesgrid').setHeight(400-20);
		 Ext.getCmp('degreesgrid').setWidth(570); 
		 document.getElementById('toolBar2').style.width = document.body.clientWidth-20 ;
...
function lockINFO(){
 	Ext.getCmp("sethighest").disable(); 
	Ext.getCmp("degreesAddBtn").disable(); 
	Ext.getCmp("save").disable(); 
	Ext.getCmp("degreesgrid").getColumnModel().setHidden(8,true);
}
