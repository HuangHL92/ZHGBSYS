		...
		<odin:grid property="TrainingInfoGrid" topBarId="toolBar8" sm="row"  isFirstLoadData="false" url="/"
				height="230" >
					...
					<odin:gridColumnModel>
					  ...
					  <odin:gridEditColumn2 header="职务层次" align="center" dataIndex="a0501b" editor="select" edited="false" codeType="ZB09" width="80"/>
					  <odin:gridEditColumn2 header="批准日期" align="center" dataIndex="a0504" editor="text" edited="false" width="80"/>
					 <%--  <odin:gridEditColumn header="批准文号" align="center" dataIndex="a0511" editor="text" edited="false" width="100"/> --%>
					  <odin:gridEditColumn2 header="终止日期" align="center" dataIndex="a0517" editor="text" width="80" edited="false"/>
					  <%-- <odin:gridEditColumn header="状态" dataIndex="a0524" editor="text" edited="false" width="100"/> --%>
					  <odin:gridEditColumn2 header="状态" align="center" dataIndex="a0524" editor="select" edited="false" selectData="['1','在任'],['0','已免']" width="80"/>
