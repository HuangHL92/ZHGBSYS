...
<div id="main" padding: 0px;margin: 0px;" >
...
<script type="text/javascript">
function AddBtn(){
	radow.doEvent('professSkillAddBtn.onclick');
}
/** function deleteRow(){ 
...
function geta0000(){
	document.getElementById("a0000").value = window.parent.frames["BaseAddPage_GB"].contentWindow.document.getElementById("a0000").value;
} */
Ext.onReady(function(){
