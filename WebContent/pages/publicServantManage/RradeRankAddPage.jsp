			...
			<odin:grid property="TrainingInfoGrid" topBarId="toolBar8" sm="row"  isFirstLoadData="false" url="/"
			 height="230">
				...
				<odin:gridColumnModel>
				  ...
				  <odin:gridEditColumn2 header="职级" dataIndex="a0501b" editor="select" edited="false" codeType="ZB148" width="100"/>
				  <odin:gridEditColumn2 header="批准日期" dataIndex="a0504" editor="text" edited="false" width="100"/>
				 <%--  <odin:gridEditColumn header="批准文号" dataIndex="a0511" editor="text" edited="false" width="100"/> --%>
				  <odin:gridEditColumn2 header="终止日期" dataIndex="a0517" editor="text" width="100" edited="false"/>
