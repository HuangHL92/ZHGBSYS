				...
				<table style="width: 100%;height: 100%;border: 2px solid #c3daf9;">
					<tr height="20%;" style="width: 100%;">
						...
						<table style="height:50px;width:100%">
							<tr>
								<odin:select property="querydb" label="" canOutSelectList="false" value = '1' data="['1','干部库'],['2','处级干部库']" width="100"></odin:select>
								<%-- 
								<odin:select property="querydb" label="" canOutSelectList="false" value = '1' data="['1','干部库'],['2','公务员库'],['3','库3'],['4','库4']" width="100"></odin:select>
								 --%>
								<td style="width: 130px;" >
									<div style="height: 80%;width: 90%;font-size: 12px;margin-top: 10px;margin-left: 10px;color: red;">多个姓名/身份证查</br>询，请按逗号隔开。</div>
								</td>
								<td>
									<odin:select property="tpye" label="" canOutSelectList="true" value = '1' data="['1','姓名'],['2','身份证号码']" width="110"></odin:select>
								</td>
								<td>
									<textarea  class="x-form-text x-form-field" style="width: 350px;height:22px;  margin-top:0px; margin-bottom:5px !important;" name="queryName" id="queryName"  ></textarea> 
									
								</td>
								<td> <input type="button" style="position: relative;top: 2px;margin-bottom:7px" onclick="toDOQuery()" value="搜索"></td>
							</tr>
						</table>
						</td>
					</tr>
						...
						<td width="46%" height="100%">
							...
							<odin:editgrid property="gridcq" title="待选列表"  width="300" height="350" pageSize="9999"
								...
								<odin:gridColumnModel>
									...
									<odin:gridEditColumn header="主键" editor="text" hidden="true" edited="false" dataIndex="a0000" />
									<odin:gridEditColumn header="来源系统" editor="text" hidden="true" edited="false" dataIndex="vxt" />
	...
	<table>
		<tr>
			<td style="display: none;">
				<%-- <odin:textarea cols='70' style="color: red;" property="coverinfo" readonly='true' value=''></odin:textarea> --%>
			</td>
			<td style="display: none;">
				<input type="button" height="20" width="25" value="清除待选列表" onclick="clearRst()">&nbsp;&nbsp;
			</td>
			<td style="display: none;">
				<input type="button" height="20" width="25" value="清除暂缓信息" onclick="clearZanhuan()">&nbsp;&nbsp;
			</td>
			<%-- <odin:select2 property="tplb" canOutSelectList="true" label="选择类别"></odin:select2> --%>
			<td><input type="button" height="20" width="25" value="&nbsp;确&nbsp;&nbsp;定&nbsp;" onclick="saveSelect()">&nbsp;&nbsp;</td>
		</tr>
	</table>
</div>
...
//清除暂缓，
function clearZanhuan(){
	radow.doEvent("clearZanhuan");
}
...
Ext.onReady(function() {
	...
	if(!!parent.Ext.getCmp(subWinId).initialConfig.cur_hj_4){
		document.getElementById("cur_hj_4").value=parent.Ext.getCmp(subWinId).initialConfig.cur_hj_4;
	}
	if(!!parent.Ext.getCmp(subWinId).initialConfig.dc005){
		document.getElementById("dc005").value=parent.Ext.getCmp(subWinId).initialConfig.dc005;
	}
