...
<table id="tablef"  >
	...
	<tr>
		<odin:select property="tjlxl" label="材料类型" value="cpl" data="['cpl','测试类文档']" width="100" maxlength="40" readonly="true"/>
		
	</tr>
	<tr>
		<odin:select property="tjlx" label="文档"  codeType="TJLX2" width="100" maxlength="40" />
...
function formSubmit(){
	...
	if(file !=""){
		...
		odin.ext.Ajax.request({
			...
			form:'excelForm',
			success:function(){
				parent.odin.info("新增测评类文档成功!");
				//parent.radow.doEvent("fileGrid.dogridquery");
				realParent.odin.ext.getCmp('file1Grid').store.reload();
				parent.odin.ext.getCmp('addWin1').close();
