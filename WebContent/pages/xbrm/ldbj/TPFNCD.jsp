			...
			<td style="width:320;">
				...
				<odin:editgrid property="codeList2Grid1" forceNoScroll="true" width="320" height="235" url="/" rowDbClick="rowFldeDbClick" load="fldListCheck">
					...
					<odin:gridColumnModel>
						<odin:gridRowNumColumn></odin:gridRowNumColumn>
						<odin:gridEditColumn header="指标项名" width="105"  dataIndex="col_name" hidden="true" edited="false" editor="text" align="left" />
						<odin:gridEditColumn2 header="指标项名" width="210"  dataIndex="col_name1" sortable="false" menuDisabled="true"  edited="false" editor="text" align="left"/>
						<odin:gridEditColumn header="指标代码类型" width="105"  dataIndex="code_type" hidden="true" edited="false" editor="text" align="left"/>
						<odin:gridEditColumn header="列数据类型" width="105"  dataIndex="col_data_type" hidden="true" edited="false" editor="text" align="left"/>
						<odin:gridEditColumn header="指标项" width="105"  dataIndex="col_code" hidden="true" edited="false" editor="text" align="left"/>
						<odin:gridEditColumn header="信息表" width="105"  dataIndex="table_code" hidden="true" edited="false" editor="text" align="left"/>
						<odin:gridEditColumn header="指标代码类型2" width="105" hidden="true" dataIndex="col_data_type_should"  edited="false" editor="text" align="left"/>
						<odin:gridEditColumn header="操作" width="80" align="center" edited="false" editor="text" dataIndex="caozuo" renderer="runorstop"  isLast="true" />
					</odin:gridColumnModel>
				</odin:editgrid>
				</odin:groupBox>
			</td>
	...
	<table id="tabcon3" style="width:100%;height:100%;">
			...
			<td >
				...
				<table>
					<tr style="display: block;">
						...
						<td rowspan="2" style="text-align:right;width:90"><odin:button text="&nbsp;&nbsp;清 &nbsp;&nbsp;&nbsp;&nbsp;除&nbsp;&nbsp;&nbsp;"  property="btnm1" handler="conditionclear" ></odin:button></td>
					</tr>
					<tr style="display: block;">
					...
					<tr>
						...
						<td style="width:50;">
							...
							<tr>
								...
								<odin:button text="&nbsp;&nbsp;编&nbsp;&nbsp;&nbsp;&nbsp;辑&nbsp;&nbsp;"  property="editbtnm" handler="editbtnFunc">
								</odin:button></td>
							</tr>
							<tr>
								<td id="iddeletecondition" style="text-align:right;width:50px;height:30px"><odin:button text="&nbsp;&nbsp;移&nbsp;&nbsp;&nbsp;&nbsp;除&nbsp;"  property="btnm3" handler="btnm3Func" ></odin:button></td>
							</tr>
							<tr>
								<td id="iddeleteallcondition" style="text-align:right;width:50px;height:30px"><odin:button text="全部删除"  property="btnm4" handler="btnm4Func" ></odin:button></td>
							</tr>
							</table>
						</td>
					</tr>
		...
		<tr>
			<td>
				...
				<tr style="width:540;">
						<odin:textarea property="conditionName9" colspan="8" rows="7" readonly="true" ></odin:textarea>
				</tr>
				<tr>
