...
<odin:editgrid2 property="memberGrid" load="selectRow" hasRightMenu="false" title="批次信息"
	...
	<odin:gridColumnModel>
		...
		<odin:gridEditColumn2 dataIndex="sybxxx" width="100" header="投资型保险反馈" editor="text" edited="false" renderer="downFunction" align="center"/>
		<odin:gridEditColumn2 dataIndex="gpjjxx" width="100" header="股票基金反馈" editor="text" edited="false" renderer="downFunction" align="center"/>
...
<odin:toolBar property="btnToolBar" applyTo="groupTreePanel">
	...
	<odin:separator></odin:separator>--%>
	<odin:buttonForToolBar text="投资型保险反馈" icon="images/icon/table.gif" handler="impCbxx" id="cbfk"/>
	<odin:separator></odin:separator>
	<odin:buttonForToolBar text="股票基金反馈" icon="images/icon/table.gif" handler="impZqxx" id="zqfk"/>
	<odin:separator></odin:separator>
	<%-- <odin:buttonForToolBar text="工商反馈" icon="images/icon/table.gif" menu="fMenu_m4" id="gsfk"/>
	<odin:separator></odin:separator> --%>
