...
<table id="talbe_1" style="width: 100%; top: 0px;">
	...
	<tr id="tr2">
		<tags:JUpload4 property="crgszw" label="资料上传" fileTypeDesc="所有文件"  colspan="2" 
...
<odin:editgrid2 property="memberGrid" hasRightMenu="false" title="导入信息" 
	...
	<odin:gridColumnModel>
		...
		<odin:gridEditColumn2 menuDisabled="true" edited="false" editor="text" dataIndex="crgszw001" width="50" header="序号" />
		<odin:gridEditColumn2 menuDisabled="true" edited="false" editor="text" dataIndex="crgszw002" width="80" header="姓名" />
		<odin:gridEditColumn2 menuDisabled="true" edited="false" editor="text" dataIndex="crgszw003" width="150" header="身份证号码" />
		<odin:gridEditColumn2 menuDisabled="true" edited="false" editor="text" dataIndex="crgszw004" width="100" header="注册号" />
		<odin:gridEditColumn2 menuDisabled="true" edited="false" editor="text" dataIndex="crgszw005" width="100" header="单位名称" />
		<odin:gridEditColumn2 menuDisabled="true" edited="false" editor="text" dataIndex="crgszw006" width="100" header="注册资本元" />
		<odin:gridEditColumn2 menuDisabled="true" edited="false" editor="text" dataIndex="crgszw007" width="100" header="企业类型" />
		<odin:gridEditColumn2 menuDisabled="true" edited="false" editor="text" dataIndex="crgszw008" width="100" header="成立日期" />
		<odin:gridEditColumn2 menuDisabled="true" edited="false" editor="text" dataIndex="crgszw011" width="100" header="经营范围" />
		<odin:gridEditColumn2 menuDisabled="true" edited="false" editor="text" dataIndex="crgszw012" width="100" header="登记机关" />
		<odin:gridEditColumn2 menuDisabled="true" edited="false" editor="text" dataIndex="crgszw013" width="100" header="企业状态" />
		<odin:gridEditColumn2 menuDisabled="true" edited="false" editor="text" dataIndex="crgszw014" width="100" header="注销日期" />
		<odin:gridEditColumn2 menuDisabled="true" edited="false" editor="text" dataIndex="crgszw015" width="100" header="吊销日期" />
