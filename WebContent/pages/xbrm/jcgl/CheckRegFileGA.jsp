...
<odin:editgrid2 property="memberGrid" load="selectRow" hasRightMenu="false" title="批次信息"
	...
	<odin:gridColumnModel>
		...
		<odin:gridEditColumn2 dataIndex="crjxx" width="100" header="出入境反馈" editor="text" edited="false" renderer="downFunction" align="center"/>
...
Ext.onReady(function() {
	...
	memberGrid.on('rowdblclick',function(gridobj,index,e){
		...
		impTest(rc.data.checkregid, 'crcrj1');
