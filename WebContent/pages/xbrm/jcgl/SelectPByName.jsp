						...
						<td width="46%" height="100%">
							...
							<odin:editgrid property="gridcq" title="待选列表"  width="300" height="350" pageSize="9999"
								...
								<odin:gridColumnModel>
									...
									<odin:gridColumn dataIndex="a0184" edited="false" header="身份证" width="100" hidden="true" align="center" isLast="true" />
	...
	<table>
		<tr>
			...
			<td>
				...
				<input type="button" height="20" width="40" value="&nbsp;确&nbsp;&nbsp;定&nbsp;" onclick="saveSelect()">&nbsp;&nbsp;
			</td>
		</tr>
	</table>
</div>
