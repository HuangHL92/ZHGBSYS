...
.x-tip-header .x-tool{background-image: none;}
	...
	/* #btnts .x-btn-text{
	    width:50px; CURSOR: pointer; TEXT-DECORATION: none; BACKGROUND: #00589E; POSITION: relative; FLOAT: right; COLOR: #fff; PADDING-BOTTOM: 5px; PADDING-TOP: 5px; PADDING-LEFT: 5px; DISPLAY: block;
	}
	#btnts{
		margin-right:12px;
	} */
...
<odin:hidden property="tabvalue" title="当前tab页值"/>
...
<%-- 	<odin:buttonForToolBar text="保存推荐"  id="savetj"  cls="bh"/> --%>
	...
	<odin:buttonForToolBar  text="保存"  id="save" handler="save" cls="bh"/>
	<odin:buttonForToolBar text="推送给干部监督处" isLast="true" cls="bh" id="btnts" handler="tsGBJD"></odin:buttonForToolBar>
...
title="" textareaStyle="display:none;text-align:center;" textareaCls="cellbgclor x-form-field" codetype="ZB01" codename="code_name3"
 defaultValue="" hiddenValue=""/>
						 ...
						 <tr>
						   ...
						   <odin:textEdit property="js1214"  maxlength="500" title="干部监督处意见" colspan="14" disabled="true" readonly="true"/>
						</tr>
					...
					<table style="width: 100%">
						...
						<tr>
						 <%-- <odin:dateEdit format="Ymd" property="js0502" width="'100%'"  title="考察时间" colspan="1" /> --%>
							...
							<odin:dateEdit format="Ymd" property="js1402" width="'100%'" title="考察时间"  colspan="1" maxlength="8"></odin:dateEdit>
						</tr>
						<tr>
...
function tsGBJD(){
	//alert(22)
	$h.confirm("系统提示：",'是否推送？',200,function(id) { 
		if("ok"==id){
...
Ext.onReady(function(){
	//拟任，拟免 input框背景色     nrzw1
	document.getElementById('js0111').style.backgroundColor ="#6ED8FC";
	document.getElementById('js0117').style.backgroundColor ="#6ED8FC";
	
	document.getElementById('nrzw1').style.background ="#6ED8FC";
	document.getElementById("nmzw1").style.background ="#6ED8FC";
	document.getElementById('nrzw2').style.background ="#6ED8FC";
	document.getElementById("nmzw2").style.background ="#6ED8FC";
	document.getElementById('nrzw3').style.background ="#6ED8FC";
	document.getElementById("nmzw3").style.background ="#6ED8FC";
	document.getElementById('nrzw4').style.background ="#6ED8FC";
	document.getElementById("nmzw4").style.background ="#6ED8FC";
	document.getElementById('nrzw5').style.background ="#6ED8FC";
	document.getElementById("nmzw5").style.background ="#6ED8FC";
	document.getElementById('nrzw6').style.background ="#6ED8FC";
	document.getElementById("nmzw6").style.background ="#6ED8FC";
	document.getElementById('nrzw7').style.background ="#6ED8FC";
	document.getElementById("nmzw7").style.background ="#6ED8FC";
	document.getElementById('nrzw8').style.background ="#6ED8FC";
	document.getElementById("nmzw8").style.background ="#6ED8FC";
	document.getElementById('nrzw9').style.background ="#6ED8FC";
	document.getElementById("nmzw9").style.background ="#6ED8FC";
	document.getElementById('nrzw10').style.background ="#6ED8FC";
	document.getElementById("nmzw10").style.background ="#6ED8FC";
	document.getElementById('nrzw11').style.background ="#6ED8FC";
	document.getElementById("nmzw11").style.background ="#6ED8FC";
	document.getElementById('nrzw12').style.background ="#6ED8FC";
	document.getElementById("nmzw12").style.background ="#6ED8FC";
	document.getElementById('nrzw13').style.background ="#6ED8FC";
	document.getElementById("nmzw13").style.background ="#6ED8FC";
	document.getElementById('nrzw14').style.background ="#6ED8FC";
	document.getElementById("nmzw14").style.background ="#6ED8FC";
	document.getElementById('nrzw15').style.background ="#6ED8FC";
	document.getElementById("nmzw15").style.background ="#6ED8FC";
	...
	peopleInfoGrid.on('rowclick',function(gridobj,index,e){       //grid表格单击事件
...
function tabclick(obj){
		...
		if($href=='#tabs-12'){
			...
			//var js1397="2";
			if(js1396 !== ""&&js1397 !== ""){
				//Ext.getCmp("r1c1").setDisabled(true);
				Ext.getCmp("r1c1").getEl().dom.readOnly = true;
				Ext.getCmp("r1c2").getEl().dom.readOnly = true;
				Ext.getCmp("r1c3").getEl().dom.readOnly = true;
				Ext.getCmp("r1c4").getEl().dom.readOnly = true;
				
				Ext.getCmp("r2c1").getEl().dom.readOnly = true;
				Ext.getCmp("r2c2").getEl().dom.readOnly = true;
				Ext.getCmp("r2c3").getEl().dom.readOnly = true;
				Ext.getCmp("r2c4").getEl().dom.readOnly = true;
				
				Ext.getCmp("r3c1").getEl().dom.readOnly = true;
				Ext.getCmp("r3c2").getEl().dom.readOnly = true;
				Ext.getCmp("r3c3").getEl().dom.readOnly = true;
				Ext.getCmp("r3c4").getEl().dom.readOnly = true;
				
				Ext.getCmp("r4c1").getEl().dom.readOnly = true;
				Ext.getCmp("r4c2").getEl().dom.readOnly = true;
				Ext.getCmp("r4c3").getEl().dom.readOnly = true;
				Ext.getCmp("r4c4").getEl().dom.readOnly = true;
				
				Ext.getCmp("r5c1").getEl().dom.readOnly = true;
				Ext.getCmp("r5c2").getEl().dom.readOnly = true;
				Ext.getCmp("r5c3").getEl().dom.readOnly = true;
				Ext.getCmp("r5c4").getEl().dom.readOnly = true;
				
				Ext.getCmp("r6c1").getEl().dom.readOnly = true;
				Ext.getCmp("r6c2").getEl().dom.readOnly = true;
				Ext.getCmp("r6c3").getEl().dom.readOnly = true;
				Ext.getCmp("r6c4").getEl().dom.readOnly = true;
			}
			...
			if(js9996 !== ""&&js9997 !== ""){
				//Ext.getCmp("r1c1").setDisabled(true);
				Ext.getCmp("t2r1c1").getEl().dom.readOnly = true;
				Ext.getCmp("t2r1c2").getEl().dom.readOnly = true;
				Ext.getCmp("t2r1c3").getEl().dom.readOnly = true;
				Ext.getCmp("t2r1c4").getEl().dom.readOnly = true;
				
				Ext.getCmp("t2r2c1").getEl().dom.readOnly = true;
				Ext.getCmp("t2r2c2").getEl().dom.readOnly = true;
				Ext.getCmp("t2r2c3").getEl().dom.readOnly = true;
				Ext.getCmp("t2r2c4").getEl().dom.readOnly = true;
				
				Ext.getCmp("t2r3c1").getEl().dom.readOnly = true;
				Ext.getCmp("t2r3c2").getEl().dom.readOnly = true;
				Ext.getCmp("t2r3c3").getEl().dom.readOnly = true;
				Ext.getCmp("t2r3c4").getEl().dom.readOnly = true;
				
				Ext.getCmp("t2r4c1").getEl().dom.readOnly = true;
				Ext.getCmp("t2r4c2").getEl().dom.readOnly = true;
				Ext.getCmp("t2r4c3").getEl().dom.readOnly = true;
				Ext.getCmp("t2r4c4").getEl().dom.readOnly = true;
				
				Ext.getCmp("t2r5c1").getEl().dom.readOnly = true;
				Ext.getCmp("t2r5c2").getEl().dom.readOnly = true;
				Ext.getCmp("t2r5c3").getEl().dom.readOnly = true;
				Ext.getCmp("t2r5c4").getEl().dom.readOnly = true;
				
				Ext.getCmp("t2r6c1").getEl().dom.readOnly = true;
				Ext.getCmp("t2r6c2").getEl().dom.readOnly = true;
				Ext.getCmp("t2r6c3").getEl().dom.readOnly = true;
				Ext.getCmp("t2r6c4").getEl().dom.readOnly = true;
			}
		}
		//默认都勾选
		if($href=='#tabs-13'){
...
function qcjs(){
	...
	for(var i=0;i<store.getCount();i++){
		...
		if(pcheck == true){
			...
			//if(num == 1){
				...
				//qcjsjs0100cs = qcjsjs0100cs +","+js0100 ;
				//alert(qcjsjs0100cs);
				$('#js0100').val(js0100);
				$('#a0101').val(a0101);
				//a0000cs = a0000cs +","+a0000;
				//alert(a0000cs);
	...
	//document.getElementById('qcjsjs0100').value= qcjsjs0100cs ;
	//document.getElementById('a0000').value= a0000cs ;
	//alert(document.getElementById('a0000').value);
	if(num!=1){
...
function setColor(num){
	if(num==5){
		document.getElementById('tabvalue').value= 5;
	}else{
		document.getElementById('tabvalue').value= 0;
	}
	if(num==3||num==4){
		var grid=Ext.getCmp("gridcq");
	    var store = grid.getStore();
