...
function setPeopleNum(val){
    ...
    $(".content-total-number ul").html(html);
}
...
function switchBar(name){
    ...
    /* ajax */
  var  ditype = document.getElementById("ditype").value;
  var  tjtype =  document.getElementById("tjtype").value;
  var  cityid = document.getElementById("cityid").value;
  var  year =  $("#aaa").find("option:selected").val();
  var  type =  $("#bbb").find("option:selected").val();
    
    var param = {'ditype':ditype,'tjtype':tjtype,'zjtype':method,'cityid':cityid,'year':year,'type':type};
    $.ajax({
        async: false,   
        type: 'post',
        url: "InsjfxServlet?method=changeZJ",
        data:param,
        dataType: "text",
...
function switchBar2(name){
	 var method = "";
	    ...
	    var  ditype = document.getElementById("ditype").value;
	    var  zjtype =  document.getElementById("zjtype").value;
	    var  year =  $("#aaa").find("option:selected").val();
	    var  type =  $("#bbb").find("option:selected").val();
	    //var  cityid = document.getElementById("cityid").value;
	    document.getElementById("tjtype").value = method;
	    var p2={'tjtype':method,'year':year,'type':type}
	    var rootNode = getOrganiseNode("",p2);
	    var id=setRoot(rootNode);
	    var param = {'ditype':ditype,'tjtype':method,'zjtype':zjtype,'cityid':rootNode.id,'year':year,'type':type};
	    init(param);
