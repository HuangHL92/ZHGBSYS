...
var g_contextpath = '<%= request.getContextPath() %>';
	Ext.onReady(function(){
		...
		$("#gdcliframe").height(screen.height *0.8);
		$("#memberGrid").height(screen.height *0.8); 
		$("#gdcliframe").attr("src","/hzb/radowAction.do?method=doEvent&pageModel=pages.xbrm2.TPB&IsGDCL=1&subWinId=qcjs&subWinIdBussessId="+parentParam.yn_id+parentParam.yn_type);
...
<TR>
<td style="width:300px;valign:top!important">
		...
		<odin:editgrid2 property="memberGrid" height="600" pageSize="9999" topBarId="topbar" url="/">
			...
			<odin:gridColumnModel>
				...
				<odin:gridEditColumn2 dataIndex="yn_type" width="110" header="调配环节" editor="select" selectData="['TPHJ1','拟酝酿动议会议'],['TPHJ2','省常委会'],['TPHJ3','省委书记专题会']" edited="false" align="center"/> <!-- ,['TPHJ2','市委书记专题会议成员酝酿'],['TPHJ3','部务会议'],['TPHJ4','市委书记专题会议'],['TPHJ5','市委常委会'] -->
...
<td>
	<iframe id="gdcliframe" name="gdcliframe" src="" style="width:830px;">
</td>
</tr>
</table>
...
function reShowMsg(gridobj,index,e){
	...
	//alert(id);
	$("#gdcliframe").attr("src","/hzb/radowAction.do?method=doEvent&pageModel=pages.xbrm2.TPB&IsGDCL=1&subWinId=qcjs&subWinIdBussessId="+id);
	//window.open("/hzb/radowAction.do?method=doEvent&pageModel=pages.xbrm2.TPB&IsGDCL=1&subWinId=qcjs&subWinIdBussessId="+id);
}
function readTPB(){
...
var doAddPerson = (function(){//增加人员
	...
	return {
		sel:function(o){
			...
			$h.openWin('seltpry','pages.xbrm2.SelectTPRY','按姓名/身份证查询 ',820,520,null,g_contextpath,window,
...
function exportTPB(expType){
	...
	var path = '<%=request.getContextPath()%>/radowAction.do?method=doEvent&pageModel=pages.xbrm2.TPBView&eventNames=ExpTPBExcel';
	//alert(path);
