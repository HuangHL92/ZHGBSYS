	...
	function formupload(){
		if(document.getElementById('excelFile').value!=""){
			...
			odin.ext.Ajax.request({
				url:'<%=request.getContextPath()%>/UploadFileServlet?method=zzbFileTYGS',
				isUpload:true,
				form:'excelForm',
				success:function(){
					parent.Ext.Msg.hide();
...
function FileUpload_onselect(){   
    ...
    var param = {};
	param.path = path;
    odin.Ajax.request(contextPath+'/dataverify/DataVerifyAction.do?method=doCheck2', param,succfun,failfun,false,false);
}
