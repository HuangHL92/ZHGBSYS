...
<iframe width="825" height="85px" src="<%=request.getContextPath() %>/pages/tygsImp/DataVerifyTYGS.jsp" frameborder=”no” border=”0″ marginwidth=”0″ marginheight=”0″ scrolling=”no” allowtransparency=”yes”></iframe>
			...
			<div id="aa2"  style="width: 540px">
				...
				<tr>
				 ...
				 <tr >
					...
					<td>&nbsp;&nbsp;
					<input type="checkbox" checked="checked" id="fxz" /><span style="font-size: 12">非现职人员</span>
					<br/><br/>&nbsp;&nbsp;
					<input type="checkbox"  id="addChild" /><span style="font-size: 12">新增下级单位</span>
					</td>
				</tr>
				<tr height="15">
					<td></td><td></td>
...
<odin:toolBar property="btnToolBar" >
	<odin:textForToolBar text="<h3>&nbsp;支持zip格式导入&nbsp;&nbsp;<font style=\"color:red\">注意：该方式导入的数据包中，不包含职级管理信息，请谨慎使用!</font></h3>" />
	<odin:fill />
...
function formSubmit2(){
	...
	var addChild = document.getElementById('addChild').checked;//true为选中
	if(ftype == '31'){
	...
	if(type11 == "MYSQL" && count2>100000){
		...
		Ext.Ajax.request({
				url:'<%=request.getContextPath()%>/UploadFileServlet?method=zzbFileImp&uuid='+uuid+'&filename='+filename+'&b0111new='+b0111new+'&a0165='+a0165+'&fxz='+fxz+'&addChild='+addChild,
