...
<!-- 统计分析基本情况分析模块专属 -->
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/sysorg/org/gbjbqk/JsClassify/Gbjbqkshao_c.js" ></script>
...
function myMouseDClick(col1, row1) {
	...
	//alert(dwid);
	var id_weiyi="GbjbqkshaoSub";//不可重复
	//用户id
	...
	$h.openWin(id_weiyi,'pages.sysorg.org.gbjbqk.GbjbqkshaoSub',title+'-二维统计',1300,550,dwid,'<%=request.getContextPath()%>');
}
var title_zj="(少)";
</script>
<!--  点击统计分析    -->
