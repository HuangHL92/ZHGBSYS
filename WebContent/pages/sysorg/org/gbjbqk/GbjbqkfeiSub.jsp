...
<!-- 统计分析基本情况分析模块专属 -->
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/sysorg/org/gbjbqk/JsClassify/Gbjbqkfei_c.js" ></script>
...
function myMouseDClick(col1, row1) {
	...
	//alert(dwid);
	var id_weiyi="GbjbqkfeiSub";//不可重复
	//用户id
	...
	$h.openWin(id_weiyi,'pages.sysorg.org.gbjbqk.GbjbqkfeiSub',title+'-二维统计',1300,550,dwid,'<%=request.getContextPath()%>');
}
var title_zj="(非)";
</script>
<!--  点击统计分析    -->
