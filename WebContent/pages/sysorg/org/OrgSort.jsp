      ...
      var tree = new Tree.TreePanel( {
         ...
         // height:450,
          ...
          loader : new Tree.TreeLoader( {
                dataUrl : 'radowAction.do?method=doEvent&pageModel=pages.sysorg.org.PublicWindow&eventNames=orgTreeJsonDataOpenTree'
          })
      });
...
<table style="height:100%;overflow:auto;" border="0">
	<tr>
		<td valign="top">
			<div id="tree-div" style="overflow: auto; border: 2px solid #c3daf9;float: left;width:100%;height:500px;"></div>
		</td>
		<td width="22px">&nbsp;</td>
		<td align="right">
