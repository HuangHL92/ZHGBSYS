...
<!-- 统计分析基本情况分析模块专属 -->
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/sysorg/org/gbjbqk/JsClassify/Gbjbqk_c.js" ></script>
<%--用户接受路径参数的值，并保存 --%>
...
function myMouseDClick(col1, row1) {
	...
	$h.openWin(id_weiyi,'pages.sysorg.org.GbjbqkSub',title+'-二维统计',1300,550,dwid,'<%=request.getContextPath()%>');
}
var title_zj="";
</script>
<!--  点击统计分析    -->
