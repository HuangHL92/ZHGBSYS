<%@page import="com.insigma.siis.local.pagemodel.sysorg.org.CgsySysOrgPageModel"%>
...
<%
	String UNITID = (String)session.getAttribute("UNITID2");
	List<HashMap<String, Object>> listCode  = new ArrayList<HashMap<String, Object>>();
	if(UNITID!=null&&!UNITID.equals("")){
	listCode = (List<HashMap<String, Object>>)CgsySysOrgPageModel.querybyid_Bzzs(UNITID);
	}
%>
<html>
<head>
	...
	if(listCode.size()<1){
		...
		<table id="coordTable1" class="coordTable A3" style="table-layout: fixed;WIDTH: 1380px" cellspacing="0" sizcache="26" sizset="0">
		 ...
		 <tr id="insertadd">
		  ...
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 180px" colspan="5">编制类别</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 180px" colspan="7">单位领导职数 </th>
		 ...
		 <tr>
		  ...
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">工勤<br/>人员<br/>编制</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">事	<br/>业<br/>编<br/>制</th>
...
<table id="coordTable1" class="coordTable A3" style="table-layout: fixed;WIDTH: 1380px" cellspacing="0" sizcache="26" sizset="0">
 ...
 <td class="rownum default_color aligh_sensc" style="DISPLAY: none" nodeindex="1">1</td>
  ...
  <%=(String)map.get("s5")==null?"":(String)map.get("s5") %>
  </td>
  <td class="default_color " sizcache="61" sizset="10" nodeindex="10">
  <%=(String)map.get("s6")==null?"":(String)map.get("s6") %>
  </td>
  ...
  <%=(String)map.get("s8")==null?"":(String)map.get("s8") %>
  </td>
  <td class="default_color " sizcache="61" sizset="13" nodeindex="13">
  <%=(String)map.get("s2")==null?"":(String)map.get("s2") %><!-- 合计 -->
  </td>
  <td class="default_color " sizcache="61" sizset="13" nodeindex="13">
  <%=(String)map.get("s3")==null?"":(String)map.get("s3") %><!-- 合计 -->
  </td>
  <td class="default_color " sizcache="61" sizset="13" nodeindex="13">
  <%=(String)map.get("s4")==null?"":(String)map.get("s4") %><!-- 合计 -->
  </td>
  <td class="default_color " sizcache="61" sizset="13" nodeindex="13">
  <%=(String)map.get("s7")==null?"":(String)map.get("s7") %><!-- 合计 -->
  </td>
  <td class="default_color " sizcache="61" sizset="13" nodeindex="13">
  <%=(String)map.get("s9")==null?"":(String)map.get("s9") %><!-- 合计 -->
  </td>
  <td class="default_color " sizcache="61" sizset="13" nodeindex="13">
  ...
  <td class="default_color " sizcache="61" sizset="17" nodeindex="17">
  <%=(String)map.get("s22")==null?"":(String)map.get("s22") %><!-- 行政副职领导 -->
  </td>
  ...
  <td class="default_color " sizcache="61" sizset="49" nodeindex="49">
  <%=(String)map.get("s39")==null?"":(String)map.get("s39") %>
  </td>
