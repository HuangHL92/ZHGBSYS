...
<%@ page import="com.insigma.siis.local.pagemodel.sysorg.org.ZjzzyPersonPageModel"%>
...
<%
	String ereaname = (String) (new ZjzzyPersonPageModel().areaInfo
			.get("areaname"));
	String ereaid = (String) (new ZjzzyPersonPageModel().areaInfo
			.get("areaid"));
	String manager = (String) (new ZjzzyPersonPageModel().areaInfo
			.get("manager"));
	String picType = (String)(new ZjzzyPersonPageModel().areaInfo.get("picType"));
%>
<div align="center" style="width:787;height:470;border: 3" id="main">
 <odin:tab id="tab">
	<odin:tabModel>
		 <odin:tabItem title="全员批量转移" id="tab1"></odin:tabItem> 
		 <odin:tabItem title="部分人员转移" id="tab2" isLast="true"></odin:tabItem>
	</odin:tabModel>
 <odin:tabCont itemIndex="tab1">
	<table style="width:780;height:450;" border="0">
		<col width="30%">
		<col width="16%">
		<col width="8%">
		<col width="16%">
		...
		<tr align="center">
			...
			<td id="td_type" align="left">
		
				<table  border="0" style="width:20;height:30;">
					<tr>
					   <td></td>
		...
		<tr>
			...
			<td colspan="1"  valign="top" >
				<div id="tree-div" style="overflow: auto; border: 2px solid #c3daf9;float: left;width: 220px;height: 220px;"></div>
			</td>
			<td align="center">
				<img src="<%=request.getContextPath()%>/pages/sysorg/org/images/arrow-right.png">
			</td>
			<td colspan="1" align="left" valign="top"><div id="tree-div1" style="overflow: auto; border: 2px solid #c3daf9;float: right;width: 220px;height: 220px;"></div></td>
		...
		<tr align="center">
		 ...
		 <div align="center" style="width:787;height:475;border: 3" id="main">
		<iframe id="zi"
			src="<%=request.getContextPath()%>/radowAction.do?method=doEvent&pageModel=pages.sysorg.org.ZjzzyPart"
			height="100%" width="100%" id="resultUpdate" name="resultUpdate">
		</iframe>
		</div>
		</odin:tabCont>
	</odin:tab>
...
<script type="text/javascript">
Ext.onReady(function() {
	document.getElementById('zi').src = "<%=request.getContextPath()%>/radowAction.do?method=doEvent&pageModel=pages.sysorg.org.ZjzzyPart";
	if(<%="transferSysOrg".equals(transferType)%>){
		//document.frames['zi'].document.getElementById('td_type').style.visibility='hidden';
		document.getElementById('td_type').style.visibility='hidden';
	}
	
	var heighttd=document.getElementById("td_id").offsetHeight;
	//var heighttdzi=document.frames['zi'].document.getElementById('td_id').offsetHeight;
	var heighttd1=document.getElementById("td_id1").offsetHeight;
	//var heighttdzi1=document.frames['zi'].document.getElementById("td_id1").offsetHeight;
	var height=document.body.offsetHeight;
	//var heightzi=document.frames['zi'].document.body.offsetHeight;
	document.getElementById("tree-div").style.height=height-heighttd-heighttd1-8;
	//console.log(document.frames['zi'].document.getElementById("tree-div11"));
	//document.frames['zi'].document.getElementById("tree-div11").style.height=heightzi-heighttdzi-heighttdzi1-8;
	document.getElementById("tree-div1").style.height=height-heighttd-heighttd1-8;
	//document.frames['zi'].document.getElementById("tree-div22").style.height=heightzi-heighttdzi-heighttdzi1-8;
	document.getElementById("main").parentNode.parentNode.style.overflow='hidden';
	//document.frames['zi'].document.getElementById("main").parentNode.parentNode.style.overflow='hidden';
...
function jcHeightWidth(){
	...
	//var heightzi=document.frames['zi'].document.body.offsetHeight;
	document.getElementById("tree-div").style.height=height-heighttd-heighttd1-8;
	//document.frames['zi'].document.getElementById("tree-div").style.height=heightzi-heighttdzi-heighttdzi1-8;
	document.getElementById("tree-div1").style.height=height-heighttd-heighttd1-8;
	//document.frames['zi'].document.getElementById("tree-div1").style.height=heightzi-heighttdzi-heighttdzi1-8;
}
