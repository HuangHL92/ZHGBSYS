...
<div style="width:100%;height:100%" align="center" id="main">
	<table border="0">
		<tr>
			<td>
				<table id="table_id1">
		...
		<tr>
			<td>
				<table id="table_id3" style="width:100%;" border="0">
					<tr>
						<td align="right"><odin:button property="expBtn" text="&nbsp;确&nbsp;&nbsp;定&nbsp;" handler="doQuery"></odin:button></td>
						<td width="40"></td> 
						<td align="left"><odin:button property="cancelBtn" text="&nbsp;取&nbsp;&nbsp;消&nbsp;"></odin:button></td>
					</tr>
				</table>
			</td>
		</tr>
...
<%-- <odin:window src="/blank.htm" id="SysPreview" width="1000" height="500"
	title="职数编制统计" modal="true"></odin:window>
	 --%>
<script type="text/javascript">
...
Ext.onReady(function() {
	var table_id1=document.getElementById("table_id1").offsetHeight;
	var table_id3=document.getElementById("table_id3").offsetHeight;
	var height=document.body.offsetHeight;
	document.getElementById("tree-div").style.height=height-table_id1-table_id3-20;
