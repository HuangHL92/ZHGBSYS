...
<%@page import="com.insigma.siis.local.pagemodel.sysorg.org.XzjgSysOrgPageModel"%>
...
<%
	String UNITID = (String)session.getAttribute("UNITID3");
	List<HashMap<String, Object>> listCode  = new ArrayList<HashMap<String, Object>>();
	if(UNITID!=null&&!UNITID.equals("")){
	listCode = (List<HashMap<String, Object>>)XzjgSysOrgPageModel.querybyid_Bzzs(UNITID);
	}
%>
<html>
<head>
	...
	if(listCode.size()<1){
		...
		<table id="coordTable1" class="coordTable A3" style="table-layout: fixed;WIDTH: 1380px" cellspacing="0" sizcache="26" sizset="0">
		 ...
		 <tr id="insertadd">
		  ...
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 160px" colspan="5">编制类别</th>
		  <th class="lign" style="FONT-SIZE: 11pt; HEIGHT: 50px !important; WIDTH: 30px" rowspan="3">省<br/>市<br/>乡<br/>县<br/>领<br/>导</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 220px" colspan="7">部门领导职数</th>
		  ...
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 90px" colspan="3">其他</th>
		 ...
		 <tr>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">行<br/>政<br/>编<br/>制</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">政法<br/>专项<br/>编制</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">纪检<br/>监察<br/>行政<br/>编制</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">机关<br/>工勤<br/>人员<br/>编制</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">机关<br/>使用<br/>事业<br/>编制</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">合<br/>计</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">部<br/>门<br/>正<br/>职<br/>领<br/>导</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">部<br/>门<br/>副<br/>职<br/>领<br/>导</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">秘<br/>书<br/>长</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">机关<br/>党委<br/>书记</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">专业<br/>技术<br/>领导</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">政治<br/>部主<br/>任</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">合<br/>计</th>
		  ...
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">工<br/>作<br/>人<br/>员</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">工<br/>勤<br/>人<br/>员</th>
		  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">其<br/>他<br/>人<br/>员</th>
...
<th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">部<br/>门<br/>副<br/>职<br/>领<br/>导</th>
<th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">秘<br/>书<br/>长</th>
<th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 35px;"  rowspan="2">机关<br/>党委<br/>书记</th>
<th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 35px;"  rowspan="2">专业<br/>技术<br/>领导</th>
<th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 35px;"  rowspan="2">政治<br/>部主<br/>任</th>
  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">合<br/>计</th>
  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 60px; " rowspan="2">纪检<br/>组长<br/>、纪<br/>委书<br/>记、<br/>专职<br/>纪检<br/>监察<br/>员</th>
  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">纪检<br/>副组<br/>长、<br/>纪委<br/>副书<br/>记</th>
  <th class="lign" style="FONT-SIZE: 11pt; TEXT-ALIGN: center; WIDTH: 30px;"  rowspan="2">监<br/>察<br/>室<br/>主<br/>任</th>
 ...
 <td class="rownum default_color aligh_sensc" style="DISPLAY: none" nodeindex="1">1</td>
  ...
  <%=(String)map.get("s25")==null?"":(String)map.get("s25") %><!-- 行政副职领导 -->
  </td>
  <td class="default_color " sizcache="61" sizset="18" nodeindex="18">
  <%=(String)map.get("s26")==null?"":(String)map.get("s26") %>
  </td>
  ...
  <%=(String)map.get("sum3")==null?"":(String)map.get("sum3") %><!-- 合计 -->
  </td>
  <td class="default_color " sizcache="61" sizset="25" nodeindex="25">
  <%=(String)map.get("sum4")==null?"":(String)map.get("sum4") %><!-- 纪检组长，纪委书记 -->
  </td>
  <td class="default_color " sizcache="61" sizset="26" nodeindex="26">
  <%=(String)map.get("sum5")==null?"":(String)map.get("sum5") %><!-- 纪检副组长，纪委副书记 -->
  </td>
  ...
  <%=(String)map.get("s37")==null?"":(String)map.get("s37") %>
  </td>
  <td class="default_color " sizcache="61" sizset="50" nodeindex="50">
  <%=(String)map.get("s38")==null?"":(String)map.get("s38") %>
  </td>
  <td class="default_color " sizcache="61" sizset="50" nodeindex="50">
  <%=(String)map.get("s38")==null?"":(String)map.get("s38") %>
  </td>
