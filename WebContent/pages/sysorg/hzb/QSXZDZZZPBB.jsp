...
function expExcel(){
	...
	if(dataArray.length>0){
	    ajaxSubmit('expExcel',{"dataArray":Ext.encode(dataArray),"excelname":"全市乡镇（街道）党政正职配备情况统计表"});
	}
}
...
<div id="selectable">
	...
	<table id="coordTable" cellspacing="0" width="100%" >
		<tr>
		    <td colspan="11" class="borderTop title borderRight">全市乡镇（街道）党政正职配备情况统计表</td>
		</tr>
		<tr>
			<th rowspan="2" class="th1">单位</th>
			<th rowspan="2" class="th2">乡镇（街道）数量</th>
			<th colspan="3" class="th12">实际配备乡镇（街道）党政正职</th>
			<th colspan="3" class="th13">实际配备乡镇（街道）党（工）委书记</th>
			<th colspan="3" class="th14">实际配备乡镇（街道）镇长（主任）</th>
		</tr>
		<tr>
		    <th class="th3">总数</th>
		    <th class="th4">35岁左右党政正职</th>
		    <th class="th5">占比</th>
		    <th class="th6">总数</th>
		    <th class="th7">35岁左右党（工）委书记</th>
		    <th class="th8">占比</th>
		    <th class="th9">总数</th>
		    <th class="th10">35岁左右镇长（主任）</th>
		    <th class="th11">占比</th>
		</tr>
	</table>
</div>
