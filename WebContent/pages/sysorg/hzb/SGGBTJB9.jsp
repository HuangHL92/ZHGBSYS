<%@page import="com.insigma.siis.local.pagemodel.sysorg.org.hzb.SGGBTJB9"%>
...
function expExcel(){
	...
	if(dataArray.length>0){
	    ajaxSubmit('expExcel',{"dataArray":Ext.encode(dataArray),"excelname":"市级政府部门市管干部情况统计表（39家单位）"});
	}
}
...
<div id="selectable">
	<table id="coordTable" cellspacing="0" width="100%" >
		<tr>
		    <td colspan="44" class="borderTop title borderRight">市级政府部门市管干部情况统计表（39家单位）</td>
		</tr>
		<tr>
