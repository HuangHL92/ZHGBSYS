<%@page import="com.insigma.siis.local.pagemodel.sysorg.org.hzb.QXSZSDWGBPB"%>
...
$(function(){
	...
	var xj41=0;var xj42=0;var xj43=0;var xj44=0;var xj45=0;var xj46=0;var xj47=0;var xj48=0;var xj49=0;
	...
	var hj41=0;var hj42=0;var hj43=0;var hj44=0;var hj45=0;var hj46=0;var hj47=0;var hj48=0;var hj49=0;
	var tval09=0;
	$.each(data, function (i,item) {
		...
		SetTDtext(tds[0],item["t00"]);SetTDtext(tds[1],item["t01"]);
		
		SetTDtext(tds[2],item["t02"]);SetTDtext(tds[3],item["t03"]);SetTDtext(tds[4],item["t04"]);
		...
		SetTDtext(tds[45],item["t45"]);SetTDtext(tds[46],item["t46"]);SetTDtext(tds[47],item["t47"]);SetTDtext(tds[47],item["t47"]);SetTDtext(tds[48],item["t48"]);
		SetTDtext(tds[49],item["t49"]);
		ROWID[i]=item["t00"];
		...
		hj37=hj37+parseInt(item["t37"]);hj38=hj38+parseInt(item["t38"]);hj39=hj39+parseInt(item["t39"]);hj40=hj40+parseInt(item["t40"]);
		hj41=hj41+parseInt(item["t41"]);hj42=hj42+parseInt(item["t42"]);hj43=hj43+parseInt(item["t43"]);
		...
		hj49=hj49+parseInt(item["t49"]);
		
		
		if(item["t00"]=="区县（市）管正职" || item["t00"]=="区县（市）管副职" ){
			...
			xj37=xj37+parseInt(item["t37"]);xj38=xj38+parseInt(item["t38"]);xj39=xj39+parseInt(item["t39"]);xj40=xj40+parseInt(item["t40"]);
			xj41=xj41+parseInt(item["t41"]);xj42=xj42+parseInt(item["t42"]);xj43=xj43+parseInt(item["t43"]);
	...
	document.getElementById("hj29").innerHTML=isnull(hj29);document.getElementById("hj30").innerHTML=isnull(hj30);document.getElementById("hj31").innerHTML=isnull(hj31);document.getElementById("hj32").innerHTML=isnull(hj32);  
	document.getElementById("hj33").innerHTML=isnull(hj33);document.getElementById("hj34").innerHTML=isnull(hj34);document.getElementById("hj35").innerHTML=isnull(hj35); 
	document.getElementById("hj37").innerHTML=isnull(hj37);document.getElementById("hj39").innerHTML=isnull(hj39);  
	...
	document.getElementById("hj49").innerHTML=isnull(hj49);
	document.getElementById("hj31").innerHTML=isnull(hj31);
	document.getElementById("hj33").innerHTML=isnull(hj33);
	hj36=Math.round(hj35*1000/xj1)/10+"%";
	document.getElementById("hj36").innerHTML=isnull(hj36);
	hj38=Math.round(hj37*1000/xj1)/10+"%";
	document.getElementById("hj38").innerHTML=isnull(hj38);
	hj40=Math.round(hj39*1000/xj1)/10+"%";
	...
	document.getElementById("xj29").innerHTML=isnull(xj29);document.getElementById("xj30").innerHTML=isnull(xj30);document.getElementById("xj31").innerHTML=isnull(xj31);document.getElementById("xj32").innerHTML=isnull(xj32);  
	document.getElementById("xj33").innerHTML=isnull(xj33);document.getElementById("xj34").innerHTML=isnull(xj34);document.getElementById("xj35").innerHTML=isnull(xj35);
	document.getElementById("xj37").innerHTML=isnull(xj37);document.getElementById("xj39").innerHTML=isnull(xj39);  
	...
	document.getElementById("xj49").innerHTML=isnull(xj49);
	document.getElementById("xj31").innerHTML=isnull(xj31);
	document.getElementById("xj33").innerHTML=isnull(xj33);
	xj36=Math.round(xj35*1000/xj1)/10+"%";
	document.getElementById("xj36").innerHTML=isnull(xj36);
	xj38=Math.round(xj37*1000/xj1)/10+"%";
	document.getElementById("xj38").innerHTML=isnull(xj38);
	xj40=Math.round(xj39*1000/xj1)/10+"%";
	document.getElementById("xj40").innerHTML=isnull(xj40);
	
	
	
	$('td:nth-child(2),td:nth-child(4),td:nth-child(5),td:nth-child(6),td:nth-child(7),td:nth-child(8),td:nth-child(9),td:nth-child(10),td:nth-child(11),'+
	'td:nth-child(12),td:nth-child(13),td:nth-child(14),td:nth-child(15),td:nth-child(17),td:nth-child(18),td:nth-child(19),td:nth-child(20),'+
	...
	'td:nth-child(31),td:nth-child(32),td:nth-child(33),td:nth-child(34),td:nth-child(35),td:nth-child(36),td:nth-child(38),td:nth-child(40),'+	
	'td:nth-child(42),td:nth-child(43),td:nth-child(44),td:nth-child(45),td:nth-child(46),td:nth-child(47),td:nth-child(48),td:nth-child(49),td:nth-child(50),','#coordTable2 tr:gt(0)').each(function (i, item) {
...
function expExcel(){
	...
	if(dataArray.length>0){
	    ajaxSubmit('expExcel',{"dataArray":Ext.encode(dataArray),"excelname":"区县（市）直属单位领导干部配备情况统计分析表"});
	}
}
...
<div id="selectable4">
	...
	<table id="coordTable" cellspacing="0" width="100%" >
		<tr>
		    <td colspan="80" class="borderTop title borderRight">区县（市）直属单位领导干部配备情况统计分析表</td>
		</tr>
		<tr>
			<th rowspan="3"  class="th11">区（县）市</th>
			<!-- <th rowspan="3" class="th2">单位数</th> -->
			<th rowspan="3" colspan="1" class="th18">区县（市）管干部实配数</th>
	...
	<table  cellspacing="0" width="100%" >
	 	<tr>
			...
			<th  id="hj1" class="th18"></th><th  id="hj2" class="th18"></th><th  id="hj3" class="th14"></th><th  id="hj4" class="th14"></th><th  id="hj5" class="th14"></th>
			...
			<th  id="hj36" class="th18"></th><th  id="hj37" class="th14"></th><th  id="hj38" class="th18"></th><th  id="hj39" class="th14"></th><th  id="hj40" class="th18"></th>
			<th  id="hj41" class="th14"></th><th  id="hj42" class="th14"></th><th  id="hj43" class="th14"></th><th  id="hj44" class="th14"></th><th  id="hj45" class="th14"></th>
			<th  id="hj46" class="th14"></th><th  id="hj47" class="th14"></th><th  id="hj48" class="th14"></th><th  id="hj49" class="th14">
		</tr>
		<tr>
			<th  class="th11" style="height: 40px;">正副职小计</th>
			<th  id="xj1" class="th18"></th><th  id="xj2" class="th18"></th><th  id="xj3" class="th14"></th><th  id="xj4" class="th14"></th><th  id="xj5" class="th14"></th>
			...
			<th  id="xj36" class="th18"></th><th  id="xj37" class="th14"></th><th  id="xj38" class="th18"></th><th  id="xj39" class="th14"></th><th  id="xj40" class="th18"></th>
			<th  id="xj41" class="th14"></th><th  id="xj42" class="th14"></th><th  id="xj43" class="th14"></th><th  id="xj44" class="th14"></th><th  id="xj45" class="th14"></th>
			<th  id="xj46" class="th14"></th><th  id="xj47" class="th14"></th><th  id="xj48" class="th14"></th><th  id="xj49" class="th14">
		</tr>
	</table>
	</div>
	<div  id="selectable2">
	...
	<table id="coordTable2" cellspacing="0" width="100%" >
		<tr>
			<th class="th11"></th></th><th class="th18"></th><th class="th18"></th>
