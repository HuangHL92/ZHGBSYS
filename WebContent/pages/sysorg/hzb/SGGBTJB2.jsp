<%@page import="com.insigma.siis.local.pagemodel.sysorg.org.hzb.SGGBTJB2"%>
...
var data = <%=SGGBTJB2.expData()%>;
var data2 = <%=SGGBTJB2.expData2()%>;
$(function(){
	//alert(data.length);
	var ROWID={};
	...
	'td:nth-child(41),td:nth-child(42),td:nth-child(43),td:nth-child(44)','#coordTable2 tr:gt(0)').each(function (i, item) {
        ...
        $(this).on('click',function(){
        	...
        	p['query_type']="SGGBTJB2";
        	openMate(p);
        })
    });
    
    var ROWID2={};
    var dz1=0;var dz2=0;var dz3=0;var dz4=0;var dz5=0;var dz6=0;var dz7=0;var dz8=0;var dz9=0;var dz10=0;
	var dz11=0;var dz12=0;var dz13=0;var dz14=0;var dz15=0;var dz16=0;var dz17=0;var dz18=0;var dz19=0;var dz20=0;
	var dz21=0;var dz22=0;var dz23=0;var dz24=0;var dz25=0;var dz26=0;var dz27=0;var dz28=0;var dz29=0;var dz30=0;
	var dz31=0;var dz32=0;var dz33=0;var dz34=0;var dz35=0;var dz36=0;var dz37=0;var dz38=0;var dz39=0;var dz40=0;var dz41=0;var dz42=0;var dz43=0;
    ...
    $.each(data2, function (i,item) {
		...
		SetTDtext(tds[40],item["t40"]);SetTDtext(tds[41],item["t41"]);SetTDtext(tds[42],item["t42"]);SetTDtext(tds[43],item["t43"]);
		ROWID2[i]=item["b0111"];
		$('#coordTable3').append(tr);
		dz1=dz1+parseInt(item["t01"]);dz3=dz3+parseInt(item["t03"]);dz4=dz4+parseInt(item["t04"]);dz5=dz5+parseInt(item["t05"]);dz6=dz6+parseInt(item["t06"]);
		dz7=dz7+parseInt(item["t07"]);dz8=dz8+parseInt(item["t08"]);dz9=dz9+parseInt(item["t09"]);dz10=dz10+parseInt(item["t10"]);dz11=dz11+parseInt(item["t11"]);
		dz12=dz12+parseInt(item["t12"]);dz13=dz13+parseInt(item["t13"]);dz14=dz14+parseInt(item["t14"]);dz15=dz15+parseInt(item["t15"]);dz16=dz16+parseInt(item["t16"]);
		dz17=dz17+parseInt(item["t17"]);dz18=dz18+parseInt(item["t18"]);dz19=dz19+parseInt(item["t19"]);dz20=dz20+parseInt(item["t20"]);dz21=dz21+parseInt(item["t21"]);
		dz22=dz22+parseInt(item["t22"]);dz23=dz23+parseInt(item["t23"]);dz24=dz24+parseInt(item["t24"]);dz25=dz25+parseInt(item["t25"]);dz26=dz26+parseInt(item["t26"]);
		dz27=dz27+parseInt(item["t27"]);dz28=dz28+parseInt(item["t28"]);dz29=dz29+parseInt(item["t29"]);dz30=dz30+parseInt(item["t30"]);dz32=dz32+parseInt(item["t32"]);
		dz34=dz34+parseInt(item["t34"]);dz35=dz35+parseInt(item["t35"]);dz36=dz36+parseInt(item["t36"]);dz37=dz37+parseInt(item["t37"]);dz38=dz38+parseInt(item["t38"]);
		dz39=dz39+parseInt(item["t39"]);dz40=dz40+parseInt(item["t40"]);dz41=dz41+parseInt(item["t41"]);dz42=dz42+parseInt(item["t42"]);dz43=dz43+parseInt(item["t43"]);
	});
    
    document.getElementById("dz1").innerHTML=isnull(dz1);document.getElementById("dz3").innerHTML=isnull(dz3);document.getElementById("dz4").innerHTML=isnull(dz4);document.getElementById("dz4").innerHTML=isnull(dz4);
	document.getElementById("dz5").innerHTML=isnull(dz5);document.getElementById("dz6").innerHTML=isnull(dz6);document.getElementById("dz7").innerHTML=isnull(dz7);document.getElementById("dz8").innerHTML=isnull(dz8);
	document.getElementById("dz9").innerHTML=isnull(dz9);document.getElementById("dz10").innerHTML=isnull(dz10);document.getElementById("dz11").innerHTML=isnull(dz11);document.getElementById("dz12").innerHTML=isnull(dz12);
	document.getElementById("dz13").innerHTML=isnull(dz13);document.getElementById("dz14").innerHTML=isnull(dz14);document.getElementById("dz15").innerHTML=isnull(dz15);document.getElementById("dz16").innerHTML=isnull(dz16);  
	document.getElementById("dz17").innerHTML=isnull(dz17);document.getElementById("dz18").innerHTML=isnull(dz18);document.getElementById("dz19").innerHTML=isnull(dz19);document.getElementById("dz20").innerHTML=isnull(dz20);  
	document.getElementById("dz21").innerHTML=isnull(dz21);document.getElementById("dz22").innerHTML=isnull(dz22);document.getElementById("dz23").innerHTML=isnull(dz23);document.getElementById("dz24").innerHTML=isnull(dz24);  
	document.getElementById("dz25").innerHTML=isnull(dz25);document.getElementById("dz26").innerHTML=isnull(dz26);document.getElementById("dz27").innerHTML=isnull(dz27);document.getElementById("dz28").innerHTML=isnull(dz28);  
	document.getElementById("dz29").innerHTML=isnull(dz29);document.getElementById("dz30").innerHTML=isnull(dz30);document.getElementById("dz32").innerHTML=isnull(dz32);  
	document.getElementById("dz34").innerHTML=isnull(dz34);document.getElementById("dz35").innerHTML=isnull(dz35);document.getElementById("dz36").innerHTML=isnull(dz36);  
	document.getElementById("dz37").innerHTML=isnull(dz37);document.getElementById("dz38").innerHTML=isnull(dz38);document.getElementById("dz39").innerHTML=isnull(dz39);document.getElementById("dz40").innerHTML=isnull(dz40);  
	document.getElementById("dz41").innerHTML=isnull(dz41);document.getElementById("dz42").innerHTML=isnull(dz42);document.getElementById("dz43").innerHTML=isnull(dz43);
	dz31=Math.round(dz30*1000/dz1)/10+"%";
	document.getElementById("dz31").innerHTML=isnull(dz31);
	dz33=Math.round(dz32*1000/dz1)/10+"%";
	document.getElementById("dz33").innerHTML=isnull(dz33);
    
	$('td:nth-child(2),td:nth-child(4),td:nth-child(5),td:nth-child(6),td:nth-child(7),td:nth-child(8),td:nth-child(9),td:nth-child(10),'+
		'td:nth-child(11),td:nth-child(12),td:nth-child(13),td:nth-child(14),td:nth-child(15),td:nth-child(16),td:nth-child(17),td:nth-child(18),td:nth-child(19),td:nth-child(20),'+
		'td:nth-child(21),td:nth-child(22),td:nth-child(23),td:nth-child(24),td:nth-child(25),td:nth-child(26),td:nth-child(27),td:nth-child(28),td:nth-child(29),td:nth-child(30),'+
		'td:nth-child(31),td:nth-child(33),td:nth-child(35),td:nth-child(36),td:nth-child(37),td:nth-child(38),td:nth-child(39),td:nth-child(40),'+	
		'td:nth-child(41),td:nth-child(42),td:nth-child(43),td:nth-child(44)','#coordTable3 tr:gt(0)').each(function (i, item) {
	        $(this).addClass('pointer');
	        $(this).on('click',function(){
	        	var p = {maximizable:false,resizable:false};
	        	p['colIndex'] = $(this).index();
	        	//alert($(this).parent().index())
	        	p['b0111'] = ROWID2[$(this).parent().index()-1];
	        	p['query_type']="SGGBTJB21";
	        	openMate(p);
	        })
	    });
...
function expExcel(){
	...
	if(dataArray.length>0){
	    ajaxSubmit('expExcel',{"dataArray":Ext.encode(dataArray),"excelname":"区县（市）市管干部情况统计表（13家单位）"});
	}
}
...
.th1{width: 5%;}.th2{width: 3%;}.th3{width: 3%;}.th4{width: 2%;}.th5{width: 66%;}
.th6{width: 15%;}.th7{width: 5%;text-align: left;}.th9{width: 3%;}.th8{width: 2.5%;}
</style>
</head>
<body>
<div id="selectable">
	<table id="coordTable" cellspacing="0" width="100%" >
		<tr>
		    <td colspan="44" class="borderTop title borderRight">区县（市）市管干部情况统计表（13家单位）</td>
		</tr>
		<tr>
...
<div id="counttable01">
	<table  cellspacing="0" width="100%" >
		...
		<tr>
			<th  class="th1" style="height: 40px;">合计</th><th  id="hj1" class="th2"></th><th  id="hj2" class="th2">/</th><th  id="hj3" class="th4"></th><th  id="hj4" class="th4"></th><th  id="hj5" class="th4"></th>
			...
			<th  id="hj30" class="th4"></th><th  id="hj31" class="th9"></th><th  id="hj32" class="th4"></th><th  id="hj33" class="th9"></th><th  id="hj34" class="th4"></th><th  id="hj35" class="th8"></th>
...
<div  id="selectable2">
	...
	<table id="coordTable2" cellspacing="0" width="100%" >
		<tr>
			...
			<th class="th4"></th><th class="th4"></th><th class="th4"></th><th class="th4"></th><th class="th4"></th><th class="th4"></th>
			<th class="th4"></th><th class="th4"></th><th class="th4"></th><th class="th4"></th><th class="th4"></th><th class="th4"></th>
			<th class="th4"></th><th class="th9"></th><th class="th4"></th><th class="th9"></th><th class="th4"></th><th class="th8"></th>
...
<div id="counttable02">
	<table  cellspacing="0" width="100%" >
		...
		<tr>
			<th  class="th1" style="height: 40px;">党政合计</th><th  id="dz1" class="th2"></th><th  id="dz2" class="th2">/</th><th  id="dz3" class="th4"></th><th  id="dz4" class="th4"></th><th  id="dz5" class="th4"></th>
			<th  id="dz6" class="th4"></th><th  id="dz7" class="th4"></th><th  id="dz8" class="th4"></th><th  id="dz9" class="th4"></th><th  id="dz10" class="th4"></th><th  id="dz11" class="th4"></th>
			<th  id="dz12" class="th4"></th><th  id="dz13" class="th4"></th><th  id="dz14" class="th4"></th><th  id="dz15" class="th4"></th><th  id="dz16" class="th4"></th><th  id="dz17" class="th4"></th>
			<th  id="dz18" class="th4"></th><th  id="dz19" class="th4"></th><th  id="dz20" class="th4"></th><th  id="dz21" class="th4"></th><th  id="dz22" class="th4"></th><th  id="dz23" class="th4"></th>
			<th  id="dz24" class="th4"></th><th  id="dz25" class="th4"></th><th  id="dz26" class="th4"></th><th  id="dz27" class="th4"></th><th  id="dz28" class="th4"></th><th  id="dz29" class="th4"></th>
			<th  id="dz30" class="th4"></th><th  id="dz31" class="th9"></th><th  id="dz32" class="th4"></th><th  id="dz33" class="th9"></th><th  id="dz34" class="th4"></th><th  id="dz35" class="th8"></th>
			<th  id="dz36" class="th8"></th><th  id="dz37" class="th8"></th><th  id="dz38" class="th8"></th><th  id="dz39" class="th8"></th><th  id="dz40" class="th8"></th><th  id="dz41" class="th8"></th>
			<th  id="dz42" class="th8"></th><th  id="dz43" class="th8"></th>
		</tr>
	</table>
</div>
...
style="cursor:pointer;margin-right:6px"/></div>
