<%@page import="com.insigma.siis.local.pagemodel.sysorg.org.hzb.SGGBTJB"%>
...
$(function(){
	...
	'td:nth-child(41),td:nth-child(42)','#coordTable2 tr:gt(0)').each(function (i, item) {
...
function expExcel(){
	...
	if(dataArray.length>0){
	    ajaxSubmit('expExcel',{"dataArray":Ext.encode(dataArray),"excelname":"全市市管干部情况统计表（130家单位）"});
	}
}
...
<div id="selectable">
	<table id="coordTable" cellspacing="0" width="100%" >
		<tr>
		    <td colspan="44" class="borderTop title borderRight">全市市管干部情况统计表（130家单位）</td>
		</tr>
		<tr>
