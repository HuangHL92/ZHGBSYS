<%@page import="com.insigma.siis.local.pagemodel.sysorg.org.hzb.QXCJGBPB"%>
...
function expExcel(){
	...
	if(dataArray.length>0){
	    ajaxSubmit('expExcel',{"dataArray":Ext.encode(dataArray),"excelname":"区县（市）管干部配备情况统计分析表"});
	}
}
...
<div id="selectable4">
	...
	<table id="coordTable" cellspacing="0" width="100%" >
		<tr>
		    <td colspan="80" class="borderTop title borderRight">区县（市）管干部配备情况统计分析表</td>
		</tr>
		<tr>
