...
function expExcel(){
	...
	if(dataArray.length>0){
	    ajaxSubmit('expExcel',{"dataArray":Ext.encode(dataArray),"excelname":"区县（市）直属单位年轻干部配备情况"});
	}
}
...
<body>
	...
	<table id="coordTable" cellspacing="0" width="100%" >
		<tr>
		    <td colspan="15" class="borderTop title borderRight">区县（市）直属单位年轻干部配备情况</td>
		</tr>
		<tr>
			<th rowspan="2" class="th0">序号</th>
			<th rowspan="2" class="th4">区县（市）</th>
			<th colspan="2" class="th4">直属单位</th>
			<th colspan="2" class="th4">直属单位领导班子成员</th>
			<th colspan="3" class="th4">35岁左右（不满37岁）领导班子成员配备情况</th>
			<th rowspan="2" class="th4">35岁左右（不满37岁）正职人数</th>
			<th rowspan="2" class="th4">30岁左右（不满32岁）副职人数</th>
			<th rowspan="2" class="th4">配备35岁左右（不满37岁）干部的党政部门数</th>
		</tr>
		<tr>
			<th  class="th4">总数</th>
			<th  class="th4">党政工作部门总数</th>
			<th  class="th4">总数</th>
			<th  class="th4">党政工作部门总数</th>
			<th  class="th4">应配数（一般达到15%）</th>
			<th  class="th4">实配数</th>
			<th  class="th4">占比</th>
		</tr>
	</table>
