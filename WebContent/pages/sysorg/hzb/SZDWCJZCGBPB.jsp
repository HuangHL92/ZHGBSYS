<%@page import="com.insigma.siis.local.pagemodel.sysorg.org.hzb.SZDWCJZCGBPB"%>
...
function expExcel(){
	...
	if(dataArray.length>0){
	    ajaxSubmit('expExcel',{"dataArray":Ext.encode(dataArray),"excelname":"市直单位处级（中层）干部配备情况统计分析表（二）"});
	}
}
...
<div id="selectable4">
	...
	<table id="coordTable" cellspacing="0" width="100%" >
		<tr>
		    <td colspan="80" class="borderTop title borderRight">市直单位处级（中层）干部配备情况统计分析表</td>
		</tr>
		<tr>
			<th rowspan="3"  class="th11">市直单位</th>
			<!-- <th rowspan="3" class="th2">单位数</th> -->
			<th rowspan="3" colspan="1" class="th18">处级干部实配数</th>
