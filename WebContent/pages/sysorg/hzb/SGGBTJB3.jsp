<%@page import="com.insigma.siis.local.pagemodel.sysorg.org.hzb.SGGBTJB3"%>
...
function expExcel(){
	...
	if(dataArray.length>0){
	    ajaxSubmit('expExcel',{"dataArray":Ext.encode(dataArray),"excelname":"市直机关部门（不含国企高校）市管干部情况统计表（93家单位）"});
	}
}
...
<div id="selectable">
	<table id="coordTable" cellspacing="0" width="100%" >
		<tr>
		    <td colspan="44" class="borderTop title borderRight">市直机关部门（不含国企高校）市管干部情况统计表（93家单位）</td>
		</tr>
		<tr>
