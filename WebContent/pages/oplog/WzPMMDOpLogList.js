...
Ext.onReady(function() {
	...
	var grid_opLogList = new Ext.grid.GridPanel({
				...
				monitorResize : true,
				doLayout : function() {
					var el = Ext.get('forView_div_1').dom;
					if (Ext.isIE) {
						this.setWidth(0)
					};
				...
				collapsible : false,
				collapsed : false,
				renderTo : gridDiv_div_1
			});
	Ext.getCmp('div_1').on('contextmenu', function(e){odin.grid.menu.gridContextmenu(e,this,'true')});
...
function rollback(opseno,aaa103,rowIndex){
