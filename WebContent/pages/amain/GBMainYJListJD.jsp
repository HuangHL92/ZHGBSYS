	...
	<odin:editgrid2 property="noticeSetgrid" hasRightMenu="false" autoFill="false" 
	 ...
	 bbarId="pageToolBar" pageSize="50" isFirstLoadData="false" url="/">
		...
		<odin:gridColumnModel>
			...
			<odin:gridEditColumn2 dataIndex="a0192a" width="270" header="任现职务" align="center" editor="text" edited="false" />
			<odin:gridEditColumn2 dataIndex="cw" width="120" header="称谓" align="center" editor="text" edited="false" />
			<odin:gridEditColumn2 dataIndex="xm" width="120" header="出国境人员姓名" align="center" editor="text" edited="false" />
			<odin:gridEditColumn2 dataIndex="gj" width="120" header="移居国家（地区）" align="center" editor="text" edited="false" />
			<odin:gridEditColumn2 dataIndex="yjlb" width="120" header="移居类别" align="center" editor="text" edited="false" />
			<odin:gridEditColumn2 dataIndex="yjsj" width="120" header="移居时间" align="center" editor="text" edited="false" />
			<odin:gridEditColumn2 dataIndex="lg" width="120" header="是否裸官" align="center" editor="text" edited="false" />
			<odin:gridEditColumn2 dataIndex="bz" width="120" header="备注" align="center" editor="text" edited="false" isLast="true"/>
		</odin:gridColumnModel>
	</odin:editgrid2>
</div>
