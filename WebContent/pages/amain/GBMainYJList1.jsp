	...
	<odin:editgrid2 property="noticeSetgrid" hasRightMenu="false" autoFill="false" 
	 ...
	 bbarId="pageToolBar" pageSize="50" isFirstLoadData="false" url="/">
		...
		<odin:gridColumnModel>
			...
			<odin:gridEditColumn2 dataIndex="year" width="80" header="年份" align="center" editor="text" edited="false" />
			<odin:gridEditColumn2 dataIndex="a0101" width="100" header="姓名" align="center" editor="text" edited="false" />
			<odin:gridEditColumn2 dataIndex="a0192a" width="320" header="职务" align="left" editor="text" edited="false" />
			<odin:gridEditColumn2 dataIndex="infodesc" width="720" header="有关情况" align="left" editor="text" edited="false"   />
			<odin:gridEditColumn2 dataIndex="cljg" width="100" header="处理结果" align="center" editor="text" edited="false" isLast="true"/>
		</odin:gridColumnModel>
	</odin:editgrid2>
</div>
