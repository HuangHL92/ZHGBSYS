	...
	<odin:editgrid2 property="noticeSetgrid" hasRightMenu="false" autoFill="false" 
	 ...
	 bbarId="pageToolBar" pageSize="50" isFirstLoadData="false" url="/">
		<odin:gridJsonDataModel>
						...
						<odin:gridDataCol name="infodesc" />
		...
		<odin:gridColumnModel>
			...
			<odin:gridEditColumn2 dataIndex="a0101" width="100" header="姓名" align="center" editor="text" edited="false" />
			<odin:gridEditColumn2 dataIndex="a0192a" width="300" header="职务" align="left" editor="text" edited="false" />
			<odin:gridEditColumn2 dataIndex="time" width="120" header="时间" align="center" editor="text" edited="false" />
			<odin:gridEditColumn2 dataIndex="infodesc" width="800" header="有关情况" align="left" editor="text" edited="false" isLast="true"  />
		</odin:gridColumnModel>
	</odin:editgrid2>
</div>
...
Ext.onReady(function() {
	...
	var type=parent.Ext.getCmp(subWinId).initialConfig.query_type;
	if(type=='scfgb'){
		pgrid.colModel.getColumnAt(3).header='影响期<br/>开始时间';
		pgrid.reconfigure(pgrid.store,pgrid.colModel);
	}else if(type=='gbstjk'){
		pgrid.colModel.getColumnAt(3).header='立案时间';
		pgrid.reconfigure(pgrid.store,pgrid.colModel);
	}
