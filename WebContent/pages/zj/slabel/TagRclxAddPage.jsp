...
function save(){
	//文字描述不可超过1000字 
	var tagrclxzs = document.getElementById('tagrclxzs').value;	
	
	if(tagrclxzs.length > 1000) {
...
<odin:toolBar property="toolBar6" applyTo="btnToolBarDiv">
				<odin:fill></odin:fill>
				<odin:buttonForToolBar text="增加" id="TagRclxAddBtn" icon="images/add.gif" cls="x-btn-text-icon"></odin:buttonForToolBar>
...
<div id="wzms">
	<table>
		<tr height="50">
			...
			<td><tags:PublicTextIconEdit property="tagrclx" label="人才类型&nbsp;" width="180" required="true" codetype="TAGRCLX" readonly="true"></tags:PublicTextIconEdit></td>
		</tr>
		<tr>
			<td><odin:textarea property="tagrclxzs" cols="63" rows="4" label="文字描述" validator="tagrclxzsLength" readonly="true"></odin:textarea></td>
		</tr>
	</table>
</div>
<div id="grid">
	<table>
		<tr>
			<td>
				<odin:grid property="TagRclxGrid" sm="row"  forceNoScroll="true" isFirstLoadData="false" url="/" height="200">
					<odin:gridJsonDataModel  id="id" root="data" totalProperty="totalCount">
						<odin:gridDataCol name="tagid" />
				   		<odin:gridDataCol name="tagrclx" isLast="true"/>			   		
					</odin:gridJsonDataModel>
					<odin:gridColumnModel>
					  <odin:gridRowNumColumn />
					  <odin:gridEditColumn header="id" dataIndex="tagid" editor="text" hidden="true"/>
					  <odin:gridEditColumn2  header="人才类型"  dataIndex="tagrclx" width="300" edited="false" editor="select" codeType="TAGRCLX"/>
...
<%-- 			<td>
				<table>
					<tr height="50">
						<tags:PublicTextIconEdit property="tagrclx" label="人才类型" width="180" required="true" codetype="TAGRCLX" readonly="true"></tags:PublicTextIconEdit>
					</tr>
				</table>
			</td> --%>
		</tr>
...
Ext.onReady(function(){
	if(realParent.buttonDisabled){
		$h.setDisabled($h.disabledButtons.tagRclx);
		
		var cover_wrap1 = document.getElementById('cover_wrap1');
		var cover_wrap2 = document.getElementById('cover_wrap2');
		var ext_gridobj = Ext.getCmp('TagRclxGrid');
		var gridobj = document.getElementById('forView_TagRclxGrid');
...
Ext.onReady(function(){
	var side_resize=function(){
		 ...
		 Ext.getCmp('TagRclxGrid').setWidth(500); 
	}
	side_resize();  
