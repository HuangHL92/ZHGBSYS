...
<div id="wzms">
	<table>
		<tr height="50">
			<td><tags:PublicTextIconEdit property="tagcjlx" label="惩戒类型" width="180" required="true" codetype="TAGCJLX" readonly="true"></tags:PublicTextIconEdit></td>
		</tr>
		<tr>
			<td><odin:textarea property="tagcjlxzs" cols="63" rows="4" label="文字描述" validator="tagcjlxzsLength" readonly="true"></odin:textarea></td>
		</tr>
	</table>
</div>
<div id="grid">
