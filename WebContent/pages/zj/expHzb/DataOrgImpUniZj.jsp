...
<odin:toolBar property="btnToolBar" applyTo="toolDiv">
	...
	<odin:fill/>
	<odin:buttonForToolBar text="导出" id="expbtn" icon="images/icon/exp.png"  isLast="true"/>
	<%--
	<odin:buttonForToolBar text="分包导出" id="exppackagebtn"/>
	--%>
	<%-- <odin:separator></odin:separator>
	<odin:buttonForToolBar text="校验" icon="image/u53.png"
		id="dataVerify" tooltip="对选中机构进行数据校验" isLast="true"/> --%>
	<%-- <odin:separator></odin:separator>
		...
		<table id="tableid1" style="width:600px;"  >
				...
				<td colspan="6" width="100%" >
					<table width="100%"> --%>
						...
						<tr >
							...
							<odin:textEdit property="linktel" width="180" colspan="1"  maxlength="20" label="联系电话"/>
						</tr>
						<tr >
			...
			<tr>
				<!-- <td colspan="4">
					<table>
						<tr>
				  			<td><span style="font-size: 12;font-weight: bold;">&nbsp;上报格式&nbsp;</span></td>
				  			<td><input type="radio" name="gs" value="7z" checked="checked"><span style="font-weight: bold;">7z</span></td>
				  			<td width="195px"></td>
							<td><input type="radio" name="gs" value="zip"><span style="font-weight: bold;">zip</span></td>
						</tr>
					</table>
				</td> -->
			</tr>
