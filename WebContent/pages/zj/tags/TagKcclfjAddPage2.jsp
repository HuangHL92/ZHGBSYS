...
<div id="tag_container">
	...
	<iframe src ="<%=request.getContextPath()%>/pages/zj/tags/addTagKcclfj2.jsp" id="wzms" frameborder="0"></iframe>
	<div id="grid">
		<table>
			<tr>
				<td width="100%">
...
function GrantRender(value, params, rs, rowIndex, colIndex, ds){
	return "<a href=\"javascript:downloadKcclfjFile('"+rs.get('tagid')+"','"+rs.get('fileurl')+"')\">下载</a>" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + 
	"<a href=\"javascript:deleteKcclfjFile('"+rs.get('tagid')+"','"+rs.get('fileurl')+"')\">删除</a>" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
}
...
function deleteKcclfjFile(tagid, fileurl){
	...
	$.ajax({
		...
		success:function(){
			...
			updateRmbFresh();
			odin.alert("考察材料附件删除成功!");
		},
		error:function(){
			odin.alert("考察材料附件删除失败!");		
		}
	});
