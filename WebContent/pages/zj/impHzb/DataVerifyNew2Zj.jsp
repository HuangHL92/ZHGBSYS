...
<odin:toolBar property="btnToolBar" >
	<odin:textForToolBar text="<h3>&nbsp;支持7z、zip格式导入</h3>" />
	<odin:fill />
...
function formSubmit2(){
	...
	if(type11 == "MYSQL" && count2>100000){
		...
		Ext.Ajax.request({
				url:'<%=request.getContextPath()%>/ZjUploadFileServlet?method=zzbFileImp&uuid='+uuid+'&filename='+filename+'&b0111new='+b0111new+'&a0165='+a0165+'&fxz='+fxz,
