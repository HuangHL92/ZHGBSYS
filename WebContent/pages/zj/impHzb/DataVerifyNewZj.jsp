...
<iframe width="825" height="85px" src="<%=request.getContextPath() %>/pages/dataverify/DataVerify2.jsp" frameborder="o" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes"></iframe>
