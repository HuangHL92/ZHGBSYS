...
<div id="conditionArea" style="height: 300; overflow-y: scroll;">
	<table style="width: 50%;margin-top: 10px;">
		<tr>
			<odin:select2 property="gwmc" label="重点岗位" data=""></odin:select2>
		</tr>
	</table>
...
Ext.onReady(function(){
	...
	//直接查询岗位名册
	Ext.getCmp('gwmc_combo').on('select',function(obj){
		radow.doEvent('setgwmc');
	});
...
function clearConbtn(condi){
	...
	if(queryType=="2"||queryType=="3"||queryType=="4"){
		condi = "clear";
	}
