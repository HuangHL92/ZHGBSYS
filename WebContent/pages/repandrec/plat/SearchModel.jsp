...
<odin:hidden property="searchDeptid"/>
	...
	<odin:gridColumnModel>
		...
		<odin:gridEditColumn header="分库类型" dataIndex="sub_libraries_model_type" align="center" isLast="true" selectData="['1','逻辑分库'],['2','物理分库']" edited="false" editor="select" width="80" />
	</odin:gridColumnModel>
</odin:editgrid>
		</div>
