...
function MKGrantRender(value, params, rs, rowIndex, colIndex, ds){
	return "<a href=\"javascript:openMKGrantWin('"+rs.get('userid')+"','"+rs.get('owner')+"')\">模块角色控制</a>";
}
		...
		<table width="100%" height="100%" border="1">
			<tr height="100%">
				...
				<td>
					...
					<odin:editgrid property="memberGrid" hasRightMenu="false" title="用户列表" autoFill="true" width="590"  bbarId="pageToolBar" pageSize="20" isFirstLoadData="false" url="/">
						...
						<odin:gridColumnModel>
							...
							<odin:gridColumn dataIndex="isleader" header="管理员" width="70" renderer="radow.commUserfulForGrid"  align="center"/>
							...
							<odin:gridColumn dataIndex="op4" header="授权" width="110" renderer="XXXGrantRender" align="center" isLast="true"/>
						</odin:gridColumnModel>
					</odin:editgrid>
				</td>
			</tr>
...
<odin:window src="/blank.htm" id="createUserWin" width="900" height="500" title="创建成员用户窗口" modal="true" maximizable="false"></odin:window>
...
<odin:window src="/blank.htm" id="UserDetailWin" width="720" height="550" title="用户详情" modal="true"></odin:window>
<script type="text/javascript">
var win_addwin;
var win_addwinnew;
Ext.onReady(function() {
