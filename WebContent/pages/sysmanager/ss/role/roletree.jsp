	...
	//	alert(document.all.area.value);
      ...
      tree = new Tree.TreePanel( {
            ...
            loader : new Tree.TreeLoader( {
                  ...
                  dataUrl : 'radowAction.do?method=doEvent&pageModel=pages.sysmanager.ss.role.roletree&eventNames=orgTreeJsonData&roleid='+roleid
            })
      });
...
<odin:tabModel  >
	<odin:tabItem title="资源授权" id="tab1"></odin:tabItem>
