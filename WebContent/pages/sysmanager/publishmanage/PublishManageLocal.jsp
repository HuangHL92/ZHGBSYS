	...
	<tr>
		...
		<td>
			<odin:groupBox title="选择组织">
				<table>
					<tr>
						<odin:textIconEdit property="searchDeptBtn" required="true" size="90" readonly="true" colspan="4" label="组织机构"/>
...
Ext.onReady(function() {
	//页面调整
//	 Ext.getCmp('fileGrid').setHeight(Ext.getBody().getViewSize().height*0.65);
	 //Ext.getCmp('fileGrid').setHeight(Ext.getBody().getViewSize().height); 
	 Ext.getCmp('fileGrid').setWidth((Ext.isIE?Ext.getBody().getViewSize().width:window.innerWidth)-objTop(document.getElementById('forView_fileGrid'))[1]-2); 
	 document.getElementById('bar_div').style.width = document.body.clientWidth-2;
//	 Ext.getCmp('bar_div').setWidth(document.body.clientWidth);
	 document.getElementById("main").style.width = document.body.clientWidth-4;
	 Ext.getCmp('fileGrid').setHeight(document.body.clientHeight-document.getElementById("location").offsetTop-40);
});
