...
<%@page import="com.insigma.siis.local.pagemodel.sysmanager.groupmanage.GroupManagePageModel"%>
      ...
      if(man == 'true'){
	       var tree = new Tree.TreePanel( {
            ...
            loader : new Tree.TreeLoader( {
                  dataUrl : 'radowAction.do?method=doEvent&pageModel=pages.sysmanager.groupmanage.GroupManage&eventNames=orgTreeJsonData'
            })
        });
      }else{
        var tree = new Tree.TreePanel( {
			...
			<odin:simplePanel title="用户组信息" width="600px" bodyWidth="400px">
				<table  height="300px" width="550px" >
					...
					<tr>
						...
						<odin:textEdit property="rate" label="级别" maxlength="8"></odin:textEdit>
					</tr>
					<tr>
