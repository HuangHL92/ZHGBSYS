...
<table width="100%">
	<tr>
		...
		<odin:editgrid property="memberGrid" title="组织用户管理" autoFill="false" width="590" height="320" bbarId="pageToolBar" pageSize="20" isFirstLoadData="false" url="/">
...
<odin:toolBar property="btnToolBar">
	...
	<odin:fill />
	/*<odin:buttonForToolBar text="设为统筹区" id="setArea" />
	<odin:separator></odin:separator>
	<odin:buttonForToolBar text="取消统筹区" id="cancelArea" />
	<odin:separator></odin:separator>*/
	<odin:buttonForToolBar text="增加成员" id="addMemberBtn" tooltip="增加已存在的还不是该组织成员的用户"/>
	<odin:separator></odin:separator>
	<odin:buttonForToolBar text="创建成员" id="createUserBtn" tooltip="创建新的用户并直接加入该组织"/>
	<odin:separator></odin:separator>
	...
	<odin:separator></odin:separator>
	<odin:buttonForToolBar text="移除成员" id="removeUserBtn" isLast="true" tooltip="将选中成员从组织中移除,如果成员没有加入其他组织,则应该先把该成员加入到其他组织后才能移除"/>
</odin:toolBar>
