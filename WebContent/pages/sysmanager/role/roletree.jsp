	...
	//	alert(document.all.area.value);
      ...
      tree = new Tree.TreePanel( {
            ...
            loader : new Tree.TreeLoader( {
                  ...
                  dataUrl : 'radowAction.do?method=doEvent&pageModel=pages.sysmanager.role.roletree&eventNames=orgTreeJsonData&roleid='+roleid
            })
      });
...
<odin:toolBar property="btnToolBar">
	<odin:textForToolBar text="<h3>授权窗口</h3>" />
	<odin:fill />
...
<odin:tabModel  >
	<odin:tabItem title="资源授权" id="tab1" isLast="true"></odin:tabItem>
	<%-- <odin:tabItem title="系统级权限" id="tab2" isLast="true"> 
</odin:tabItem>--%>
</odin:tabModel > 
<odin:tabCont itemIndex="tab1"  >
 ...
 <odin:tabCont itemIndex="tab2">
	<odin:gridSelectColJs name="type" codeType="NTYPE"></odin:gridSelectColJs>
			<odin:editgrid property="resourcegrid" isFirstLoadData="false" 
				url="/" title="授权资源列表" width="280" height="360" >
				<odin:gridJsonDataModel id="gridid" root="data">
					<odin:gridDataCol name="logchecked" />
					<odin:gridDataCol name="functionid" />
					<odin:gridDataCol name="title" isLast="true" />
				...
				<odin:gridColumnModel>
					...
					<odin:gridEditColumn header="系统级权限名称" align="center" width="180"
						dataIndex="title" editor="text" edited="false" isLast="true" />
				</odin:gridColumnModel>
			</odin:editgrid>
</odin:tabCont>
</odin:tab>
