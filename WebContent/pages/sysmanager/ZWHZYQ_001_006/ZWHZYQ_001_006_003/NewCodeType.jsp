	...
	Ext.onReady(function(){
		...
		var tree = new Ext.tree.TreePanel({
			...
			loader : new Ext.tree.TreeLoader({
				dataUrl : 'radowAction.do?method=doEvent&pageModel=pages.sysmanager.ZWHZYQ_001_006.ZWHZYQ_001_006_003.NewCodeType&eventNames=getTreeJsonData'
			}),	
			listeners : {
		...
		var src = 'radowAction.do?method=doEvent&pageModel=pages.sysmanager.ZWHZYQ_001_006.ZWHZYQ_001_006_003.NewCodeValue';
...
<odin:window src="" modal="true" id="NewCodeType" width="380" height="260" title="新建代码集" closable="true" maximizable="false"></odin:window>
<odin:window src="" modal="true" id="UpdateCodeType" width="380" height="260" title="修改代码集" closable="true" maximizable="false"></odin:window>
