...
<table align="center" width="96%">
	<tr>
		<odin:select property="excelType" label="表册类型"  editor="false" tpl="<%=ItemValue.tpl_Value%>" data='<%=(request.getParameter("tmpType")==null?"":java.net.URLDecoder.decode(request.getParameter("tmpType"),"utf-8"))%>'  required="true"></odin:select>
	</tr>
	...
	--><%if(request.getParameter("checkList").equals("4")){%>
	<tr>
        <odin:select property="viewType2" label="照片自定义" editor="false" value="21" data="['21', '无机构名称展示'],['22', '按机构名称展示'],['23', '按职务层次展示']" ></odin:select>
	</tr>
	<%} %>
...
///		document.simpleExcelForm.fileName.value = a0101+'_'+filename+'.xls';
