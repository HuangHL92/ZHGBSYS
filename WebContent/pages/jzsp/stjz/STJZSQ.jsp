...
<table style="width: 250px;">
	<tr>
		<odin:select2 property="sp0114" canOutSelectList="false"  label="审批状态" onchange="infoSearch" value="all" data="['all','全部'],['0','未送审'],['1','审批中'],['2','审批通过'],['3','审批未通过']" />
	</tr>
</table>
...
<odin:toolBar property="btnToolBar" applyTo="groupTreePanel">
	...
	<odin:buttonForToolBar text="申请" icon="image/icon021a2.gif" handler="loadadd" id="loadadd" />
	<odin:separator></odin:separator>
	<odin:buttonForToolBar text="修改" icon="image/icon021a6.gif" handler="infoUpdate"  id="infoUpdate"/>
	<odin:separator></odin:separator>
	<odin:buttonForToolBar text="删除" icon="image/icon021a3.gif" handler="infoDelete" id="infoDelete" isLast="true"/>
</odin:toolBar>
