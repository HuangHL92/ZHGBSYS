...
function expFile(value, params, record, rowIndex, colIndex, ds) {
	if(record.data.spp08=='0'){
		return "";
	}else if(record.data.spp08=='1'&&record.data.spb06=='2'){//审批中   处室节点
...
function infoUpdate1(spp00){
	...
	$h.openPageModeWin('FJHZ1','pages.jzsp.fjsp.FJHZ1&spp00='+spp00,'领导干部社团兼任审批汇总表',1150,800,{spp00:spp00},g_contextpath);
}
