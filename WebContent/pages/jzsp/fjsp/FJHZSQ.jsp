...
function expFile(value, params, record, rowIndex, colIndex, ds) {
	if(record.data.spp08=='0'&&record.data.spb06=='1'){//环节
...
<table style="width: 600px;">
	<tr>
		<td>
			<odin:hidden property="spp08" value="all"/>
			<input type="radio"  name="spp081" id="spp081" value="all" checked="checked" onclick="infoSearch(this.value)"/><label for="spp081">全部</label>
			<input type="radio"  name="spp081" id="spp082" value="99" onclick="infoSearch(this.value)"/><label for="spp082">待送审</label>
...
<odin:toolBar property="btnToolBar" applyTo="groupTreePanel">
	...
	<odin:buttonForToolBar text="申请" icon="image/icon021a2.gif" handler="loadadd" id="loadadd" isLast="true"/>
</odin:toolBar>
...
Ext.onReady(function() {
	...
	memberGrid.setHeight(viewSize.height-70);
...
function infoUpdate1(spp00){
	...
	$h.openPageModeWin('JGLDAdd','pages.jzsp.fjsp.AddFJ','领导兼职审批附件上传',780,400,{spp00:spp00},g_contextpath);
}
...
function loadadd(){
	$h.openPageModeWin('JGLDAdd','pages.jzsp.fjsp.AddFJ','领导兼职审批附件上传',790,260,{},g_contextpath);
}
</script>
