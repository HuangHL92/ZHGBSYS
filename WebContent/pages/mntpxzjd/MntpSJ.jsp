...
<odin:editgrid2 property="memberGrid" load="selectRow" hasRightMenu="false" autoFill="true"  bbarId="pageToolBar"  url="/">
	...
	<odin:gridColumnModel>
		...
		<odin:gridEditColumn2 dataIndex="mntp05" width="60" header="模拟调配模式" editorId="asd" editor="select" selectData="['2','区县市'],['1','市直单位'],['4','国企高校']" hidden="true" edited="true" align="center"/>
...
function viewGW(value, params, record, rowIndex, colIndex, ds) {
	...
	ret += "<a style='cursor:pointer;padding-left:15px;' onclick=\"openBDFAPage('"+value+"');\">单位设置</a>"
...
function openViewFABD(fabd00){//方案比对
	$h.openWin('ViewFABDWinsj','pages.mntpsj.MNTPSJOP','模拟调配个别调配方案',1810,950,'','<%=request.getContextPath()%>',null,
