...
<odin:toolBar property="ToolBar">
			...
			<odin:grid property="TrainingInfoGrid" height="500" title="" autoFill="true" topBarId="ToolBar" bbarId="pageToolBar" sm="row" isFirstLoadData="false" pageSize="20"  url="/" rowDbClick="rowDbClick">
...
<%-- 			   		<odin:gridDataCol name="type" isLast="true"/>			   		 --%>
				    ...
				    <odin:gridRowNumColumn></odin:gridRowNumColumn>
				  	...
				  	<odin:gridEditColumn2 header="创建时间" align="center" dataIndex="creattime" editor="text" edited="false"  width="100" /> 
 				  	...
 				  	<odin:gridEditColumn2 header="是否通用标识" align="center" dataIndex="selty" editor="text" edited="false" width="100" hidden="true"/> 
...
function rowDbClick(grid,rowIndex,event){/* 获取文件名称,回传至父页面 */
	...
	var filename = record.data.id;
	var selfile = selty+","+filename;
	//window.opener.document.getElementById("filename").value = record.data.id; 
	window.opener.document.getElementById("filename").value = selfile; 
	window.close();
}
