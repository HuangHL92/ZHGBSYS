...
<form name="excelForm" method="post"  action="<%=request.getContextPath()%>/servlet/UploadHandleServlet" enctype="multipart/form-data" target="impFrame">	
<table align="center" width="96%">
	<tr>
		<td height="20"></td>
	</tr>
	<tr>
		<td><div class="x-form-item">文件选择（.xml/.json）<input type="file" id="normalFile" name="normalFile" size="47" accept=".xml,.json"/></div></td>
	</tr>
	<tr>
		<td height="15"></td>
	</tr>
...
function doCloseWin(type){
	...
	parent.odin.ext.getCmp('impFileWin').hide();
