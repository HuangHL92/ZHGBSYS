...
<div id="fancha_div" style="width:100%;height:100%;margin: 0 auto;">
	<odin:editgrid property="gridfc" title="" height="505"
		...
		<odin:gridJsonDataModel>
			...
			<odin:gridDataCol name="a0195" isLast="true" />
		</odin:gridJsonDataModel>
		<odin:gridColumnModel>
			...
			<odin:gridEditColumn header="身份证号"  editor="text" dataIndex="a0184" edited="false" width="120"/>
			<odin:gridEditColumn2 header="现职务层次"  editor="select" dataIndex="a0221" codeType="ZB09" edited="false" width="50"/>
			<odin:gridEditColumn header="任职机构及职务全称" editor="text" dataIndex="a0192a" edited="false" width="125"/>
			<odin:gridEditColumn header="统计关系所在单位" editor="text" dataIndex="a0195" edited="false" isLast="true" width="125"/>
		</odin:gridColumnModel>
		<odin:gridJsonData>
			{
		        data:[]
