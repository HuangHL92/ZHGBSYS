...
function startImport(){
	...
	var path = '<%=request.getContextPath()%>/HZBImportAction.do?method=importByUnid&unid='+unid;
...
<div style="width: 360px;height: 150px">
	<table style="width: 100%;">
		<tr>
			<td>
				<font style="font-size: 13px;">&nbsp;选择上传要导入的文件</font>
			</td>
		</tr>
		<tr></tr>
		<tr></tr>
		<tr>
			<td>
				<font style="font-size: 13px;">&nbsp;1: 导入的Excel文件的格式必须与填写<a href="javascript:void(0)" title="点击链接下载模板" onclick="window.open('<%=request.getContextPath()%>/Data_(干部)模板.xls');return false;">模板</a>一致,否则不能导入!</font>
			</td>
		</tr>
	</table>	
	<br>
	<form id="data" name="data" method="post" enctype="multipart/form-data">
		<div>
			<font style="font-size: 13px;">&nbsp;&nbsp;选择要导入的文件：</font>
