...
<table>
	<tr>
		<odin:select2 colspan="2" property="gbquery" onchange="query()" label="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;干部名册分类：" data="['0', '干部总名册'],['1', '重点岗位'],['8', '两头干部名册'],['3', '年轻干部'],['4', '专业干部'],['5', '干部梯队'],['6', '结构性干部'],['7', '年龄段干部'],['2', '职级晋升、到龄等相关名册']" title="干部名册分类" value="0"></odin:select2>
	</tr>
</table>
		...
		<td style="width:80%">
			...
			<odin:editgrid2 property="grid"   height="420" 
				...
				<odin:gridJsonDataModel id="id" root="data" totalProperty="totalCount">
					...
					<odin:gridDataCol name="screenshow" />
					<odin:gridDataCol name="sortid" isLast="true"/>
				</odin:gridJsonDataModel>
				<odin:gridColumnModel>
					<odin:gridRowNumColumn></odin:gridRowNumColumn>
					<odin:gridEditColumn sortable="false"  header="排序" hidden="true" edited="false"  dataIndex="sortid" align="center" editor="text"  width="8" />
					<odin:gridEditColumn sortable="false"  header="干部名册名称" width="300"  edited="false"  dataIndex="name" align="center" editor="text"  />
					<odin:gridEditColumn2 sortable="false" header="是否大屏显示" width="100" editor="checkbox" dataIndex="screenshow" align="center" edited="true" checkBoxClick="checkBoxClick"/>
...
function checkBoxClick(rowIndex,colIndex,dataIndex,gridName){
	var pgrid = Ext.getCmp('grid');
	var store = pgrid.getStore();
	var rc = store.getAt(rowIndex);
	var uuid = rc.data.uuid;
	var screenshow = rc.data.screenshow;
	radow.doEvent("checkBoxClick",uuid+"@@"+screenshow);
}
</script>
