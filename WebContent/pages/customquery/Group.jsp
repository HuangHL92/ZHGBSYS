		...
		<div id="jbDiv">
			<table style="width: 100%;height: 530">
				...
				<tr>
					...
					<odin:select2 property="a0165C" label="处级（中层）干部" data="['12', '市直正处'],['50', '市直副处'],['07', '区管正职'],['08', '区管副职'],['09', '县市管正职'],['13', '县市管副职'],['14','市属国企中层正职'],['15','市属国企中层副职'],['51','市属副局级企业副职'],['60','市属副局级企业中层副职'],['52','其他']" multiSelect="true"></odin:select2>
				</tr>
				<tr>
...
<!-- 					<td  align="center"><label style="FONT-SIZE: 12px">是否为现任</label><input name="sfwxr" id="a" type="checkbox" value="1" /></td>
 -->				<odin:select2 property="gbgzmd" label="干部工作名单"  ></odin:select2>
				</tr>
