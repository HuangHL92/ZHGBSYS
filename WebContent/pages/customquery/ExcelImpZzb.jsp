...
<iframe width="380px" height="160px" src="<%=request.getContextPath() %>/pages/customquery/importZzb.jsp" frameborder=”no” border=”0″ marginwidth=”0″ marginheight=”0″ scrolling=”no” allowtransparency=”yes”></iframe>
