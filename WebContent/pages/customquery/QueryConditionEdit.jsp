	...
	<tr>
		...
		<td >
			...
			<table>
				...
				<tr>
					<odin:textEdit property="conditionName" label="查询方案名称" width="500" ></odin:textEdit>
				</tr>	
			</table>
		</td>
	</tr>
...
function cellEdit(e){
	...
	function resizeframe(){
		...
		ta.style.width = viewSize.width-384;
		tx.style.width = viewSize.width-384;
		
		treediv.style.height = viewSize.height-150;
		
		var grid =Ext.getCmp('grid');
		grid.setHeight(viewSize.height-250);
		grid.setWidth(viewSize.width-300);
