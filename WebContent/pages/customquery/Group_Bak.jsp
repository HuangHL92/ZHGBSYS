       ...
       <odin:tabItem title="熟悉领域" id="tab5"  isLast="true"></odin:tabItem>
		...
		<div id="jbDiv">
			<table style="width: 100%">
				...
				<tr>
				<odin:select2 property="a0165" label="管理类别" codeType="ZB130" multiSelect="true"></odin:select2>
				...
				<tr>
					...
					<br/><input name="intersection1" id="intersection1" type="checkbox" value="0" οnclick="this.value=(this.value==0)?1:0"/>（选中交集,未选中并集,用;隔开）
					</odin:textEdit>
				</tr>
				<tr>
					<odin:textEdit property="byyxzya08" label="毕业院校和专业" maxlength="36">
					<br/><input name="intersection3" id="intersection3" type="checkbox" value="0" οnclick="this.value=(this.value==0)?1:0"/>（选中交集,未选中并集,用;隔开）
					</odin:textEdit>
				</tr>
			</table>
		</div>
	</odin:groupBoxNew>
	    <odin:groupBoxNew title="匹配适配" contentEl="ppDiv" property="ppBox" collapsible="false">
	       <div id="ppDiv" >
	          <table style="width: 100%">
				<tr>
					<odin:textEdit property="ppName" label="适配人员" maxlength="100" readonly="true" ondblclick="chosePerson()" ></odin:textEdit>
					<td>
					<odin:button text="清除适配人员" property="clearConPP" handler="clearConPP"></odin:button>
					<odin:hidden property="ppA0000"/>
					<odin:hidden property="zb09Word"/>
					</td>
					
					<odin:numberEdit property="ppNum" label="匹配人数" maxlength="100" value="20" ></odin:numberEdit>
				</tr>
				</table>
	       </div>
	    </odin:groupBoxNew>
			...
			<table style="width: 100%">
				...
				<tr>
					...
					<td noWrap="nowrap" style="FONT-SIZE: 12px">
						<input name="intersection2" id="intersection2" type="checkbox" value="0" οnclick="this.value=(this.value==0)?1:0"/>（选中交集,未选中并集,用;隔开）
					</td>
				...
				<tr>
					<%-- <tags:PublicTextIconEdit isLoadData="false"  property="a0221A" label="现职务层次"  codetype="ZB09"   readonly="true"  /> --%>
