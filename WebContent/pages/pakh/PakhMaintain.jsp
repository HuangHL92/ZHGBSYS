<%@page import="com.insigma.siis.local.pagemodel.pakh.PakhMaintainPageModel"%>
...
<odin:editgrid2 property="memberGrid"  topBarId="btnToolBar" hasRightMenu="false" autoFill="true" forceNoScroll="true" bbarId="pageToolBar"  url="/">
	<odin:gridJsonDataModel>
		<odin:gridDataCol name="egl00" />
		<odin:gridDataCol name="egl01"/>
		<odin:gridDataCol name="ets00"/>
		<odin:gridDataCol name="egl04" isLast="true"/>
	</odin:gridJsonDataModel>
	<odin:gridColumnModel>
		<odin:gridRowNumColumn2></odin:gridRowNumColumn2>
		<odin:gridEditColumn2 dataIndex="egl04" width="140" header="描述" editor="text" edited="false" align="left"/>
		<odin:gridEditColumn2 dataIndex="egl01" width="140" header="日期" editor="text" edited="false" align="left"/>
		<odin:gridEditColumn2 dataIndex="ets00" width="140" header="指标方案" editor="select" selectData="<%=PakhMaintainPageModel.getEts00SelData() %>" edited="false" align="center"/>
		<odin:gridEditColumn2 dataIndex="egl00" width="60" header="操作" editor="text" edited="false" renderer="delegl" isLast="true" hidden="true" align="center"/>
	</odin:gridColumnModel>
</odin:editgrid2>
...
function QXSPJGLInfo(egl00){
	...
	$h.showWindowWithSrc('QXSPJGL',contextPath + "/pages/pakh/PakhShow.jsp?egl00="+egl00,'综合评价',1800,1200,null,{maximizable:true,resizable:true},true);
}
...
function delegl(value, params, record,rowIndex,colIndex,ds){
	var egl00 = record.data.egl00;
	
	return "<a href=\"javascript:deleteRow2(&quot;"+egl00+"&quot;)\">删除</a>";
}
