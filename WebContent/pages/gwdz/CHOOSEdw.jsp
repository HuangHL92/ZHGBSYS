...
function updateTree(mntp00) {
	...
	tree2 = new Ext.tree.TreePanel({    
		  ...
		  loader : new Tree.TreeLoader( {
               dataUrl : 'radowAction.do?method=doEvent&pageModel=pages.gwdz.CHOOSEdw&eventNames=definedList&famx01='+famx01+'&famx00='+famx00+'&mntp00='+mntp00
		  }) ,
	       listeners: {        
	    	   scope:this,
...
<table width="100%" >
		<tr>
			<odin:select2 property="mntplist" onchange="mntpQuery()" label="选择调配方案" ></odin:select2>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</td>			
			<td>
				<div class="btns"> 
...
Ext.onReady(function() {
	...
	document.getElementById('mntp00').value = parentParam.mntp00;
});
var jsontree={};

function mntpQuery(){
	var a=document.getElementById('mntplist').value;
	document.getElementById('tree-div1').innerHTML = "";
	radow.doEvent('clean')
	updateTree(a);
}
