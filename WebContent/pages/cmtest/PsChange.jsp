...
<ss:query property="psidnew" p="R"></ss:query>
</ss:module>
<ss:module param="P1,P2">
<ss:query property="psquery" p="R"></ss:query>
</ss:module>
<ss:textEdit property="aac003" label="姓名" p="P0/P3:R,P1/P2:D"  />
...
<ss:select property="aac005"  label="性别"  codeType="AAC005"  p="P0/P3:R,P1/P2:D" />
...
<ss:dateEdit property="aac007" label="参加工作时间" p="P0/P3:R,P1/P2:D" />
...
<ss:select property="aaz289_1"  label="养老类别"  codeType="AAZ289_1"  p="P0/P1/P2:R,P3:D" onchange="true"/>
...
<ss:select property="aae008"  label="委托机构"  codeType="AAE008"  p="R" onchange="true"/>
...
<odin:editgrid property="div_2"  pageSize="200" afteredit="radow.cm.afteredit"  isFirstLoadData="false" url="/" title=""  height="200">
...
<odin:gridColumnModel>
  <odin:gridRowNumColumn />
    <odin:gridColumn header="" width="50" dataIndex="checked" editor="checkbox" edited="true" checkBoxClick="radow.cm.doGridCheck"/>
  <ss:gridEditColumn header="险种" width="80" dataIndex="aae140" editor="select" p="D"/>
