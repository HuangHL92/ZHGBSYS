...
<ss:editgrid property="div_2" pageSize="150" topBarId="bar2"   afteredit="radow.cm.afteredit"  isFirstLoadData="false" url="/" title="条件信息"  height="300" autoFill="false">
		<ss:gridColModel>
			...
			<ss:gridCol header="条件" name="condition" width="130" editor="text" p="E" maxLength="100"></ss:gridCol>
					...
					for (i = 0; i < gridDivs.length; i++) {
						...
						for(lab in gridLabel){
							...
							if(lab=='check'){
								...
								selectData[j].value=gridLabel[lab];
							}
							j++;
						}
					}
