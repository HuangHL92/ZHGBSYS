...
<ss:editgrid property="div_2" pageSize="150" topBarId="bar2" title="审核级信息" afteredit="radow.cm.afteredit"  isFirstLoadData="false" url="/" height="450" autoFill="false">
		<ss:gridColModel>
...
<odin:window src="/" modal="true" id="grantWindow" width="320" height="450"></odin:window>