							...
							<div id="selectByPersonIdDiv" >
								<odin:editgrid property="gridcq" title="待选列表"  width="300" height="350" pageSize="9999"
									...
									<odin:gridColumnModel>
										...
										<odin:gridColumn dataIndex="a0107" header="出生年月" width="75" align="center" edited="false"/>
										<odin:gridColumn dataIndex="a0192a" edited="false" header="单位职务" width="100"  align="center" />
										<odin:gridEditColumn2 dataIndex="a0163" header="人员状态" width="65" hidden="true" align="center" editor="select" edited="false" isLast="true" codeType="ZB126" />
									</odin:gridColumnModel>
									<odin:gridJsonData>
										{
									        data:[]
								...
								<odin:editgrid property="selectName" title="输出列表" width="300" height="350" autoFill="false" >
									<odin:gridJsonDataModel>
										...
										<odin:gridColumnModel>
											...
											<odin:gridColumn dataIndex="a0107" header="出生年月" width="75" align="center" edited="false"/>
											<odin:gridColumn dataIndex="a0192a" edited="false" header="单位职务" width="100" align="center" />
										<odin:gridEditColumn2 dataIndex="a0163" header="人员状态" width="65" align="center" editor="select"  hidden="true" edited="false" isLast="true" codeType="ZB126" />
										</odin:gridColumnModel>
										<odin:gridJsonData>
											{
										        data:[]
...
Ext.onReady(function() {
	...
	document.getElementById("xrdx00").value=parent.document.getElementById('xrdx00').value;
