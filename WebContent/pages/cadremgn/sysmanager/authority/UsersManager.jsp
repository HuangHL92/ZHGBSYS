...
<table style="width: 98%">
	<tr>
		...
		<div id="qxtable" style="width: 100%;height: 340px;">
			<table>
				<tr>
					<!-- <td><input class="bluebutton bigbutton-customquery qxbutton"  type="button" value="继承组管理员权限" onclick="inherit2()"></td> -->
					<td>&nbsp;&nbsp;<input class="bluebutton bigbutton-customquery qxbutton" type="button" value="机构（编辑）范围管理" onclick="personRange2()"></td>
					<!-- <td><input class="bluebutton bigbutton-customquery qxbutton" type="button" value="机构（浏览）范围管理" onclick="personRangeLL()"></td> -->
					<td>&nbsp;&nbsp;<input class="bluebutton bigbutton-customquery qxbutton" type="button" value="菜单功能权限" onclick="personFunc2()"></td>
				</tr>
				<tr>	
					<td><input class="bluebutton bigbutton-customquery qxbutton" type="button" value="用户类型" onclick="checkUserType()"></td>
				</tr>
				<!-- <tr>	
					<td><input class="bluebutton bigbutton-customquery qxbutton" type="button" value="表格名册权限" onclick="personFuncBook2()"></td>
				</tr>
				<tr>
					<td><input class="bluebutton bigbutton-customquery qxbutton" type="button" value="录入界面及应用权限" onclick="personFuncWin2()"></td>
					<td><input class="bluebutton bigbutton-customquery qxbutton" type="button" value="查询统计权限" onclick="personFuncQuery2()"></td>
				</tr> -->
				<!-- <tr>	
				<td>&nbsp;&nbsp;<input class="bluebutton bigbutton-customquery qxbutton" type="button" value="菜单功能权限" onclick="personFunc2()"></td>
				<td>&nbsp;&nbsp;<input class="bluebutton bigbutton-customquery qxbutton" type="button" value="信息集权限" onclick="table2()"></td>
				<td><input class="bluebutton bigbutton-customquery qxbutton" type="button" value="信息项权限" onclick="tableCol2()"></td>
					<td><input class="bluebutton bigbutton-customquery qxbutton" type="button" value="所有家庭成员查看权限" onclick="personFuncWin2()"></td>
				</tr>
				<tr>
				<td>&nbsp;&nbsp;<input class="bluebutton bigbutton-customquery qxbutton" type="button" value="克隆" onclick="personRange3()"></td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;<input class="bluebutton bigbutton-customquery qxbutton" type="button" value="所有家庭成员查看权限" onclick="personFuncWin2()"></td>
					<td></td>
...
function changeUserType(userid){
	$h.openWin('usertype','pages.cadremgn.sysmanager.authority.AlterUserTypeWindow','定义或修改用户类型',300,300,userid,'<%=request.getContextPath()%>');
}
...
function personRangekl(user){
	$h.openPageModeWin('newRangekl','pages.cadremgn.sysmanager.authority.NewRangekl','机构(克隆)管理',430,535, user,'<%=request.getContextPath()%>',null,{maximizable:false,resizable:false},true);
}
