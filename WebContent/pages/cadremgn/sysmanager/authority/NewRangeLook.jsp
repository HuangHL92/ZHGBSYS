				...
				var tree = new Ext.tree.TreePanel(
						{
							...
							loader : new Tree.TreeLoader(
									{
										dataUrl : 'radowAction.do?method=doEvent&pageModel=pages.sysorg.org.PublicWindow&eventNames=orgTreeJsonNewArrayLook',
										baseParams : {
											userid : user
										}
									}),
...
<script type="text/javascript">
	...
	function saveSystem() {
		...
		radow.doEvent('saveTree', document.getElementById("b0111s").value);
	}
