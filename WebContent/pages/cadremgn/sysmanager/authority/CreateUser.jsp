...
<legend>用户基本信息</legend>
	<table  id="myform" >
        ...
        <%-- <tr>
            <odin:select2 property="kg"  label="密码有效期开关" required="true"  data="['ON','开'],['OFF','关']" editor="false" onchange="ff(this.value)"></odin:select2>	
			<odin:select property="validity" codeType="VALIDITY" label="密码有效期" ></odin:select>			
		</tr> --%>
		<tr>
