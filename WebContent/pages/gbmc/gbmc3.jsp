...
<script type="text/javascript">
	...
	function addNewTable(index,o){
		...
		$.each(o,function (i, rowData){
            ...
            SetTDtext(tds[10],"a0144", rowData["a0144"]);  //   入党时间
            SetTDtext(tds[9],"a0107", rowData["a0107"]);  //   出生日期
	        SetTDtext(tds[11],"a0134", rowData["a0134"]);  //   参加工作时间
...
<table id="coordTable1" class="coordTable A3" style="WIDTH: 1380px" cellspacing="0" sizcache="26" sizset="0">
 ...
 <tr id="insertadd">
  ...
  <th class="lign aligh_sensc" style="FONT-SIZE: 11pt; WIDTH: 73px; PADDING-BOTTOM: 9px !important; PADDING-TOP: 9px !important; PADDING-LEFT: 9px !important; PADDING-RIGHT: 9px !important" rowspan="2">姓&nbsp;名 </th>
  <th class="lign" style="FONT-SIZE: 11pt; HEIGHT: 50px !important; WIDTH: 175px;text-align:center" rowspan="2">现任职务 </th>
  ...
  <th class="lign" style="FONT-SIZE: 11pt; HEIGHT: 50px !important; WIDTH: 90px;"  rowspan="2">参与工<br>作时间 </th>
  ...
  <th class="lign aligh_sensc" style="FONT-SIZE: 11pt; WIDTH: 92px;" rowspan="2">备&nbsp;注 </th>
 </tr>
 <tr>
