		...
		<table style="width: 100%; height: 100%;margin-top:10px;">
			...
			<tr>
				<td colspan="2">
					<div class="imgDiv">
					点击下载模板:
					<a href="javascript:downLoadExcel()">&nbsp①人员数据模板</a><img src="<%=ctxPath%>/image/icon_excel_sm2.png" class="download_icon" onclick="downLoadExcel();return false;">
					</div>
				</td>
			</tr>
			<tr>
