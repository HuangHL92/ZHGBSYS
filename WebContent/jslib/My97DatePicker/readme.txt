注意:此版本为 4.5 正式版 build 20090623
//=======================================//
<script  type="text/javascript" src="<%=root%>/js/My97DatePicker/WdatePicker.js" defer="defer"></script> 

<input name="bothday" id="bothday" onclick="setday(4,bothday)"/>
//======================================//
