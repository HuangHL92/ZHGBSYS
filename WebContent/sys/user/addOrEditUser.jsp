...
<table align="center" width="96%">
	...
	<tr>
		<odin:textEdit property="passwd" inputType="password" alt="用户密码" label="用户密码"></odin:textEdit>
		<odin:select property="useful" data="['1','有效'],['0','无效']" label="是否有效" value="1"></odin:select>
	</tr>
	<tr>
		<odin:textEdit property="dept" alt="" label="隶属机构"></odin:textEdit>
		...
		<odin:groupBox title="数据角色">
			<odin:grid property="dataRoleGrid" sm="checkbox" width="420" height="100" url="/common/pageQueryAction.do?method=query" isFirstLoadData="false">
				...
				<odin:gridColumnModel>
					<odin:gridSmColumn></odin:gridSmColumn>
					<odin:gridRowNumColumn></odin:gridRowNumColumn>
					<odin:gridColumn dataIndex="rolename" header="数据角色名称" isLast="true"></odin:gridColumn>
				</odin:gridColumnModel>
			</odin:grid>	
		</odin:groupBox>
		</td>
