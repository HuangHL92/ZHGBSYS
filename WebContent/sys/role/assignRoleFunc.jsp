...
<script type="text/javascript" src="<%=request.getContextPath()%>/sys/role/assignRoleFunc.js"></script>
</head>
...
<table width="96%" align="center">
	...
	<tr>
		...
		<td width="6"></td>
		<td><img src="<%=request.getContextPath()%>/images/quxiao.gif" onclick="parent.odin.ext.getCmp('funcWindow').hide()"></td>
	</tr>
	<tr>
		<td colspan="4" height="4"></td>
	</tr>
