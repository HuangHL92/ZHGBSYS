...
<form name="excelForm" method="post"  action="<%=request.getContextPath()%>/excel/excelServlet?method=impExcelAndProcess" enctype="multipart/form-data" target="impFrame">	
